...
//                'up_timestamp' => date('Y-m-d H:i:s')
    ...
    public function fee_challan(){
        ...
        $this->data['year']         = $this->CRUDModel->dropDown('financial_year','', 'id', 'year',array('status'=>1));
...
//                  echo '<pre>';print_r($paid_amount);
    ...
    public function bank_reconciliation_statment(){
        ...
        if($this->input->post()):
            ...
            $this->data['from'] = $from;
            $this->data['to']   = $to;
            $where['fee_actual_challan_detail.challan_status !='] = 1;
            $where['fee_actual_challan_detail.challan_status !='] = 4;
...
//        $this->data['install_type'] = $this->CRUDModel->dropDown('fee_installment_type','', 'id', 'installment_title');
        ...
        $this->data['pc_array']     = $this->FeeModel->payment_Cat_DropDown('fee_payment_category', ' Payment Type', 'pc_id', 'title');
        $this->data['sub_pro_name'] = $this->CRUDModel->sub_proDropDown('sub_programes', '', 'sub_pro_id', 'name',array('sub_programes.programe_id'=>1));
...
//                            
                    ...
                    $this->CRUDModel->update('student_record',array('sub_pro_id'=>  $sub_pro_name),$fee_balance_where);
