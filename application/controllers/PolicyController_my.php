...
//            echo '<pre>';print_r($this->data['UrRecord']);die;
            $this->data['menu1']    =   $this->CRUDModel->CRUDModel->get_where_result('menul1',array('m1_status'=>1));    
...
//      
//            $menu2 = $value;
//                $this->db->join("menul3",'user_policyl3.upl3_m3Id=menul3.m3_id');
//                $this->db->join("menul2",'user_policyl3.upl3_m2Id=menul2.m2_id');
//                $this->db->group_by('upl3_m3Id');
//                $this->db->where('m2_m1Id',$menu2);
//                $men3 = $this->db->get('user_policyl3')->result();
//                
//                foreach($men3 as $row):
//                    $data =array(
//                     'm3_m1Id'=>$row->m2_m1Id,   
