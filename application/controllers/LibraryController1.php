...
//        echo '<pre>'; print_r($result_student); die;
        ...
        if($result_staff):
            ...
            echo '<hr><h3 align="center">List of Books Issued to Staff</h3>
                ...
                <thead>
                    <tr>
                        <th style="vertical-align: middle;" width="5%">S No.</th>
                        <th style="vertical-align: middle;" width="15%">Employee Name</th>
                        <th style="vertical-align: middle;" width="10%">Department</th>
                        <th style="vertical-align: middle;" width="23%">Book Name</th>
                        <th style="vertical-align: middle;" width="23%">Subject</th>
                        <th style="vertical-align: middle;" width="10%">Accession No.</th>
                        <th style="vertical-align: middle;" width="7%">Status</th>
                        <th style="vertical-align: middle;" width="7%">Issued on</th>
                    </tr>
                </thead>
                <tbody>';
        ...
        if($result_student):
            ...
            echo '<hr><h3 align="center">List of Books Issued to Students</h3>
                ...
                <thead>
                    <tr>
                        <th style="vertical-align: middle;" width="5%">S No.</th>
                        <th style="vertical-align: middle;" width="15%">Student Name</th>
                        <th style="vertical-align: middle;" width="7%">College #</th>
                        <th style="vertical-align: middle;" width="8%">Section</th>
                        <th style="vertical-align: middle;" width="22%">Book Name</th>
                        <th style="vertical-align: middle;" width="22%">Subject</th>
                        <th style="vertical-align: middle;" width="8%">Accession #</th>
