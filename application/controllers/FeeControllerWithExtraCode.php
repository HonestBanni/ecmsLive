...
//            $this->data['fcs_date_to']  = date('d-m-Y', strtotime($record->fcs_date_to));
    ...
    public function class_setups_deletex(){
//        
...
//                'comment'           => '',
        ...
        $current_challan_update = array(
             'delete_head_flag' => 0,
             'comment'           => $updatRow->comment.' #This head is delete in current challan.'
         );
...
//            $where['student_record.college_no'] = '16481';
            ...
            if($this->input->post('netReceivableAllNew')):
                ...
                $ResultExcel = $this->FeeModel->net_receivable_new($where,$amount,$like);  
