...
//                            endif;
                            ...
                            echo '<tr>
                                ...
                                <td>'.$eRow->grade.'</td>';
                            if($eRow->sub_pro_id == 0):
                            echo '<td><button type="button"   class="btn btn-success disabled">Update</button>                            
                                <button type="button"  class="btn btn-danger disabled">Delete</button></td>';
                                
                           echo '</tr>'; 
                                else:
                                 echo '<td><button type="button" id="'.$eRow->serial_no.'" class="btn btn-success updateGreenFileEducation" data-toggle="modal" data-target="#updateGreenFile"   >Update</button>                            
    ...
    public function green_file_edu_update_data(){
        ...
        $education_details  = $this->db->get_where('applicant_edu_detail',array('serial_no'=>$education_id))->row();
                ...
                $degree           = $this->CRUDModel->dropDown('degree', 'Select Degree', 'degree_id', 'title');
           ...
           <div class="row">
            <div class="col-md-12">';
                    ...
                    echo    form_dropdown('program', $program,$student_details->programe_id,  'class="form-control"  ');
                    echo '</div>';
                    
                    echo '<div class="col-md-4 col-sm-5">
                            <label for="name">Program</label>';
                    echo    form_dropdown('sub_programes', $sub_program,$education_details->sub_pro_id,  'class="form-control" id="sub_programesu"');
                    echo '</div>';
                    echo '<div class="col-md-4 col-sm-5">
                            <label for="name">Program</label>';
                    echo    form_dropdown('degree_id', $degree,$education_details->degree_id,  'class="form-control" id="degree_id" ');
                    echo '</div>';
                                ...
                                jQuery.ajax({
                                    ...
                                    url     :'GreenFileUpdateSave',
                                     data :  {
                                                ...
                                                'degree_id'        :  jQuery('#degree_id').val(),
                                                'rollno'            : rollno,
                                                'year_of_passing'   : year_of_passing,
                                                'total_marks'       : total_marks,
                                                'obtained_marks'    : obtained_marks,
