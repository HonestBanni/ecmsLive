    ...
    public function add_payment_category(){
        ...
        if($this->input->post('add')):
            ...
            $this->CRUDModel->insert('fee_payment_category',$data);  
                ...
                $this->session->set_flashdata('add_payment_error', 'Payment Category Already Exist');
            endif;
...
//        $this->data['sub_program']      = $this->CRUDModel->sub_proDropDown('sub_programes', '', 'sub_pro_id', 'name');;
