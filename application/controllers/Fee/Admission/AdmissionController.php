...
class   AdmissionController extends AdminController {
   ...
   public function generate_admission_challan(){
        ...
        if($uri2):
            ...
            $this->data['shift']        = $this->CRUDModel->dropDown('shift','', 'shift_id', 'name',array('shift_id'=>$this->data['student_info']->shift_id));
...
//        echo '<pre>';print_r($this->data['student_info']);die;
        $this->data['page']         = 'Fee/Admission/Challan/search_and_generate';
        $this->data['page_header']  = 'Generate Admission Challan  ( Merit )';
        $this->data['page_title']   = 'Generate Admission Challan ( Merit ) | ECMS';
