...
//                   
              ...
              //Insert challan info against the student
                   $data = array(
                    ...
                    'section_id_paid'   => $studentRow->sectionsName,
                ...
                $credit_amount =  $this->db->get_where('fee_challan',array('fc_student_id'=>$studentRow->student_id,'credit_flag'=>1,'fc_challan_credit_amount >'=>0))->row();
                    if(!empty($credit_amount)):
                       ...
                       $SET_CREDIT     = array(
                        ...
                        $balance = $current_challan_balance->r_amount - $credit_amount->fc_challan_credit_amount;  
                        //Update Remove CREDIT from fee Balance table
                        $this->CRUDModel->update('fee_balance',array('r_amount'=>$balance,'comments'=>'Credit Adujst Rs:'.$credit_amount->fc_challan_credit_amount.'/'),array('balance_id'=>$current_challan_balance->balance_id));
...
//         echo '<pre>';print_r($this->data['mess_information']);die;
    ...
    public function fee_paid_amount(){
        ...
        if($this->input->post()):
           ...
           if($fee_head_from):
                $where_head['fee_heads.fh_Id']   = $fee_head_from;
...
//           fc_challan_credit_amount
            $this->data['result']           = $this->FeeModel->fee_paid_amount_report_programwise($where,$like,$date,$where_head);
//            $this->data['std_result']       = $this->FeeModel->fee_bank_reconcilition_count($where,$like,$date);
...
//           fc_challan_credit_amount
            $this->data['result']           = $this->FeeModel->fee_paid_amount_report_programwise_split($where,$like,$date,$where_head);
//            $this->data['std_result']       = $this->FeeModel->fee_bank_reconcilition_count($where,$like,$date);
