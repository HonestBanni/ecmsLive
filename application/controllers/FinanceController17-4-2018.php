...
//              echo '<pre>';print_r($this->data['GeneralLeader']);die; 
       ...
       for($col = ord('A'); $col <= ord('I'); $col++){
        ...
        foreach ($result as $row){
             ...
             $this->data['page']         = "Finance/reports/general_leader_dw";
            $this->data['title']        = 'Trial Balance | ECMS';
            $this->load->view('common/common',$this->data);
    }
...
//              echo '<pre>';print_r($this->data['GeneralLeader']);die; 
       ...
       for($col = ord('A'); $col <= ord('I'); $col++){
               ...
               $GeneralLeader =  $this->FinanceModel->get_leader_dw_old('gl_amount_details',
                       $this->data['dateFrom'], 
                       $this->data['toDate'],
                       $this->data['recordFromCode'],
                       $this->data['recordToCode']
                 ...
                 if(!empty($GeneralLeader)):
                    ...
                    $result[] =  array(
                        ...
                        $detail = $this->FinanceModel->get_amountDetails_old(
                                                        'gl_amount_transition',
                                                        array('gl_ad_coa_mc_pk'=>$GLRow->gl_ad_coa_mc_pk),$this->data['dateFrom'],$this->data['toDate']);
                        $credit_total    = '';
                        $debit_total     = '';
        ...
        foreach ($result as $row){
            ...
            $this->data['title']        = 'General Ledger Old | ECMS';
            $this->load->view('common/common',$this->data);
    }
...
//        
        ...
        $this->data['page_title']   = 'Trial Balance Process Date | ECMS';
        $this->load->view('common/common',$this->data);
    }
...
//        $term = trim(strip_tags($_GET['term']));
   ...
   public function finance_supplier_info(){
      ...
      public function trail_balance_new(){
            ...
            $this->data['GeneralLeader']   =  $this->FinanceModel->trail_balance_new('gl_amount_details',
                       $this->data['dateFrom'], 
                       $this->data['toDate'],
                       $this->data['recordFromCode'],
                       $this->data['recordToCode']
...
//                $this->excel->getActiveSheet()->getStyle(chr($col))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
        ...
        foreach ($result as $row){
                ...
                $this->excel->getActiveSheet()->fromArray($exceldata, null, 'A2');
                $date = $this->data['dateFrom'].' To '.$this->data['toDate'];
                $filename='Trail Balance From '.$date.'.xls'; //save our workbook as this file name
                header('Content-Type: application/vnd.ms-excel'); //mime type
                header('Content-Disposition: attachment;filename="'.$filename.'"'); //tell browser what's the file name
                header('Cache-Control: max-age=0'); //no cache
             ...
             $this->data['page']         = "Finance/reports/trail_balance_new";
            $this->data['title']        = 'Trial Balance | ECMS';
            $this->data['page_header']        = 'Trial Balance New';
            $this->load->view('common/common',$this->data);
    }
     ...
     public function income_statument(){
            ...
            if($this->input->post('search')):
             ...
             $this->data['GeneralLeader']   =  $this->FinanceModel->income_statement(
                       $this->data['dateFrom'], 
                       $this->data['dateTo'],
                       $this->data['recordFromCode'] ='',
                       $this->data['recordToCode'] =''
            ...
            if($this->input->post('excel')):
                ...
                $this->excel->setActiveSheetIndex(0);
                //name the worksheet
                $this->excel->getActiveSheet()->setTitle('INCOME STATEMENT');
                //set cell A1 content with some text
                $this->excel->getActiveSheet()->setCellValue('A1', 'CODE');
                $this->excel->getActiveSheet()->getStyle('A1')->getFont()->setBold(true);
                $this->excel->getActiveSheet()->getStyle('A1')->getFont()->setSize(12);
                
                $this->excel->getActiveSheet()->setCellValue('B1', 'COA DESCRIPTION');
                $this->excel->getActiveSheet()->getStyle('B1')->getFont()->setBold(true);
                $this->excel->getActiveSheet()->getStyle('B1')->getFont()->setSize(12);
...
//                $this->excel->getActiveSheet()->getStyle(chr($col))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
        ...
        foreach ($result as $row){
                ...
                $this->excel->getActiveSheet()->fromArray($exceldata, null, 'A2');
                $date = $this->data['dateFrom'].' To '.$this->data['toDate'];
                $filename='INCOME STATEMENT From '.$date.'.xls'; //save our workbook as this file name
                header('Content-Type: application/vnd.ms-excel'); //mime type
                header('Content-Disposition: attachment;filename="'.$filename.'"'); //tell browser what's the file name
                header('Cache-Control: max-age=0'); //no cache
          ...
          $this->data['page']         = "Finance/reports/income_statement";
            $this->data['title']        = 'Income Statement | ECMS';
            $this->data['page_header']  = 'Income Statement';
            $this->load->view('common/common',$this->data);
    }
...
//                                ); 
        ...
        foreach ($result as $row){
                ...
                $this->excel->getActiveSheet()->fromArray($exceldata, null, 'A2');
                $date = $this->data['dateFrom'].' To '.$this->data['toDate'];
                $filename='Balance Sheet From '.$date.'.xls'; //save our workbook as this file name
                header('Content-Type: application/vnd.ms-excel'); //mime type
                header('Content-Disposition: attachment;filename="'.$filename.'"'); //tell browser what's the file name
                header('Cache-Control: max-age=0'); //no cache
        ...
        $this->data['page']         = "Finance/reports/balance_sheet";
        $this->data['title']        = 'Balance Sheet | ECMS';
        $this->data['page_header']  = 'Balance Sheet';
        $this->load->view('common/common',$this->data);
    }
       public function bank_reconciliation_statement(){
            ...
            $this->data['page']            = "Finance/BRS";
            $this->data['title']            = 'Bank Reconciliation Statement | ECMS';
            $this->data['page_header']      = 'Bank Reconciliation Statement';
            $this->load->view('common/common',$this->data);
    }
    public function search_bank_reconciliation_statement(){
             ...
             if($this->input->post()):
               ...
               $search_brs   =  $this->FinanceModel->search_result_brs('gl_amount_details',
                       $this->data['dateFrom'], 
                       $this->data['toDate'],
                       $this->data['recordFromCode'] 
                       );
                 ...
                 endforeach;
                   ...
                   echo  '<td style="text-align:  center; width: 4.8%"></td>';
                    ...
                    echo '</tr>';
                      ...
                      $addition_gAmounts = $bank_book+$unprested_cheks+$gAdd_amount;
                    
                    echo '<tr>';
                    echo '<td colspan="9" style="text-align:  right;"><strong>Bank Book [+] Unpresented Cheque [+] Addition </strong></td>';
                     echo '<td style="text-align:  right; width: 5%">';
                        if(!empty($addition_gAmounts)):
                            echo number_format($addition_gAmounts, 0, ',', ','); 
                        endif;
                    echo '</td>';
                    echo '<td style="text-align:  center; width: 1%"></td>';
                    echo '</tr>';
                    ...
                    echo '<td colspan="9" style="text-align:  right;"><strong>Balance as per Bank Statement</strong></td>';
                     echo '<td style="text-align:  right; width: 5%">';
                        if(!empty($Sub_gAmounts)):
                            echo number_format($Sub_gAmounts, 0, ',', ','); 
                        endif;
                    echo '</td>';
                    echo  '<td style="text-align:  center; width: 4.8%"></td>';
                    echo '</tr>';
...
//              echo '<pre>';print_r($tran_data);die;   
    ...
    public function bank_reconciliation_statement_report(){
            ...
            $this->data['page']         = "Finance/reports/BRS_report";
            $this->data['title']        = 'BRS Report| ECMS';
            $this->data['page_header']  = 'BRS Report';
            $this->load->view('common/common',$this->data);
    }     
    public function brs_report_print(){
            ...
            $this->data['title_info'] = $this->db->get_where('fn_brs_report',array('fn_brs_report.id'=>$this->uri->segment(2)))->row();
...
//                     echo '<pre>';print_r($this->data['title_info']);die;
            ...
            $this->data['page']         = "Finance/reports/BRS_report_print";
            $this->data['title']        = 'BRS Report Print| ECMS';
            $this->data['page_header']  = 'BRS Report Print';
            $this->load->view('common/common',$this->data);
    }     
    ...
    public function brs_report_edit(){
            ...
            $this->data['tran_type']    = $this->CRUDModel->dropDown('fn_brs_tran_type', 'Selecct Type', 'id', 'tran_type'); 
                                           $this->db->join('fn_coa_master_sub_child','fn_coa_master_sub_child.fn_coa_mc_id=fn_brs_report.COA_id'); 
            $this->data['report_info']  =  $this->db->get_where('fn_brs_report',array('id'=>$brs_id))->row();
            ...
            $this->data['page']         = "Finance/BRS_edit";
            $this->data['title']        = 'BRS Edit| ECMS';
            $this->data['page_header']  = 'BRS Edit';
            $this->load->view('common/common',$this->data);
    }  
