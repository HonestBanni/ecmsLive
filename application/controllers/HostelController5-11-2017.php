     ...
     { 
       ...
       public function hostel_fee(){
            ...
            if($this->input->post()):
                ...
                $check_insta = $this->db->get_where('hostel_student_bill',array('hostel_std_id'=>$h_studetn_id,'cat_title_id'=>$inst_type))->row();
               
                if(empty($check_insta)):
...
//                 echo '<pre>';print_r($old_balance);die;
                ...
                endforeach;
                  ...
                  redirect('hostelPrintChallan/'.$h_studetn_id.'/'.$hostel_fee_id);
                     ...
                     redirect('hostelPrintChallan/'.$h_studetn_id.'/'.$check_insta->id);   
...
//                                  );
//                                $hostel_fee_id  =  $this->CRUDModel->insert('hostel_student_bill',$data);
//                                $hostel_fee     = $this->CRUDModel->get_where_result('hostel_heads',array('status'=>1,'head_type'=>1,'batch_id'=>$batch));
//                                $this->RQ($hostel_fee_id, 'assets/RQ/hostel_rq/');
//                                 foreach($hostel_fee as $feeRow):
//                                    $data = array(
//                                        'hostel_bill_id'    =>$hostel_fee_id,
