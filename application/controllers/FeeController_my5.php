...
class FeeController extends AdminController {
    ...
    public function fee_heads(){
        ...
        if($this->input->post('add')):
           ...
           if(!empty($fhid)):
            ...
            $this->data['recordFrom']       = $fh_record->fn_coa_mc_title;
            $this->data['recordFromCode']   = $fh_record->fn_coa_mc_id;
            $this->data['comment']          = $fh_record->fh_comments;
            $this->data['fee_fh_Id']        = $fh_record->fh_Id;
           
           endif;
        $this->data['result']    = $this->FeeModel->get_feeHead();
        $this->data['page']         = 'Fee/fee_heads';
 ...
 //Auto complete 
    ...
    public function shift_auto_complete(){
                ...
                if( $term == ''){
                    $like                   = $term;
                    $result_set             = $this->db->get('fee_shift')->result();
                    $labels                 = array();
                        foreach ($result_set as $row_set) {
                            $labels[]       = array( 
                                'label'     =>$row_set->name, 
                ...
                $matches                    = array_slice($matches, 0, 10);
                    ...
                    $like                   = $term;
                    $result_set             = $this->db->like('name',$like)->get('fee_shift')->result();
                    $labels                 = array();
                        foreach ($result_set as $row_set) {
                        $labels[]           = array( 
                             'label'        =>$row_set->name, 
    ...
    public function get_fee_coa_heads(){
                ...
                if( $term == ''){
                    $like                   = $term;
                    $result_set             = $this->FeeModel->get_fee_coa_heads('fn_coa_master_sub_child',$like);
                    $labels                 = array();
                        foreach ($result_set as $row_set) {
                            $labels[]       = array( 
    ...
    public function add_payment_category(){
        ...
        $this->data['page']         = 'Fee/fee_payment_category';
    ...
    public function payment_category_update(){
        ...
        $this->data['result']       = $this->FeeModel->get_Payment_Category();
        $this->data['page']         = 'Fee/fee_payment_category_update';
...
//                                                              echo '<pre>';print_r($row);die;
    ...
    public function class_setups(){
        ...
        $this->data['page']         = 'Fee/class_fee_setup';
...
//        echo '<pre>';print_r($where);die;
                                                          ...
                                                          foreach($result as $row):
                                                           ...
                                                           $sn++;
                                                            echo '<tr class="'.$class[$k].'">
                                                                ...
                                                                <th>'.$row->title.'('.$row->name.')</th>
                                                                <th>'.$row->fcs_comments.'</th>
                                                                 ';
                                                                       
                                                                    echo '<td>  <a href="classSetupsEdit/<?php echo $row->fcs_id;?>"  class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Edit </button></a>
                                                                  </td> 
                                                                  <td>';?> 
    ...
    public function class_setups_edit(){
        ...
        $this->data['shift_name']       = $this->CRUDModel->dropDown('fee_shift', 'Shift Name', 'shiftId', 'name');
...
//            $this->data['fcs_date_to']  = date('d-m-Y', strtotime($record->fcs_date_to));
        ...
        $this->data['page']         = 'Fee/class_fee_setup_edit';
...
//        echo '<pre>';print_r($this->data['result'] );die;
        $this->data['page']         = 'Fee/class_fee_category_wise';
    ...
    public function fee_Category_Wise_Edit(){
        ...
        $this->data['page']         = 'Fee/class_fee_category_wise_edit';
...
//         echo '<pre>';print_r($this->data['result'] );die;
        $this->data['page']         = 'Fee/class_fee_year_wise';
    ...
    public function fee_challan_status(){
        ...
        $this->data['page']         = 'Fee/fee_challan_status';
    ...
    public function fee_comments(){
        ...
        $this->data['page']         = 'Fee/fee_comment';
...
//                'up_timestamp' => date('Y-m-d H:i:s')
        ...
        $this->data['page']         = 'Fee/fee_concession_type';
    ...
    public function getPaymentCategory(){
        ...
        foreach($getResult as $secRow):
               echo '<option value="'.$secRow->pc_id.'">'.$secRow->title.'('.$secRow->name.')</option>';
        endforeach;
    }
    ...
    public function fee_challan(){
        ...
        $this->data['bank']         = $this->CRUDModel->dropDown('bank','', 'bank_id', 'name');
        $this->data['year']         = $this->CRUDModel->dropDown('financial_year','', 'id', 'year');
...
//             echo '<pre>';print_r( $this->data['result']);die;
        ...
        $this->data['page_header']  = 'Fee Challan Searh';
        $this->data['page_title']   = 'Fee Challan Searh | ECMS';
        $this->load->view('common/common',$this->data);
    }
...
//            $fee_setups_details = $this->CRUDModel->get_where_row('fee_class_setups',array('fcs_id'=>$head_id));
...
//            $this->data['studentInfo']  = $this->FeeModel->fee_challan_student(array('student_record.s_status_id' => 5,'student_record.student_id'=>$this->uri->segment(3)));
        ...
        $this->data['page']         = 'Fee/fee_challan_print';
    ...
    public function print_challan_class_wise(){
        ...
        $this->data['student_info'] = $this->FeeModel->fee_challan_filters_classWise($where,$like);
        
 
        
      
        $this->data['page']         = 'Fee/class_wise_print';
...
//        echo '<pre>';print_r($this->data['student_info']);die;
        ...
        if($this->input->post()):
            ...
            $fee_challan_exist = $this->CRUDModel->key_exists('fee_challan',array('fc_student_id'=>$studentRow->student_id,'fc_pay_cat_id'=>1));
...
//        echo '<pre>';print_r( $this->data['result']);die;
     ...
     public function fee_challan_print_admission(){
            ...
            $this->data['studentInfo']  = $this->FeeModel->fee_challan_student(array('student_record.s_status_id' => 1,'student_record.student_id'=>$this->uri->segment(3)));
            $this->data['feeComments']  = $this->FeeModel->get_challan_detail(array('fc_challan_id'=>$this->uri->segment(2)));
             $where = array(
                       'fc_student_id '=> $this->data['feeComments'] ->fc_student_id,
                       'fc_paid_form <='=> $this->data['feeComments'] ->fc_paid_form,
        ...
        $this->data['result']       = $this->FeeModel->feeDetails_head_print($where);
        $this->data['page']         = 'Fee/fee_challan_print_admission';
        $this->data['page_header']  = 'Fee Challan Print';
        $this->data['page_title']   = 'Fee Challan Print | ECMS';
        $this->load->view('common/common',$this->data);
    }
...
//             echo '<pre>';print_r($this->data['result']);die;
       ...
       $userInfo           = json_decode(json_encode($this->getUser()), FALSE);
            ...
            $this->CRUDModel->insert('fee_refund_challan',$refund_where);
...
//             echo '<pre>';print_r( $this->data['result']);die;
    ...
    public function fee_concession(){
        ...
        $this->data['concession_type'] = $this->CRUDModel->dropDown('fee_concession_type', '', 'concess_type_id', 'title');
//        if($this->input->post('payment_challan_search')):
...
//            $challandId = $this->input->post('challan_no');
            ...
            if(!empty($challan_status)):
//            echo '<pre>';print_r($challan_status);die;
...
//             echo '<pre>';print_r($this->data['result']);die;
                 ...
                 $this->session->set_flashdata('refun_message', 'Challan Information  !</strong> Challan are paid connect to Finance Department');
            endif;
...
//        endif;
        ...
        if($this->input->post('concession_challan')):
            ...
            $this->CRUDModel->insert('fee_concession_challan',$refund_where);
...
//                  echo '<pre>';print_r($paid_amount);
    ...
    public function bank_reconciliation_statment(){
        ...
        $this->data['program']      = $this->CRUDModel->dropDown('programes_info', 'Program ', 'programe_id', 'programe_name');
        $this->data['section']      = $this->CRUDModel->dropDown('sections', 'Section', 'sec_id', 'name');
        $this->data['fee_head']     = $this->FeeModel->dropDown_fee_head('fee_class_setups', 'Fee Head', 'fcs_id', 'fh_head');
        ...
        if($this->input->post()):
            ...
            $this->data['from'] = $from;
            $this->data['to']   = $to;
            $where['fee_actual_challan_detail.challan_status'] = 2;
            $like       = '';
            $where_head = '';
              
           if($fee_head):
                $where_head['fee_actual_challan_detail.fee_id']     = $fee_head;
       ...
       if($this->input->post('student_wise')):
            ...
            $this->data['result']       = $this->FeeModel->fee_bank_reconcilition($where,$like,$date);
...
//              echo '<pre>';print_r( $this->data['result']);die;
       ...
       if($this->input->post('date_wise')):
            ...
            $this->data['result']       = $this->FeeModel->fee_bank_reconcilition_date_wise($where,$date);
...
//              echo '<pre>';print_r( $this->data['result']);die;
       ...
       if($this->input->post('fee_head')):
            ...
            $this->data['result']       = $this->FeeModel->fee_bank_reconcilition_head_wise($where_head,$date);
...
//                     echo '<pre>';print_r($this->data['result'] );
                ...
                if($this->input->post('conce_head_wise')):
                    $this->data['result']       = $this->FeeModel->fee_concession($where,$like,$date);
                    
               
                    $this->data['report_type']  = 'conce_head_wise';
                    $this->data['report_name']  = 'Fee Concession Head Wise';
                endif;
        endif;
