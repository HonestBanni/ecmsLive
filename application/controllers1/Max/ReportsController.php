...
//                echo '<pre>';print_r($result);die;
                ...
                $this->data['countResult']  = count($this->data['result']);
                $this->data['page']         = "reports/marksWise";
...
//                $this->load->view('common/common',$this->data);      
            ...
            $this->data['page']         = "reports/Inter/marks_wise_fine_inter_v";
            $this->data['title']        = 'Students Absentee Fine| ECMS';
            $this->load->view('common/common',$this->data); 
    ...
    public function student_position_wise_fine_inter1(){
            ...
            if($this->input->post('search')):
                ...
                $this->data['ReportName']   = 'Position Marks wise Fine (Inter)';
                $this->data['countResult']  = count($this->data['result']);
                $this->data['page']         = "reports/marksWisefineinter";
                $this->data['title']        = 'Position Marks wise (BCS) | ECMS';
                $this->load->view('common/common',$this->data);      
            else:
            $this->data['studentId'] = '';
    ...
    public function grand_report_finance(){ 
            ...
            $this->data['program']      = $this->CRUDModel->dropDown('programes_info', 'Program ', 'programe_id', 'programe_name');
            $this->data['section']      = $this->CRUDModel->dropDown('sections', 'Section', 'sec_id', 'name',array('status'=>'On'));
            $this->data['student_status']   = $this->CRUDModel->dropDown('student_status', ' Status', 's_status_id', 'name');
//            $this->data['student_status']   = $this->ReportsModel->statuss_dropDown('student_status', ' Status', 's_status_id', 'name');
            $this->data['batch']            = $this->CRUDModel->dropDown('prospectus_batch', ' Batch ', 'batch_id', 'batch_name',array('status'=>'on'));
            $this->data['gender']           = $this->CRUDModel->dropDown('gender', 'Gender Status', 'gender_id', 'title');
             $this->data['shift']            = $this->CRUDModel->dropDown('shift', 'Select Shift ', 'shift_id', 'name');
...
//            echo '<pre>';print_r($this->data['result']);die;
            ...
            $this->data['ReportName']   = 'Student Attendance Percentage Wise Report';
            $this->data['page']         = "reports/Inter/student_attendance_percentage_wise_v";
            $this->data['page_title']        = 'Student Attendance Percentage Wise Report | ECMS';
            $this->load->view('common/common',$this->data); 
    }
...
//        $this->data['page']     =   "reports/bs_department/uop_result_print";
    ...
    public function teacher_attendance_date_wise_report(){
        $this->data['ReportName']          = 'Teacher Attendance ( Date Wise )';
        $this->data['page_title']       = 'Student Attendance ( Date Wise ) | ECMS';
        $this->data['page']             =  'reports/admin/teacher_attendance_date_wise';
        $this->load->view('common/common',$this->data); 
    }
    
    public function teacher_attendance_date_wise_report_result(){
        if($this->input->post()):
           ...
           $where = '';
            ...
            $this->data['result']       = $this->ReportsModel->get_teacher_attendance_date_wise($where,$date);
        endif;
     $this->load->view('reports/admin/jQuery_v/teacher_date_wise_js',$this->data); 
    }
     public function teacher_attendance_month_wise_report(){
         ...
         if($this->input->post('ExportMonthWise')):
            ...
            $result     = $this->CRUDModel->get_where_result('hr_emp_record',$where);
...
//             $return_dataCount = '0';
    ...
    public function teacher_attendance_month_wise_report_result(){
        if($this->input->post()):
                                        $where = array('emp_status_id'=>1,'cat_id'=>1);
            $this->data['result']   =   $this->CRUDModel->get_where_result('hr_emp_record',$where);
        endif;
...
//            echo '<pre>'; print_r($this->data['result']); die;
                          $this->db->select('date_format(timestamp, "%M") as attendance_month, date_format(timestamp, "%Y-%m") as month_year');
                          $this->db->group_by('date_format(timestamp, "%M")');
