...
//        echo '<pre>'; print_r($this->data['result']); die;
    ...
    public function view_exam_marks_list(){  
        ...
        $this->data['result']   = $this->AttendanceModel->view_exam_marks_list('exams_bs_details',$where);
        $this->data['count']    = $this->AttendanceModel->view_exam_marks_list('exams_bs_details',$where);
