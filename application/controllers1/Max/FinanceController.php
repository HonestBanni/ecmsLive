...
//            $userInfo      = $this->getUser();
        ...
        $this->data['page_heading']     = "OP Voucher Print Setting";
        $this->data['page_title']       = 'OP Voucher Print Setting | ECMS';
...
//        echo '<pre>';print_r($this->data['voucher_info']);die;
        ...
        $order['order']   = 'asc';
        $this->data['approval']         = $this->CRUDModel->get_where_result_order('fn_vocher_approvalby',array('status'=>1,'fn_account_type_id'=> 1),$order); 
