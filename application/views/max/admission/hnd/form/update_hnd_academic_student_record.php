    ...
    <div class="content">
        ...
        <div class="module">
            <div class="module-head">
                <h3>Update HND Student Academic Record</h3>
            </div>
            <div class="module-body">
                
                <br />
                
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/update_hnd_academic_student_record/<?php echo $id;?>">
