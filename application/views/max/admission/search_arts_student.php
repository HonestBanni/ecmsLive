        ...
        <div class="content container">
               <!-- ******BANNER****** -->
   <h3 align="left">Inter Subject Allottment<hr></h3>          
...
$query = $this->CRUDModel->get_where_row('student_subject_alloted',array('student_id'=>$student_id));
    ...
    { 
    ?>
<a href="<?php echo base_url();?>admin/student_updassign_subjects/<?php echo $student_id;?>/<?php echo $rec->sub_pro_id;?>">Update Subjects</a>      
    <?php
    }
    else{
        ?>
   <a href="<?php echo base_url();?>admin/student_assign_subjects/<?php echo $student_id;?>/<?php echo $rec->sub_pro_id;?>">Assign Subjects</a>
<?php
    }            
    ?>    
</td>
