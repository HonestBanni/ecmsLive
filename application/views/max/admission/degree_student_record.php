        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Students Record (Degree Level)<span  style="float:right"><a href="admin/add_degree_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
...
$i = 1;
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>">
    ...
    <td><a class="btn btn-primary btn-sm" href="admin/update_degree_student/<?php echo $rec->student_id;?>"><b>Edit</b></a></td>
    <td><a class="btn btn-danger btn-sm" href="admin/upload_degree_sphoto/<?php echo $rec->student_id;?>"><b>Add Pic</b></a></td>
