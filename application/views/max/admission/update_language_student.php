...
<div class="content container">
       <!-- ******BANNER****** -->
<h2 align="center">Update Student (Language)</h2>    
        ...
        <div class="form-group col-md-3">
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM programes_info WHERE programe_id='10'");
            ...
            <option type="text" value="<?php echo $grec->sub_pro_id;?>"><?php echo $grec->name;?></option>
             ...
             <?php
                ...
                ?>
                  <div class="form-group col-md-3">
                  <label for="usr">Sub Program:</label>
               <select class="form-control" type="text" id="lang_subpro_id" name="sub_pro_id" required>
                   <?php
            $gres = $this->get_model->get_by_id('sub_programes',array('sub_pro_id'=>$sub_pro_id));
                if($gres){
                    foreach($gres as $grec){ ?>                   
            ...
            echo '<option type="text" value=""></option>';
                ...
                ?>
                    ...
                    <?php 
                        $sb = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=10");
    ...
    <div class="form-group col-md-3">
                ...
                <select class="form-control" type="text" name="batch_id" id="show_batch_id">
                <?php
