...
<form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/new_student_academic_record/<?php echo $student_id;?>">
    ...
    <div class="form-group col-md-6">
        <input type="submit" class="btn btn-theme" name="Add_education" value="Add Record">
    </div>
...
<div class="alert alert-info col-md-12">
        ...
        <p style="margin-left:200px; color:red">If Academic Details Completed Then Click on Done Button, Thanks... <a style="float:right; margin-right:450px;" href="admin/new_student_record" onclick="myFunction()" class="btn btn-primary">Done</a></p><br>    
            <br>
    </div>        
