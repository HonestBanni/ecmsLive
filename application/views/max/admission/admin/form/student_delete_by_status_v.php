...
//                                        $Section = array('Section'=>"Section");
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-5 pull-right">
                                    ...
                                    <button type="submit" class="btn btn-theme" name="DeleteRecord" id="DeleteRecord"  value="DeleteRecord" ><i class="fa fa-search"></i> Delete Record</button>
                                                          ...
                                                          foreach($result as $row):
                                                            ...
                                                            $sn++;  
                                                              echo ' <tr>
                                                                ...
                                                                echo '<td><img src="assets/images/students/'.$pic_link.'" style="height: 50px;"></td>';
