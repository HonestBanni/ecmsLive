 <!-- ******CONTENT****** --> 
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="center" style="border-bottom:1px solid #ccc;">Add New Student (Law)</h2>
       
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form name="student" method="post" enctype="multipart/form-data" action="admin/add_law_student">        
    <h3 align="left">Student Admission Information<hr></h3> 
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="batch_id" id="batch_id" class="form-control">
                <?php
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE programe_id='9' order by batch_id desc");
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="programe_id" id="SProgrameId" class="form-control">
                <?php
        $b = $this->db->query("SELECT * FROM programes_info WHERE programe_id='9' ");
                foreach($b->result() as $brec)
                {
                ?>
        ...
        <div class="form-group col-md-3">
           ...
           <?php
        $c = $this->db->query("SELECT * FROM sub_programes WHERE programe_id='9'");
