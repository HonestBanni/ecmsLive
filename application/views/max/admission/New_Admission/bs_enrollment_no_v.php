        ...
        <div class="content container">
            ...
            <form method="post" >
                ...
                <div class="form-group col-md-2">
                    <input type="text" name="enrollement_no" value="<?php if($enrollement_no): echo $enrollement_no;endif; ?>"  placeholder="Enrollement No" class="form-control">
              </div>
                <div class="form-group col-md-2">
        ...
        <input type="submit" name="search" class="btn btn-theme" value="Search">
            ...
            <button type="button" class="btn btn-success">
                <i class="fa fa-check-circle"></i>Total Records: <?php echo count($result);?>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-boxed table-bordered table-striped" style="font-size:12px">
                    <thead>
                        <tr>
                            <th>Picture</th>
                            <th>College #</th>
...
$i = 1;
    ...
    <img src="<?php echo base_url();?>assets/images/students/<?php echo $applicant_image;?>" style="border-radius:10px;" width="60" height="60">
                ...
                <td><?php echo $student_name;?><br/><?php echo $father_name;?></td>
                ...
                <td>
                    ...
                    <a href="BsEnrollmentNoUp/<?php echo $student_id;?>"><button class="btn btn-theme btn-sm">Update</button></a>
                </td>
    </tr>
        <?php
        }
