...
<script>
function myFunction() {
    alert("You have inserted Student Id: <?php echo $student_id;?>");
}
</script>
<br />
<form method="post" enctype="multipart/form-data">
    ...
    <div class="form-group col-md-4">
        <?php 
            ...
            if($std):
                $addRess = $std->last_school_address;
                else:
            $addRess = '';    
            endif;
        ?>
            <label for="usr">Institute:</label>
            <input type="text" name="inst_id" value="<?php echo $addRess;?>" class="form-control"> 
   </div>
    <div class="form-group col-md-4">
    ...
    <div class="col-md-6">
        ...
        <!--<a  href="HostelNewRecord/<?php echo $student_id;?>"  class="btn btn-theme btn-lg">Add Hostel Record</a>-->
    </div>
    
    
    <div class="col-md-1 pull-right">
         <a  href="NewAdmissonInterSearch" onclick="myFunction()" class="btn btn-primary btn-lg">Done</a>
    </div>
    ...
    <!--<div class="col-md-6 col-md-offset-1 pull-right">-->
        ...
        <?php
            if($student_records):
//                echo '<pre>';print_r($student_records);die;
            ?>
             <table class="table table-bordered table-striped display">
                 ...
                 <?php
                        ...
                        <tr class="gradeA">
                            ...
                            <td><a href="UpdateAdmissionAcademic/<?php echo $rec->serial_no;?>" class="btn btn-theme btn-small">Edit</a></td>
                        </tr>
                        <?php
                        endforeach;
                        endif;
