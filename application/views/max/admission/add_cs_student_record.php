 <!-- ******CONTENT****** --> 
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="center" style="border-bottom:1px solid #ccc;">Add New Student (Computer Science)</h2>
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form name="student" method="post" enctype="multipart/form-data" action="admin/add_cs_student">       
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="batch_id" id="batch_id" class="form-control">
                <?php
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE programe_id=2 Order by batch_id desc");
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="sub_pro_id" class="form-control">
                <?php
                $b = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=2");
                foreach($b->result() as $brec)
                {
                ?>
