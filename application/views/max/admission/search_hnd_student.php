        ...
        <div class="content container">
               <!-- ******BANNER****** -->
   <h3 align="left">All HND Students Record<span  style="float:right"><a href="<?php echo base_url();?>admin/add_hnd_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h3>          
            <div class="row cols-wrapper">
                <div class="col-md-12">
                    
            <form method="post" action="admin/search_hnd_student">
...
foreach($result as $rec)  
{
  ...
  <img src="<?php echo base_url();?>assets/images/students/<?php echo $rec->applicant_image;?>" style="border-radius:10px;" width="80" height="80">
    ...
    <td><a class="btn btn-primary btn-sm" href="<?php echo base_url();?>admin/update_hnd_student/<?php echo $rec->student_id;?>"><b>Edit</b></a></td>
    <td><a class="btn btn-danger btn-sm" href="<?php echo base_url();?>admin/upload_hnd_sphoto/<?php echo $rec->student_id;?>"><b>Add Pic</b></a></td>
