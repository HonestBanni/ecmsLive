   ...
   <h3 align="left">All Students <hr></h3>          
            <div class="row cols-wrapper">
                <div class="col-md-12">
                    ...
                    <form method="post" action="admin/admin_search_student">
...
foreach($result as $rec)  
{
  ...
  <img src="<?php echo base_url();?>assets/images/students/<?php echo $rec->applicant_image;?>" style="border-radius:10px;" width="80" height="80">
                <?php 
                    ...
                    {?>
                    <?php echo $section;?><br>
                <a href="<?php echo base_url();?>admin/update_student_by_group/<?php echo $rec->serial_no;?>">Change</a>     
                <?php 
                    }
                    ?></td>
                    <td><?php echo $rec->student_status;?></td>
    <td><a class="btn btn-primary btn-sm" href="<?php echo base_url();?>admin/admin_update_student/<?php echo $rec->student_id;?>"><b>Edit</b></a></td>
    <td><a class="btn btn-danger btn-sm" href="<?php echo base_url();?>admin/admin_upload_sphoto/<?php echo $rec->student_id;?>"><b>Add Pic</b></a></td>
