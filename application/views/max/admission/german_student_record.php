    <div class="content container">
            <h2 align="left">German Students Record<span  style="float:right"><a href="admin/add_german_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
        ...
        <div class="form-group col-md-2">
            <select type="text" name="programe_id" class="form-control">
                <?php
        $b = $this->db->query("SELECT * FROM programes_info WHERE programe_name LIKE 'german%'");
    ...
    $c = $this->db->query("SELECT * FROM sub_programes WHERE programe_id='11'");
        ...
        <option value="<?php echo $crec->sub_pro_id;?>"><?php echo $crec->name;?></option>
            ...
            <option value="<?php echo $brec->batch_id;?>"><?php echo $brec->batch_name;?></option>
                ...
                <?php 
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE  `batch_name` LIKE  '%german%'");
                foreach($b->result() as $brec)
                {
                ?>
                    <option value="<?php echo $brec->batch_id;?>"><?php echo $brec->batch_name;?></option>
...
foreach($result as $rec)  
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>">
    ...
    <td><a class="btn btn-primary btn-sm" href="admin/update_german_student/<?php echo $rec->student_id;?>"><b>Update</b></a></td>
