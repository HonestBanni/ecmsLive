    ...
    <div class="form-group col-md-2">
        ...
        <?php
            ...
            if($gres){
                ...
                { ?>          
                <input type="text" required="required" name="sec_Name" value="<?php echo $grec->name; ?>" placeholder="Section" class="form-control" id="sections_art_id">
                <input type="hidden" name="sec_id" id="sec_id" value="<?php echo $grec->sec_id; ?>">      
                <?php 
                }     
            }else{?>
            <input type="text" name="sec_Name" placeholder="Section" class="form-control" id="sections_art_id" required="required">
