        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">All HND Students Record<span  style="float:right"><a href="admin/add_hnd_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
...
foreach($result as $rec)  
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>">
    ...
    <td><a class="btn btn-primary btn-sm" href="admin/update_hnd_student/<?php echo $rec->student_id;?>"><b>Edit</b></a></td>
    <td><a class="btn btn-danger btn-sm" href="admin/upload_hnd_sphoto/<?php echo $rec->student_id;?>"><b>Add Pic</b></a></td>
