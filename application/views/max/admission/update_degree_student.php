...
<div class="content container">
       <!-- ******BANNER****** -->
<h2 align="center">Update Student (Degree Level)<hr></h2>    
    ...
    <div class="form-group col-md-3">
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM prospectus_batch WHERE programe_id='4' order by batch_id desc");
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM programes_info WHERE programe_id='4'");
                    foreach($b->result() as $brec)
                    {
                    ?>
    ...
    <div class="form-group col-md-3">
        <label for="usr">Place of Birth  (<small>dd-mm-yy</small>):</label>
...
<div class="form-group col-md-12">                       
    <input type="submit" class="btn btn-theme" name="submit" value="Update Student">
                ...
                <br><br>
                <h3 align="center">Student Academic Record Details<hr><span style="folat:right"><a href="<?php echo base_url();?>admin/degree_student_academic_record/<?php echo $id;?>" class="btn btn-large btn-primary">Add Academic Record</a></span></h3>
        ...
        <td><a href="admin/update_degree_academic_record/<?php echo $rec->serial_no;?>">Update</a></td>
