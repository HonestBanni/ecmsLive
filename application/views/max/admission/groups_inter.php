    ...
    <h2 align="left">Year Head All Groups <hr></h2>        
            <div class="row cols-wrapper">
                <div class="row cols-wrapper">
                    <form>
                        <?php
                    $q = $this->db->query("SELECT DISTINCT sections.name as section,sections.sec_id as sec_id from sections,student_group_allotment where student_group_allotment.section_id = sections.sec_id AND sections.program_id='1'
    ...
    <input style="background-color:#337ab7; color:#fff; height:40px; border:1px solid #337ab7; text-align:center" value="<?php echo $row->section;?> (Total: <?php echo $s->num_rows();?>)" class="form-control" readonly></a> 
            ...
            <tr class="gradeA">
                ...
                <td><a class="btn btn-success btn-sm" href="admin/update_student_by_group_inter/<?php echo $rec->serial_no;?>">Update</a></td>
            </tr>
