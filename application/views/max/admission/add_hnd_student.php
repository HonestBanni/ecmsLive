 <!-- ******CONTENT****** --> 
    <div class="content container">
       <!-- ******BANNER****** -->
    <h2 align="center" style="border-bottom:1px solid #ccc;">Add New Student (HND Level)</h2>
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form name="student" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/add_hnd_student">        
    <h3 align="left">Student Admission Information<hr></h3> 
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="batch_id" id="batch_id" class="form-control">
                <?php
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE  `batch_name` LIKE  '%HND%' OR batch_name LIKE '%BBA%' OR batch_name LIKE '%EDSML%' order by batch_id desc");
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="programe_id" id="alumiProgrameId" class="form-control">
        ...
        <div class="form-group col-md-3">
           ...
           <select class="form-control" name="sub_pro_id" id="showAlumiSubPro">
            </select>
          </div>
        <div class="form-group col-md-3">
            <label for="usr">Form No.:</label>
            <input type="text" name="form_no" id="form-Checking" placeholder="form no e.g 222" class="form-control">        
        </div>
        <div class="form-group col-md-3">
