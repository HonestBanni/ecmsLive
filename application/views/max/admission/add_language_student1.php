 <!-- ******CONTENT****** --> 
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="center" style="border-bottom:1px solid #ccc;">Add New Student (For Language)</h2>
       
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form name="student" method="post" action="admin/add_language_student">        
    <h3 align="left">Student Admission Information<hr></h3> 
        <div class="form-group col-md-3">
            ...
            <select type="text" name="programe_id" class="form-control">
                <?php
        $b = $this->db->query("SELECT * FROM programes_info WHERE programe_name LIKE 'Languages%'");
    ...
    <option value="<?php echo $brec->programe_id;?>"><?php echo $brec->programe_name;?></option>
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="batch_id" id="show_batch_id" class="form-control">
        ...
        <div class="form-group col-md-3">
            ...
            $this->db->limit('1');
            $qr = $this->db->get();
            foreach($qr->result() as $sdRow);
            $s_id = $sdRow->student_id + 1;
            ?>
            <input type="text" name="form_no" id="form-Checking" value="HSK-<?php echo $s_id; ?>" class="form-control" readonly>        
        </div>
        <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="lang_status_id" class="form-control">
                <option value="">Select Status</option>
                <?php
        $l = $this->CRUDModel->getResults("student_status_lang");
                foreach($l as $brec)
                {
                ?>
