        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">All Institutes <span  style="float:right"><a href="" data-toggle="modal" data-target="#adding" class="btn btn-large btn-primary">Add New Institute</a></span><hr></h2>
...
foreach($result as $rec)  
{
                        ...
                        <tr class="gradeA">
                            ...
                            <td><a href="<?php echo base_url();?>admin/update_institute/<?php echo $rec->inst_id;?>"><i class="icon-edit"></i><b> Update</b></a></td>
                            <td><a href="<?php echo base_url();?>admin/delete_institute/<?php echo $rec->inst_id;?>" 
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal row-fluid" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/add_institute">
