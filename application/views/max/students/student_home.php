<?php
    ...
    <div class="four-grids">
        ...
        <div class="col-md-2 four-grid">
            <a href="whiteCardShow/<?php echo $student_id;?>/<?php echo $section_id;?>" target="_blank" title="Student Progress Reports">
    ...
    <div class="four-grids">
        ...
        <div class="col-md-2 four-grid">
             <a href="StudentController/timetable/<?php echo $student_id;?>/<?php echo $section->section_id;?>" target="_blank" title="Student Time Table">
            <div class="four-wthree">
                <div class="four-text">
                    <h3>Time Table</h3>
                </div>
