    ...
    <?php  if($std_data): ?>
             <div style="margin: 2px 4px 2px; width:32%;height:auto;border-right:2px dotted #000; float: left; position: relative">
                <div style="text-align: center">
                  ...
                  <p style="font-size: 12px; text-align: center;"><strong>HABIB BANK LIMITED POLICE ROAD, PESHAWAR</strong> <br><strong style="font-size: 15px;">Acc No :(0898-00162501-03)</strong></p>
                <table class="table ">
                        <tr  style="font-size: 20px;">
                            <td class="removeBorder"><strong>Challan# :</strong></td>
                            <td class="removeBorder"><strong><?php echo  $std_data->pros_challan_id    ?></strong></td>
...
//                           endif;
                        ...
                        <tr>
                           ...
                           <td style="font-size: 13px;" class="removeBorder"><strong><?php echo  date('d-m-Y',strtotime($std_data->due_date));?></strong></td>
                        </tr>
                    </table>
               ...
               <ol class="custom-list-style">
                    ...
                    <li><strong>No Fee shall be deposited after <?php echo  date('d-m-Y',strtotime($std_data->due_date));?>.</strong></li>
