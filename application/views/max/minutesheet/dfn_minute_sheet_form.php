            ...
            <section class="course-finder" style="padding-bottom: 2%;">
                ...
                <div class="section-content" >
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 form-group">
                            ...
                            <select class="form-control" name="case_id" id="case_id">
                                ...
                                <option value="8">Forwarded to HOD for Recommendation</option>
                    ...
                    <div class="col-md-12 right">
                        <button type="button" class="btn btn-theme pull-right mt-2" name="update_dfn_ms" id="update_dfn_ms"  value="update_dfn_ms" >Submit Minute Sheet</button>
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#update_dfn_ms').on('click', function(){
            ...
            if($('#case_id').val() == 9 || $('#case_id').val() == 10){
                if($('#details').val() === ''){
                    $('#details').focus();
                    return false;
                }
