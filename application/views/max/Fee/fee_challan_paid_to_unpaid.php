                            ...
                            <div class="row">
                               ...
                               <div class="col-md-3">
                                    <label for="name">Program</label>
                                        <?php 
                                            echo form_dropdown('program_id', $program,$student_info->programe_id,  'class="form-control" disabled="disabled"');
                                        ?>
                                    </div>
                               <div class="col-md-3">
                                    <label for="name">Batch</label>
                                        <?php 
                                             ...
                                             echo form_dropdown('batch_id', $batch,$student_info->batch_id,  'class="form-control" disabled="disabled"');
                                              form_input(array(
                                                'name'          => 'father_name',
                                                'id'            => 'father_name',
                               ...
                               <div class="col-md-3">
                                    <label for="name">Sub Program</label>
                                        <?php 
                                             ...
                                             echo form_dropdown('sub_pro_name', $sub_pro_name,$student_info->sub_pro_id,  'class="form-control" disabled="disabled"');
                                              form_input(array(
                                                'name'          => 'father_name',
                                                'id'            => 'father_name',
                                                'value'         => $student_info->sub_proram,
                                ...
                                <div class="col-md-3">
                                    ...
                                    echo form_dropdown('pc_array', $pc_array, $challan_info->fc_pay_cat_id,'id="payment-challan" class="form-control" disabled="disabled"');
...
//                                        if(@$challan_info->challan_id_lock == 0):
                                           echo '<button type="submit" class="btn btn-theme" name="updateChallan" id="updateChallan"  value="updateChallan" ><i class="fa fa-book"></i> UnPaid Challan</button>';
//                                        endif;
              ...
              <?php
                                    ...
                                    if(@$challan_info->fc_ch_status_id == 2):
                                        echo '<div class="alert alert-danger alert-dismissable center">
                                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                        <strong>Challan! Paid</strong> </div>';
