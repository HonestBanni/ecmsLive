                                                          ...
                                                          foreach($result as $row):
                                                           ...
                                                           $sn++;
                                                            echo '<tr ">
                                                                ...
                                                                ';
                                                                       ?>
                                                                    <td>  <a href="Comments/<?php echo $row->commentId;?>"  class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Edit </button></a>
                                                                  </td> 
                                                                  <td> 
                                                                   <a href="CommentsDelete/<?php echo $row->commentId;?>"  onclick="return confirm('Are You Sure to Delete This..?')"  class="productstatus"><button type="button" class="btn btn-danger btn-xs"> Delete</button></a>
                                                                   </td>  
                                                                <?php
