        ...
        <article class="contact-form col-md-12 col-sm-7">                            
          <?php echo form_open('',array('class'=>'form-inline')); ?>
            ...
            <div class="col-md-12">
                ...
                <?php 
                echo form_dropdown('coa_parent_id', $COAP,$coaId,  'class="form-control" id="coa_fee_parent_id" required="required"');
                ?>
              </div>
                <div class="form-group">
                    <select name="master_child" id="master_child" class="form-control fee_coa_master_child_result" required="required">
                    <?php
                  ...
                  $sn = 1;
                   foreach($master_sub as $urRow):
                      ...
                      echo '<tr>
                                ...
                                <td>'.$status.'</td>
                                <td>
                                <a href="feeSubChild/'.$urRow->fn_coa_mc_id.'" class="productstatus" ><span class="fa fa-book text-navy"></span></a>
                                 &nbsp;
                                <a href="delteFeeCOAS/'.$urRow->fn_coa_mc_id.'" class="productstatus" ><span class="fa fa-trash text-danger"></span></a>    
