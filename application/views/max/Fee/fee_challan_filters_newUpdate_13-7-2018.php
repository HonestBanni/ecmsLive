...
//                                        $Section = array('Section'=>"Section");
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-5 pull-right">
                                    ...
                                    <button type="button" class="btn btn-theme"    id="print_batch"  value="print_batch" ><i class="fa fa-print"></i> Print Last Chl</button>
...
//                                                            echo '<pre>';print_r($row);die;
                                                          ...
                                                          echo '<tr>
                                                                ...
                                                                if($row->s_status_id == 5):
                                                                    echo '<td><a href="fullDetails/'.$row->student_id.'" target="_new"><strong title="'.$row->student_name.'/'.$row->father_name.', Class :('.$row->sessionName.'), Student status = '.$row->student_status.'") target="_new">'.substr($row->student_name, 0, 30).'</strong></a><br/>'.$row->batch_name.'<br/>'.$row->sessionName.'<br/>'.$row->student_status.'</td>';
                                                                    else:
                                                                    echo '<td><a href="fullDetails/'.$row->student_id.'" target="_new"><strong title="'.$row->student_name.'/'.$row->father_name.', Class :('.$row->sessionName.'), Student status = '.$row->student_status.'") target="_new"><span style="color:red;">'.substr($row->student_name, 0, 30).'</span></strong></a><br/>'.$row->batch_name.'<br/>'.$row->sessionName.'<br/>'.$row->student_status.'</td>';
                                                                endif;
                                                                
                                                                echo '<td><span style="color:red;">'.$hoste_status.'</strong></td>
                                                                      ...
                                                                      $gBalance = $gBalance-$row->old_credit;
                                                                        ...
                                                                        echo ' <td>'.$gBalance.'</td>';
                                                                          ...
                                                                          if($row->ch_status_id == 2):
                                                                              echo '<td><a  href="UnPaidChallan/'.$row->fc_challan_id.'" class="btn btn-warning btn-xs">'. $row->fcs_title.'</a></td>';
...
//                                                             
                                                                      echo     '<td><a href="balanceChallan/'.$row->student_id.'/'.$row->fc_challan_id.'" class="btn btn-danger btn-xs "><span class="fa fa-download">Balance</span></a></td>';
//                                                                     
                                                                 else:
                                                                   echo '<td></td>';  
...
//                                                           
                                                                  ...
                                                                  if($row->ch_status_id == 1):
                                                                       ...
                                                                       if($row->challan_id_lock == 1):
                                                                            echo '<td></td>';
                                                                           echo '<td><a  class="btn btn-warning btn-xs disabled">Cancel</a></td>';
                                                                       
                                                                           else:
                                                                               echo '<td><a href="feeNewHead/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-danger btn-xs "><span class="fa fa-download">Update</span></a></td>';
                                                                           echo '<td><a href="cancelChallanURI/'.$row->fc_challan_id.'" class="btn btn-warning btn-xs ">Cancel</a></td>';
                                                                       endif;
                                                                       ...
                                                                       echo '<td><a  class="btn btn-danger btn-xs disabled"><span class="fa fa-download"> Update</span></a></td>';
                                                                       echo '<td><a  class="btn btn-warning btn-xs disabled"> Cancel</a></td>';
                                                                    endif; 
