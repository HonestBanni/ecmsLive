                ...
                <div style="margin-top: 2px;width:100%;height:710px;margin-right:8px;margin-bottom:9px;float:left;margin-bottom: 2px;">
                    ...
                    <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">
                        ...
                        <tr>
                         ...
                         <tr>
                          <td style="border: 1px solid #000000;">Security Refund Status</td>
                          <td style="border: 1px solid #000000; color: red"><strong><?php 
                          
                                            
                          $security =  $this->db->get_where('student_security',array('student_id'=>$studentInfo->student_id))->row();
                          if(empty($security)):
                            echo '';  
                          else:
                              echo 'Security Refund';
                          endif;
                          ?></strong></td>
                          <td colspan="2" style="border: 1px solid #000000;"><strong>Security Refund Comments:</strong> <?php 
                           if($security):
                            echo $security->comments;  
                          endif;
                           ?></td>
               ...
               foreach($fee_information as $challan_info):
                 ...
                 ?>
                    ...
                    foreach($challan_info->payment_details as $payment_info):
                        $sn++;
                        $fee_class_info = '';
                        if($payment_info->credit_adjust_flag == 1):
                            $fee_class_info = 'info';
                            else:
                            $fee_class_info = 'danger';
                        endif;
                        ...
                        if($payment_info->delete_head == 0):
                                    ...
                                    ?>
                              <tr class='<?=$fee_class_info?>'>

                                        <td class="updateHeads" style="border: 1px solid #000000; width: 11%;  text-decoration: line-through;color: red;" id="<?php echo $payment_info->Fee_details_id?>"><?php echo $payment_info->Fee_heads?></td>

                                      <td style="border: 1px solid #000000; width: 10%; text-decoration: line-through;color: red;"><?php echo $payment_info->Current_Amount?></td>
                                      <td style="border: 1px solid #000000; width: 10%;  text-decoration: line-through;color: red;"><?php echo $payment_info->Credit_Amount?></td>
                                      <td style="border: 1px solid #000000; width: 7%; text-decoration: line-through;color: red;"><?php echo $payment_info->Arrears_Amount?></td>
                                      <td style="border: 1px solid #000000; width: 7%; text-decoration: line-through;color: red;"><?php echo $payment_info->Concession?></td>
                                      <td style="border: 1px solid #000000; width: 7%; text-decoration: line-through;color: red;"><?php echo $payment_info->Paid_Amount?></td>
                                      <td style="border: 1px solid #000000; width: 7%; text-decoration: line-through;color: red;"><?php echo $payment_info->Balance?></td>
                        ...
                        <tr class="<?=$fee_class_info?>">
                                ...
                                <td class="updateHeads"  style="border: 1px solid #000000; width: 11%;" id="<?php echo $payment_info->Fee_details_id?>"><?php echo $payment_info->Fee_heads?></td>
                        ...
                        <tr class="danger">
                             <td colspan="1" style="border: 1px solid #000000; width: 10%;">Credit Status  :<strong><?php echo $challan_info->credit_amount?></strong></td>
                           <?php
                           if($challan_info->fine_id == 1):
                               echo '<td colspan="1" style="border: 1px solid #000000; width: 11%;"></strong></td>';
                               else:
                               echo '<td colspan="1" style="border: 1px solid #000000; width: 11%;">Credit Amount  :<strong>'.$challan_info->fine_title.'</strong></td>';
                           endif;
                           ?>
                            ...
                            <td colspan="2" style="border: 1px solid #000000; width: 10%;">GROUP:<strong><?php 
                            ...
                            <td colspan="4" style="border: 1px solid #000000; width: 31%;">
                                <?php
                                             $this->db->select('sum(balance) as total_balance');
                                $check_fee = $this->db->get_where('fee_actual_challan_detail',array('challan_id'=>$challan_info->challan_id))->row();
                                 if($check_fee->total_balance > 0 && $studentInfo->s_status_id == 14):
                                     if($balance_amount>0):
                                        echo '<strong><a href="TransferBalance/'.$studentInfo->student_id.'/'.$challan_info->challan_id.'" >Transfer Student Fee</a></strong>';
                                    endif;
                                 endif;
                                ?>
                      ...
                      <?php
                        ...
                        ?> 
                            ...
                            foreach($hostel_row->bill_details as $bill_row):
                              $sn++;
                            $class_hostel = '';
                             if($bill_row->adjust_flag ==1):
                                 $class_hostel = 'danger';
                                 else:
                                 $class_hostel = 'info';
                             endif;
                            ?>
                            <tr class="<?=$class_hostel?>">
...
//                            echo '<pre>';print_r($mess_row);die;
                            foreach($mess_row->bill_details as $mess_bill_row):
                             $sn++;
                            $class = '';
                            if($mess_bill_row->adjust_flag ==1):
                                $class = 'danger';
                            else:
                                $class = 'warning';
                            endif;
                                ...
                                <table class="table table-hover"   id="table" style="margin-bottom: 5px;font-size: 12px;width: 60%;float: left;border: 1px solid;">
                                    ...
                                    <tr class="info">
                                     ...
                                     <tr class="info">
                                        ...
                                        echo @$total_balance+$hoste_balance+$grand_mess_balance-$credit_amount;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Fee Head Details</h4>
      </div>
    ...
    <script>
        jQuery(document).ready(function(){
            ...
            jQuery('.updateHeads').dblclick(function(){
                var detailsId = this.id;
                jQuery('#myModal').modal('toggle');
                jQuery.ajax({
                    'type'      : 'post',
                    'url'       : 'UpdateFeeHeadDetails',
                    'data'      : {'detailsId':detailsId},
                    'success'   : function(result){
                        jQuery('#FeeDetails').html(result);
                    }
                });
            });
        });
