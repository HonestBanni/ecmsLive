                                                          ...
                                                          foreach($result as $row):
                                                              $challan_checking = $this->CRUDModel->get_where_row('fee_challan',array('fc_student_id'=>$row->student_id));
                                                                ...
                                                                echo '<tr ">
                                                                    ...
                                                                    <td><a href="annualFeeBill/'.$row->student_id.'"  class="productstatus"><button type="button" class="btn btn-info btn-xs"> Generate Challan </button></a></td>
                                                              ...
                                                              echo '<tr">
                                                                    ...
                                                                    <th><a href="updateChallanUri/'.$challan_checking->fc_challan_id.'"  class="productstatus"><button type="button" class="btn btn-danger btn-xs"><i class="fa fa-print"></i> Update To Annual Fee </button></a></th>
...
//                                                             <th><a href="feeChallanPrintAdmission/'.$challan_checking->fc_challan_id.'/'.$row->student_id.'"  class="productstatus"><button type="button" class="btn btn-theme btn-xs"><i class="fa fa-print"></i> Print </button></a></th> 
