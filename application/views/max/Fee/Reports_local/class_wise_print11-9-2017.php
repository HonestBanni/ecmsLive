                ...
                <div class="table-responsive">
                  <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;"  >
                    <tbody>
                      ...
                      <td style="border-top: 0px solid #000000;"> <strong><?php echo date_format(date_create($stdInfo->fc_dueDate),"d-M-Y")?></strong> </td>  
                    </tr>
                  </tbody></table>       
                  <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">    
                    <tbody><tr>
                  ...
                  <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">    
                    <tr>
                      ...
                      <td style="border-top: 0px solid #000000;"> <strong><?php  echo  date('d-M-Y',strtotime($stdInfo->fc_issue_date));
                       ?> </strong> </td>
...
//                                     echo $pc_id->title.'   ('.$pc_id->name.')'; 
                      ...
                      <td style="border-top: 0px solid #000000;"> <strong><?php echo $stdInfo->form_no?> </strong> </td>
