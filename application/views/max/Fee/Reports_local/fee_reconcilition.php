                        ...
                        <table class="table table-hover" id="table">
                              ...
                              <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td colspan=" "><strong>Total Credit</strong></td>
                                      <td></td>
                                     <td><strong><?php echo $paidgrandTotal?></strong></td>
                                    <td><strong><?php echo $fc_challan_credit_amount?></strong></td>
                                ...
                                <tr>
                                    ...
                                    <td><strong>Total</strong></td>
                                     ...
                                     <td></td>
                                    <td><strong><?php echo $paidgrandTotal + $fc_challan_credit_amount?></strong></td>
                                    <td></td>
                                    <td></td>
                        ...
                        <table class="table table-hover" id="table">
                              ...
                              <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><strong><?php echo $grandTotal + $total_credit?></strong></td>
                        ...
                        <table class="table table-hover" id="table">
                              ...
                              <tr>
                                    ...
                                    <td><strong><?php 
                                        ...
                                        $this->db->join('student_record','student_record.student_id=fee_challan.fc_student_id','left outer');
                              ...
                              <tr>
                                    ...
                                    <td><strong><?php echo $grandTotal + $grandCredit?></strong></td>
...
//                                        $where['fee_actual_challan_detail.fee_id']  = $fee_id;
                              ...
                              <tr>
                                    ...
                                    <td></td>
                                    <td><strong>Total Credit </strong></td>
                                    <td><strong><?php echo $fee_amount_credit->fc_challan_credit_amount?></strong></td>
                              ...
                              <tr>
                                    ...
                                    <td></td>
                                    <td><strong>Grand Total</strong></td>
                                    <td><strong><?php echo $grandTotal+$fee_amount_credit->fc_challan_credit_amount?></strong></td>
