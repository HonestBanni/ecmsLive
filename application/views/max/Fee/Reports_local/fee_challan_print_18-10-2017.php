                            ...
                            $where =array(
                                        ...
                                        if($feeComments->fc_pay_cat_id == 0):
                                         echo 'Other Challan';
                                            ...
                                            if(!empty($pc_id)):
                                        echo '<strong>'.$pc_id->title.'</strong>';   
                                           else:
...
<!--                      <td style="border-top: 0px solid #000000;">Form# </td>
                      <td style="border-top: 0px solid #000000;"> <strong><?php   $studentInfo->form_no?> </strong> </td>
                   -->
                    </tr>
...
//                             endif;
                        ...
                        $total = $total_arrears+$total_arrears2;
                        echo '<table class="table table-hover" id="table" style="margin-bottom: 1px; border: 1px solid;">    
                       <tr>
