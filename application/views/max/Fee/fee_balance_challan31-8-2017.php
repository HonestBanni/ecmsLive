                        ...
                        <div class="row">
                                  <div class="col-md-3">
                                    <label for="name">From Date</label>
                                        ...
                                        $from_date = '';
                                        if(@$result[0]->fc_paid_form):
                                            $from_date = date('d-m-Y',strtotime($result[0]->fc_paid_form));
                                            else:
                                    ...
                                    <div class="col-md-3">
                                        <label for="name">Up To Date</label>
                                            <?php 
                                            $from_to = '';
                                        if(@$result[0]->fc_paid_upto):
                                            $from_to = date('d-m-Y',strtotime($result[0]->fc_paid_upto));
                                            else:
                                            $from_to = date('d-m-Y');
                                        endif;
