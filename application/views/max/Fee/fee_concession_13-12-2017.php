                               ...
                               <div class="col-md-3">
                                    <label for="name">Concession Type</label>
                                        <?php 
                                           ...
                                           echo form_dropdown('concession_type_id', $concession_type,'', ' class="form-control" required="required" ');
                                                        ...
                                                        $grand_paid_amount = '';
                                                          ...
                                                          foreach($result as $row):
                                                            ...
                                                            echo '<tr ">
                                                                ...
                                                                <th><input name="update_installment[]" class="update_installment" value="'.$con_amount.'"></th>
                                                                <th><input name="update_installment[]" class="update_installment" value="'.$row->actual_amount.'"></th>
