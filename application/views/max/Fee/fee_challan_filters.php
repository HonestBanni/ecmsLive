                                              ...
                                              <table class="table table-hover" id="table" style="font-size:11px;">
                                                    <thead>
                                                      <tr style="border: 1px solid #000000;">
                                                          ...
                                                          <th style="border: 1px solid #000000;">New Challan</th>
                                                          <th style="border: 1px solid #000000;">Print</th>
                                                          <th style="border: 1px solid #000000;">New Head</th>
                                                          <th style="border: 1px solid #000000;">Canel</th>
...
//                                                                    if($row->fc_challan_type == 2):
//                                                                        echo '<td style="border: 1px solid #000000;">'.$row->fee_installment.'<br/>Installment Challan</td>';
//                                                                    else:
//                                                                        echo '<td style="border: 1px solid #000000;">'.$row->fee_installment.'</td>'; 
//                                                                    endif;  
...
//                                                                          echo '<pre>';print_r($check_last_challan);die;
                                                                          if($row->ch_status_id == 2):
                                                                              if($check_last_challan == $row->fc_challan_id):
                                                                                  echo '<td style="border: 1px solid #000000;"><a  href="UnPaidChallan/'.$row->fc_challan_id.'" class="btn btn-warning btn-xs">'. $row->fcs_title.'</a></td>';
                                                                                  else:
...
//                                                             
                                                                      echo     '<td style="border: 1px solid #000000;"><a href="balanceChallan/'.$row->student_id.'/'.$row->fc_challan_id.'" class="btn btn-danger btn-xs "><span class="fa fa-download">Balance</span></a></td>';
//                                                                     
                                                                 else:
...
//                                                           
                                                                  ...
                                                                  if($row->ch_status_id == 1):
                                                                        ...
                                                                        echo '<td style="border: 1px solid #000000;">';
                                                                                 ...
                                                                                 $this->db->order_by('fc_challan_id','desc');
                                                                        $check = $this->db->get_where('fee_challan',array('fc_student_id'=>$row->student_id,'fc_ch_status_id'=>1))->row();
                                                                        if($check->fc_challan_id == $row->fc_challan_id):
                                                                            echo '<a href="feeChallanPrintPDC/'.$row->fc_challan_id.'/'.$row->student_id.'" target="_blank"  class="btn btn-theme btn-xs"><span class="fa fa-print"> PDC</span></a><br/><br/>';
                                                                        endif;
                                                                        echo '<a href="feeChallanPrint/'.$row->fc_challan_id.'/'.$row->student_id.'" target="_blank"  class="btn btn-success btn-xs"><span class="fa fa-print"> Print</span></a><br/><br/>';
                                                                        '<a href="EnvelopePrintPage/'.$row->student_id.'" target="_blank"  class="btn btn-danger btn-xs"><span class="fa fa-print">  Envelope</span></a>';
                                                                          
                                                                        echo '</td>';
                                                                       
                                                                       
                                                                       if($row->challan_id_lock == 1):
                                                                            echo '<td style="border: 1px solid #000000;"></td>';
                                                                           echo '<td style="border: 1px solid #000000;"><a  class="btn btn-warning btn-xs disabled">Cancel</a></td>';
                                                                       
                                                                           else:
                                                                               echo '<td style="border: 1px solid #000000;"><a href="feeNewHead/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-danger btn-xs "><span class="fa fa-download">Update</span></a></td>';
                                                                           echo '<td style="border: 1px solid #000000;"><a href="cancelChallanURI/'.$row->fc_challan_id.'" class="btn btn-warning btn-xs ">Cancel</a></td>';
                                                                       endif;
                                                                        
                                                                        else:
                                                                              
                                                                   
                                                                       echo '<td style="border: 1px solid #000000;"><a  class="btn btn-success btn-xs"><span class="fa fa-print"> Print</span></a></td>';     
                                                                       echo '<td style="border: 1px solid #000000;"><a  class="btn btn-danger btn-xs disabled"><span class="fa fa-download"> Update</span></a></td>';
                                                                       echo '<td style="border: 1px solid #000000;"><a  class="btn btn-warning btn-xs disabled"> Cancel</a></td>';
                                                                    endif; 
