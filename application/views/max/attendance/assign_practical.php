...
<form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>AttendanceController/assign_practical_groups">
    <div class="form-group col-md-3">
            <label for="usr">Student Name</label>
       <input type="text" value="<?php echo $result->student_name;?>" class="form-control" readonly> 
       <input type="hidden" name="student_id" value="<?php echo $result->student_id;?>" class="form-control" > 
   </div>
    <div class="form-group col-md-3">
            <label for="usr">Father Name:</label>
            <input type="text" value="<?php echo $result->father_name;?>" class="form-control" readonly> 
   </div>
    <div class="form-group col-md-3">
            <label for="usr">College No</label>
        <input type="text" value="<?php echo $result->college_no;?>" class="form-control" readonly>
    </div>
    <div class="form-group col-md-3">
   ...
   <div class="form-group col-md-12"> 
    ...
    ?>
         <div class="form-group col-md-2">
            ...
            <input type="checkbox" name="checked[]" value="<?php echo $rec->prac_group_id; ?>">
            <strong><?php echo $rec->group_name; ?></strong> 
