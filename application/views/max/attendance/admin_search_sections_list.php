<div class="content container">
    <h2 align="left">Teacher Subjects List<hr></h2>
        <div class="row cols-wrapper">
            <div class="col-md-12">    
                <form method="post" action="AttendanceController/admin_search_section">
                ...
                <div class="col-md-12">
                    ...
                    ?>     
                        <div class="col-md-2 col-xm-4">
                            <p class="promo-badge">
                                <a class="RedDamask" href="AttendanceController/admin_studentsAtts/<?php echo $row->class_id;?>/<?php echo $row->sec_id;?>">    
    ...
    echo count($this->AttendanceModel->get_studentsAtts('student_group_allotment',$where)); 
               ...
               ?>               
                        <div class="col-md-2 col-xm-4">
                            <p class="promo-badge">
                                <a class="RedDamask" href="AttendanceController/admin_studentsSubjectsAtts/<?php echo $row->class_id;?>/<?php echo $row->sec_id;?>/<?php echo $row->subject_id;?>">
