...
<div class="content container">
    ...
    <h4 style="color:red; text-align:center;"><?php print_r($this->session->flashdata('msg'));?></h4>
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>AttendanceController/update_marks/<?php echo $serial_no;?>/<?php echo $tst_id;?>/<?php echo $emp_id;?>/<?php echo $subject_id;?>/<?php echo $sec_id;?>">
