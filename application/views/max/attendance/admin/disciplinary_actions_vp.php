  ...
  <div class="page-wrapper">
        ...
        <div class="col-md-12 col-sm-12">   
            <h2 align="left">Disciplinary Actions 
                <span  style="float:right">
                    <a href="AttendanceController/add_disc_action_vp" class="btn btn-large btn-primary">Add Disciplinary Action</a>
                </span>
                <hr>
            </h2>
    ...
    <table class="table table-boxed">
        ...
        ?>    
            ...
            <td><a href="EditWhiteCardRemarksDA/<?php echo $row->proc_id;?>" class="btn btn-theme">WC Remarks</a></td>   
            <td>
            <?php
            if(!empty($curr_user)):
                if($curr_user == $row->proc_user_id):
                    echo '<a href="EditDisciplinaryActionVP/'.$row->proc_id.'" class="btn btn-primary">Update</a>';
                endif;
            endif;
            ?>
            </td>  
