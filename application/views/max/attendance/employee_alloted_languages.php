        ...
        <div class="content container">
            ...
            ?>
        <h2 align="left"> <strong style="color:green">Languages </strong>Attendance List<hr></h2>
            ...
            <div class="col-md-2 col-xm-4">
                <p class="promo-badge">
                    <a class="RedDamask" href="AttendanceController/studentslanguageAtts/<?php echo $row->programe_id;?>/<?php echo $row->batch_id;?>">
