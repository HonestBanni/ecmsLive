...
<!-- ******CONTENT****** --> 
        <div class="content container">
          ...
          <form name="std" method="post" action="AttendanceController/pre_board_sectionbasetest">   
                ...
                <?php
                    ...
                    ?>
                        <tr class="gradeA">
                            ...
                            <td><input type="text" id="textOmarks" name="omarks[]"  placeholder="Obtained Marks" class="form-control checkBoard"></td>
