    ...
    $test_id = $this->uri->segment(3);
     $total = $this->db->query("SELECT * FROM monthly_test_details WHERE test_id = '$test_id'");?>
            ...
            <td><img src="assets/images/students/<?php echo $rec->applicant_image;?>" width="60" height="50"></td>
                ...
                <td><a href="AttendanceController/update_marks/<?php echo $rec->serial_no; ?>/<?php echo $test_id; ?>/<?php echo $emp_id; ?>/<?php echo $subject_id; ?>/<?php echo $sec_id; ?>" class="btn btn-theme btn-sm">Update</a></td>   
                        </tr>
                        <?php
                        $i++;
                        }
