...
<!--                     <tr>
                        <td>2</td>
                        <td>HSSC Part I (Evening)</td>
                        <?php
                        $gender_total   = 0;
                        $male           = 0;
                        $female         = 0;
                        foreach($gender_1st_year_eve as $gender_row):
                        if($gender_row->gender_id == 1):
                            $male ++;
                            else:
                             $female ++;   
...
<!--                     <tr>
                        <td>4</td>
                        <td>HSSC Part II (Evening)</td>
                        <?php
                        $gender_total   = 0;
                        $male           = 0;
                        $female         = 0;
                        foreach($gender_2nd_year_eve as $gender_row):
                        if($gender_row->gender_id == 1):
                            $male ++;
                            else:
                             $female ++;   
...
<!--
                     <tr>
                        ...
                        <td>Bsc 3 <sup>rd</sup> Years</td>
-->
                        <?php
//                        $gender_total   = 0;
//                        $male           = 0;
//                        $female         = 0;
//                        foreach($BSC_3rd as $gender_row):
//                        if($gender_row->gender_id == 1):
//                            $male ++;
//                            else:
//                             $female ++;   
...
<!--                    </tr>-->
    ...
    <!--                 <tr>
                        ...
                        <td>BA 3 <sup>rd</sup> Years</td>
-->
                        <?php
//                        $gender_total   = 0;
//                        $male           = 0;
//                        $female         = 0;
//                        foreach($Ba_3rd as $gender_row):
//                        if($gender_row->gender_id == 1):
//                            $male ++;
//                            else:
//                             $female ++;   
...
<!--                    </tr>-->
                     <tr>
                        ...
                        <td>BA 4 <sup>th</sup> Years</td>
                        <?php
                        $gender_total   = 0;
                        $male           = 0;
                        $female         = 0;
                        foreach($Ba_4th as $gender_row):
                        if($gender_row->gender_id == 1):
                            $male ++;
                            else:
                             $female ++;   
                    ...
                    if($A_level_record):
                         ...
                         foreach($A_level_record as $alevel_row):
                          echo ' <tr>';
                                
                                echo '<td>'.$alevel_row->al_title.'</td>';
                                echo '<td>'.$alevel_row->male.'</td>';
                                echo '<td>'.$alevel_row->female.'</td>';
                                echo '<td>'.$alevel_row->gender_total.'</td>';
                                
                            echo '</tr>';
                             $total          += $alevel_row->gender_total;
                            $male_total     += $alevel_row->male;
                            $female_total   += $alevel_row->female;
                         endforeach;
                      endif;
                      ?>
                       <tr> 
            ...
            <div class="widget-content">
                ...
                <tbody>
                     ...
                     <tr>
                      ...
                      <tr>
                        <td>A-LEVEL 1<sup>st</sup> Year</td>
                        <?php
                        $relg_total         = 0;
                        $Muslim             = 0;
                        $Christian          = 0;
                        ...
                        $Sikh               = 0;
                        $other              = 0;
                        foreach($AL_1_gender as $gender_row):
                        if($gender_row->religion_id == 1):
                             $Muslim ++;
                        endif;    
                        if($gender_row->religion_id == 2):
                      ...
                      <tr>
                        ...
                        <td>A-LEVEL 2<sup>nd</sup> Year</td>
                        ...
                        $Sikh               = 0;
                        $other              = 0;
                        foreach($AL_2_gender as $gender_row):
                        if($gender_row->religion_id == 1):
                             $Muslim ++;
                        endif;    
                        if($gender_row->religion_id == 2):
