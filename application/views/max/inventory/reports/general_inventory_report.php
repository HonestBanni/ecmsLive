...
<div class="content container">
                        ...
                        <div class="section-content" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                          <button type="button" name="search" value="search" id="searchDetailsGeneral" class="btn btn-theme"><i class="fa fa-search"></i> Search </button>
                                          <button type="button" name="search" value="search" id="searchDetailsGeneralIteam" class="btn btn-theme"><i class="fa fa-search"></i> Item Wise </button>
  ...
  jQuery('#searchDetailsGeneral').on('click',function(){
  ...
  jQuery('#searchDetailsGeneralIteam').on('click',function(){
        var emp         = jQuery('#emp_id').val();
        var blockName   = jQuery('#blockName').val();
        var itemname    = jQuery('#itemname').val();
        var roomname    = jQuery('#roomname').val();
