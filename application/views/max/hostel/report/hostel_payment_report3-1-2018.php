                                  ...
                                  $grand_total = '';
                                   ...
                                   foreach($row->group as $row_group):
                                        ...
                                        echo '<tr>
                                            ...
                                            <td>'.number_format($row_group->paid_amount, 0, ',', ',').'</td>
                                            </tr>
                                          
                                        ';
                              
                                       $grand_total +=$row_group->paid_amount;
                                       $program_wise_grand +=$row_group->paid_amount;
                                    endforeach;
                                    ...
                                    echo '<tr>
                                            <td></td>
                                            <td></td>
                                            <td>'.number_format($program_wise_grand, 0, ',', ',').'</td>
                                            </tr>
