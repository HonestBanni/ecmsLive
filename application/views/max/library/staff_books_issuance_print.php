...
<img  class='img-responsive' src='assets/images/logo.png' alt='Edwardes College Peshawar'>
--> 
  ...
  <div class="page-wrapper">
     ...
     <h2 align="left"><span  style="float:right">
        ...
        <div style="width:100%; height:110px;margin-bottom:2px;">
            ...
            <div style="width:48%; height:110px;float:left">
                <img style="border-radius:5px;float:right;margin-right:50px;" width="80" height="60" class='img-responsive' src='assets/images/employee/<?php echo $emp_data->picture;?>'>
            </div>
        </div>
        <h3 align="left"><strong><?php echo $emp_data->emp_name;?> <small>(Designation: <?php echo $emp_data->desg;?> | Department: <?php echo $emp_data->dept;?>)</small></strong></h3>    
    <p style="font-size:18px; text-align:center"><u>Books Reminder</u></p>
            ...
            <strong>Remarks/Note:</strong> <?php if(@$comnts): echo $comnts->comments;endif;
