...
//                                            $recordToCode     = $recordToCode;
                                    ...
                                    <input type="hidden" name="formCode" id="formCode" value="<?php $rand = rand(1,10000000); $date = date('YmdHis'); echo md5($rand.$date);?>">
                                     ...
                                     <div class="col-md-3 col-sm-5">
                                         <div style="padding-top:9.5%;">
                                             <button type="button" class="btn btn-theme" name="search_brs" id="search_hm_brs"  value="search_hm_brs" ><i class="fa fa-search"></i> Search COA</button>
                                         </div>
                            ...
                            <div style="padding-top:1%;">
                                <div class="col-md-6 pull-right">
                                    <button type="button" class="btn btn-theme" name="up_checks_hm" id="up_checks_hm"  value="up_checks_hm" ><i class="fa fa-plus"></i> Add Vouchers</button>
                                  </div>
                            </div>
                            <hr/>
                            ...
                            <div style="padding-top:1%;">
                                <div class="col-md-6 pull-right">
                                    ...
                                    <button type="button" class="btn btn-theme" name="add_unpresent_amount_hm" id="add_unpresent_amount_hm"  value="add_unpresent_amount_hm" ><i class="fa fa-plus"></i> Update Amount</button>
                                    <button type="button" class="btn btn-theme" name="save_checks_hm" id="save_checks_hm"  value="save_checks_hm" ><i class="fa fa-book"></i> Save</button>
                                             ...
                                             <td>&nbsp;</td>
                                                ...
                                                $coacs = $this->CRUDModel->get_where_result('fn_coa_master_sub_child',array('fn_coa_mc_status'=>1,'fn_coa_mc_mId'=>$coacRow->fn_coa_m_cId));
                                                        ...
                                                        foreach($coacs as $coacsRow):
                                                             ...
                                                             echo ' <tr class="recordFrom3rdhm" id="'.$coacsRow->fn_coa_mc_title.','.$coacsRow->fn_coa_mc_id.','.$coacsRow->fn_coa_mc_code.'">
                                                                        <td>&nbsp;</td>
...
//        jQuery('#myModal').modal('toggle');
        jQuery('#HmRecordFrom').val(array[0]);
        jQuery('#HmRrecordFromCode').val(array[1]);
