...
//                                                           $sn++;
                                                            echo '<tr">
                                                                <td colspan="2" style="border-top:1px solid rgba(0, 0, 0, 0);">'.date('d-m-Y', strtotime($row->gl_at_date)).'</td>
                                                                <td style="border-top:1px solid rgba(0, 0, 0, 0);">'.$row->gl_at_vocher.'</td>
                                                                <td style="border-top:1px solid rgba(0, 0, 0, 0);">'.$row->ftt_title.'</td>
                                                                <td style="border-top:1px solid rgba(0, 0, 0, 0);">'.$row->gl_at_payeeId.'</td>
                                                                <td style="border-top:1px solid rgba(0, 0, 0, 0);">'.$row->gl_at_cheque.'</td>
                                                                
                                                                <td style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                                <td style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                                <td style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                            ...
                                                            $sn = '';
                                                                ...
                                                                foreach($details as $dRow):
                                                                    echo '  <tr">
                                                                        ...
                                                                        <td colspan="2" style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);">'.$dRow->gl_ad_coa_mc_name.'</td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);">'.number_format($dRow->gl_ad_depit, 0, ',', ',').'</td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);">'.number_format($dRow->gl_ad_credit, 0, ',', ',').'</td>
                                                                    </tr>';
                                                          ...
                                                          $x = array_rand($class);
                                                                echo '  <tr">
                                                                        ...
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);"> </td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);">Total</td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);">'.number_format($TotalDebit, 0, ',', ',').'</td>
                                                                        <td style="border-top:1px solid rgba(0, 0, 0, 0);">'.number_format($TotalCredit, 0, ',', ',').'</td>
                                                                    </tr>';
                                                                
                                                                echo '  <tr>
                                                                        <td  colspan="9" style="border-top:1px solid rgba(0, 0, 0, 0);">( Description :
