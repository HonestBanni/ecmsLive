                                    ...
                                    <div class="col-md-12" style="margin-left:40px">
                                        ...
                                        if(!empty($balance_sheet)):
                                           ...
                                           $CROSS_CHECK = ''; 
                                            ...
                                            foreach($balance_sheet as $GLRow):
                                            ...
                                            $where = array(
                                                ...
                                                $open_balance       = $this->FinanceModel->open_balance($where);
                                                 ...
                                                 $where_gg_amount = array(
                                                   'gl_ad_coa_mc_pk'        => $GLRow->gl_ad_coa_mc_pk,  
                                                   'fn_account_type_id'     => 3 
                                                 );   
                                                $detail = $this->FinanceModel->get_amountDetails_balance_sheet('gl_amount_transition',$where_gg_amount,$dateFrom,$dateTo);
                                        ...
                                        if(!empty($balance_sheet)):
                                          ...
                                          <tr>
                                              <td colspan="3" style="text-align:  left; font-size: 20px; font-weight: bold;  width: 5%">LIABILITIES</td>
                                        ...
                                        <?php
                                           ...
                                           $TOTAL_LIABILITIES        = ''; 
                                            ...
                                            foreach($balance_sheet as $GLRow):
                                             ...
                                             if($GLRow->gl_ad_coa_mc_id >=200000 && $GLRow->gl_ad_coa_mc_id <=299999):
                                            ...
                                            $where = array(
                                                ...
                                                $detail = $this->FinanceModel->get_amountDetails(
                                                        'gl_amount_transition',
                                                        array('gl_ad_coa_mc_pk'=>$GLRow->gl_ad_coa_mc_pk,'gl_amount_transition.fn_account_type_id'=>3),$dateFrom,$dateTo);
                                            ...
                                            echo '<tr>';
                                                ...
                                                echo '<td style="text-align:  right;width:10%;"><strong>';
                                                    if($NET_INCOME): 
                                                        $TOTAL_LIABILITIES = $final_total_close_credit;
                                                        echo number_format($NET_INCOME, 0, ',', ',');
                                                    endif;
                                                echo '</td></strong>';
                                            echo '</tr>';
                                        
                                            echo '<tr>';
                                                echo '<td colspan="2" style="text-align=;text-align: right; width: 5%"><strong>TOTAL LIBILITIES [PKR]&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>';
                                                echo '<td style="text-align:  right;width:10%;"><strong>';
                                                
                                                
                                                $GRAND_NET_INCOME = $NET_INCOME+$TOTAL_LIABILITIES; 
                                                if($GRAND_NET_INCOME): 
                                                       echo number_format($GRAND_NET_INCOME, 0, ',', ',');
                                                    endif;
                                                echo '</td></strong>';
                                            echo '</tr>';
                                                
                                            echo '<tr>';
                                                echo '<td colspan="3" style="text-align=;text-align: right;width: 5%;border-left: 1px solid #ffffff;border-right: 1px solid #ffffff;"><strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>';
                                            echo '</tr>';
                                           
                                                 //ASSETS DETAILS
                                           echo '<tr>
                                              <td colspan="3" style="text-align:  left; font-size: 20px; font-weight: bold;  width: 5%">ASSETS</td>
                                             </tr>';
                                           ...
                                           $final_total_close_credit = '';
                                            ...
                                            echo '<tr>';
                                            echo '<td colspan="2" style="text-align=;text-align: right; width: 5%"><strong>TOTAL ASSETS [PKR]&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>';
                                             
                                           
                                            echo '<td style="text-align:  right;width:10%;"><strong>';
                                            if($final_total_close_debit): 
                                                $TOTAL_ASSETS = $final_total_close_debit; 
                                                echo number_format($final_total_close_debit, 0, ',', ',');
                                            endif;
                                            echo '</td></strong>';
                                             
                                             $CROSS_CHECK = $TOTAL_ASSETS-$GRAND_NET_INCOME;
                                            echo '</tr>';
                                                echo '<tr>';
                                                echo '<td colspan="2" style="text-align=;text-align: right; width: 5%"><strong>CROSS CHECK  = (NET-INCOME - TOTAL ASSETS)&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>';
                                                echo '<td style="text-align:  right;width:10%;"><strong>';
                                                
                                                if($CROSS_CHECK): 
                                                     echo number_format($CROSS_CHECK, 2, '.', ',');
                                                     else:
                                                         echo 0;
                                                endif;
