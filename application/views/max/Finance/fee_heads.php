...
<div class="content container">
  <div class="page-wrapper">
    <header class="page-heading clearfix">
      <h1 class="heading-title pull-left">Chart Of Account Master 
      </h1>
      <div class="breadcrumbs pull-right">
        <ul class="breadcrumbs-list">
          ...
          <li class="current">Chart Of Account Master
        </ul>
      </div>
      <!--//breadcrumbs-->
    </header> 
                  ...
                  $sn = 1;
                   foreach($coa_master as $urRow):
                      ...
                      echo '<tr>
                                ...
                                <td>'.$status.'</td>
                                <td><a href="coa_master_child/'.$urRow->fn_coa_m_cId.'" class="productstatus" ><span class="fa fa-book text-navy"></span></a></td>
