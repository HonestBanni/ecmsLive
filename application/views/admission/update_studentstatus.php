...
//            $b = $this->db->query("SELECT * FROM student_status WHERE s_status_id in(5,6,7,8,10,12,13,14,9,1)");
            $b = $this->db->query("SELECT * FROM student_status WHERE s_status_id in(5,6,7,8,10,12,13,20)");
            ...
            <?php
             ...
             $hostel_enrolled = $this->CRUDModel->get_where_row('hostel_student_record',array('student_id'=>$result->student_id));
            if($hostel_enrolled):
                 $hostel_status = $this->CRUDModel->dropdown('hostel_status','Select Hostel','hostel_status_id','status_name');
             ?>
        <div class="form-group col-md-3">
            <label>Hostel Status:</label>
            <?php
            
//                echo form_dropdown('h_status_id', $hostel_status,'',  'class="form-control" required="required"');
                echo form_dropdown('h_status_id', $hostel_status,$hostel_enrolled->hostel_status_id,  'class="form-control" required="required"');
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="admission_comment" class="form-control" required="required">
        </div>
        <div class="form-group col-md-2">    
            <label style="visibility: hidden;">Status Comment:</label>
