        ...
        <div class="content container">
               <!-- ******BANNER****** -->
    <h3 align="left">All Students (Computer Science)<span  style="float:right"><a href="<?php echo base_url();?>admin/add_cs_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h3>        
            <div class="row cols-wrapper">
                <div class="col-md-12">
                    <form method="post" action="admin/search_cs_student">
  ...
  <img src="<?php echo base_url();?>assets/images/students/<?php echo $rec->applicant_image;?>" style="border-radius:10px;" width="80" height="80">
                <?php 
                    ...
                    <td><?php echo $rec->college_no;?></td>
                            ...
                            <td><a href="<?php echo base_url();?>admin/update_cs_studentstatus/<?php echo $rec->student_id;?>"><?php echo $rec->student_status;?></a></td>
    <td><a class="btn btn-primary btn-sm" href="<?php echo base_url();?>admin/cs_update_student/<?php echo $rec->student_id;?>"><b>Edit</b></a></td>
    <td><a class="btn btn-danger btn-sm" href="<?php echo base_url();?>admin/upload_bcs_sphoto/<?php echo $rec->student_id;?>"><b>Add Pic</b></a></td>
