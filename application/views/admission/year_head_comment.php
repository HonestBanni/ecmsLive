        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Year Head Comment<hr></h2>
...
$i = 1;
 ...
 <td><a href="<?php echo base_url();?>admin/student_profile/<?php echo $student_id;?>">
      <span style="font-size:15px;"><?php echo $student_name;?></span></td>
...
<td>
   <a class="btn btn-success btn-sm" href="<?php echo base_url();?>admin/year_head_edit_student/<?php echo $student_id;?>">Update</a>
</td>
    </tr>
<?php
}
