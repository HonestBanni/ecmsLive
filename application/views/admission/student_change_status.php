        ...
        <div class="form-group col-md-2">
            ...
            <?php 
            $sb = $this->db->query("SELECT * FROM student_status WHERE s_status_id in(5,6,7,8,10,12,13,20)");
            foreach($sb->result() as $sbrec)
            {
            ?>
                <option <?php if($s_status_id == $sbrec->s_status_id ): echo 'Selected'; endif;?> value="<?php echo $sbrec->s_status_id;?>"><?php echo $sbrec->name;?></option>
            <?php
            }
            ?>
        </select>
