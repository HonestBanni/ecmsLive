...
<div class="content container">
       <!-- ******BANNER****** -->
<h2 align="center">Update Student (German Language)</h2>    
        ...
        <div class="form-group col-md-3">
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM programes_info WHERE programe_id='11'");
            ...
            <option type="text" value="<?php echo $grec->sub_pro_id;?>"><?php echo $grec->name;?></option>
             ...
             <?php
                ...
                ?>
                  <div class="form-group col-md-3">
                  <label for="usr">Sub Program:</label>
               <select class="form-control" type="text" name="sub_pro_id" required>
                   <?php
            $gres = $this->get_model->get_by_id('sub_programes',array('sub_pro_id'=>$sub_pro_id));
                if($gres){
                    foreach($gres as $grec){ ?>                   
            ...
            echo '<option type="text" value=""></option>';
                ...
                ?>
                    ...
                    <?php 
                        $sb = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=11");
    ...
    <div class="form-group col-md-3">
                ...
                <select class="form-control" type="text" name="batch_id">
                <?php
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM prospectus_batch WHERE  `programe_id`=11");
                    foreach($b->result() as $brec)
                    {
                    ?>
            ...
            <div class="form-group col-md-3">
                ...
                <select class="form-control" type="text" name="lang_status_id">
                <?php
            $gres = $this->get_model->get_by_id('student_status_lang',array('lang_status_id'=>$lang_status_id));
                if($gres){
                    foreach($gres as $grec){ ?>                   
            <option type="text" value="<?php echo $grec->lang_status_id;?>"><?php echo $grec->name;?></option>
                 <?php 
                    }     
                }else{
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->CRUDModel->getResults("student_status_lang");
                    foreach($b as $brec)
                    {
                    ?>
                <option value="<?php echo $brec->lang_status_id;?>"><?php echo $brec->name;?></option>
                    <?php 
                    }
                    ?>
            </select>  
    ...
    <input type="submit" class="btn btn-theme" name="submit" value="Update Student">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped	 display" width="100%">
                    ...
                    foreach($q->result() as $rec)  
                    {
                        ...
                        $d = $this->db->query("SELECT * FROM degree WHERE degree_id = '$degree_id'");
                       
                        $bu = $this->db->query("SELECT * FROM board_university WHERE bu_id = '$bu_id'");
                        foreach($bu->result() as $burec);
                        /*
                        $i = $this->db->query("SELECT * FROM institute WHERE inst_id = '$inst_id'");
                        foreach($i->result() as $irec);
                        ...
                        */
                        ...
                        <tr class="gradeA">
                            ...
                            <td><?php echo $drec->title;?></td>
                            <td><?php echo $burec->title;?></td>
                            ...
                            <td><a href="admin/update_law_academic/<?php echo $rec->serial_no;?>">Update</a></td>
                        </tr>
