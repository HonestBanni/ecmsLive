        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">All Students Change Status (Admin)<hr></h2>
...
$i = 1;
 ...
 <td><a href="<?php echo base_url();?>admin/student_profile/<?php echo $student_id;?>">
     <span style="font-size:15px;"><?php echo $student_name;?></span></a>    
            ...
            <td>
        <a class="btn btn-primary btn-sm" href="<?php echo base_url();?>admin/update_studentstatus_admin/<?php echo $rec->student_id;?>"><?php echo $rec->status;?></a>
            </td>    
    </tr>
<?php
}
