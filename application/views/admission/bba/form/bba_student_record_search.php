        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <!--<h2 align="left"><?php // echo $title;?><span  style="float:right"><a href="admin/add_bba_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>-->
            <h2 align="left">
                <?php echo $title;?>
...
<!--                       <select name="gender_id" class="form-control">
              ...
              <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-2">
                    <?php 
                      $reserved_seat =  $this->CRUDModel->dropDown('reserved_seat', 'Reserved Seat', 'rseat_id', 'name');
...
<!--                <select name="rseats_id" class="form-control">
                ...
                <div class="form-group col-md-2">
                    <!--<option value="">Admission Status</option>-->
                     <?php 
                      $student_status =  $this->CRUDModel->dropDown('student_status', 'Admission Status', 's_status_id', 'name');
...
foreach($result as $rec)  
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>">
     <span style="font-size:15px;"><?php echo $student_name;?></span></a>    
                    ...
                    <td><a class="btn btn-primary btn-sm" href="admin/update_bba_student/<?php echo $rec->student_id;?>"><b>Edit</b></a></td>
