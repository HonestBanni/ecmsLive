 <!-- ******CONTENT****** --> 
    ...
    <form name="student" method="post" enctype="multipart/form-data" action="admin/add_new_student_record">       
        ...
        <input type="text" placeholder="Father Mobile No (SMS)" name="mobile_no" class="form-control phone"> 
        </div>
        <div class="form-group col-md-3">
        <label for="usr">Applicant Mobile No (SMS):</label>
        <input type="text" placeholder="Applicant Mobile No" name="applicant_mobile_no1" class="form-control phone">        
        </div>
        <div class="form-group col-md-3">
