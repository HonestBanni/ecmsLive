<div class="content container">
    ...
    <div class="page-content">
      <div class="row">
        <form method="post" >
            ...
            <div class="form-group col-md-3">
                <label>College #</label>
                <input type="text" name="college_no" class="form-control" id="checking_college_no"  value="<?php echo $result->college_no;?>">
            </div>
  ...
  $(document).ready(function(){
      $('#updateCollegeNo').on('click', function(){
          $('#updateCollegeNo').hide();
      });
  });
  </script>