        ...
        <a href="AddNewAdmissonInter" class="btn btn-large btn-primary">Add New Student</a></span>
...
//                endif;
                ...
                <?php
                if($rec->s_status_id == 5): ?>
                <td><a class="btn btn-primary btn-sm disabled"><b>Edit</b></a></td>
                <?php else: ?>
                <td><a class="btn btn-primary btn-sm" href="UpdateNewAdmissionInter/<?php echo $student_id.'/'.$rec->sub_id;?>"><b>Edit</b></a></td>
                <?php endif; ?>
                <td><a class="btn btn-danger btn-sm disabled" href="NewAdmissionPicture/<?php echo $student_id;?>"><b>Add Pic</b></a></td>
    </tr>
        <?php
        }
         ?>
