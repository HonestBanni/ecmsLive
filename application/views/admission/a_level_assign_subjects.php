...
<form method="post"  action="admin/a_level_assigning_subject">
...
<div class="form-group col-md-3">
            ...
            <?php
             ...
             if(@$section->section_id){
                 ...
                 ?>          
                <input type="text" readonly="readonly"  name="sec_Name" value="<?php echo @$gres->name; ?>" placeholder="Section" class="form-control">
                <input type="hidden" name="sec_id" id="sec_id" value="<?php echo @$gres->sec_id; ?>">      
                <?php
                
                
            }else{?>
            <input type="text"  readonly="readonly" name="sec_Name" placeholder="Section" class="form-control" >
