    <div class="content container">
            <h2 align="left">Pashto Students Record<span  style="float:right"><a href="admin/add_pashto_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
...
foreach($result as $rec)  
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>">
    ...
    <td><a class="btn btn-primary btn-sm" href="admin/update_pashto_student/<?php echo $rec->student_id;?>"><b>Update</b></a></td>
