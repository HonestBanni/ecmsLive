        ...
        <div class="content container">
            ...
            <h2 align="left">All Students (Inter Level)
                <!--Student status Application Receive-->
                <!--<span  style="float:right"><a href="admin/add_student_record" class="btn btn-large btn-primary">Add New Student</a></span>-->
                <!--Student status Pending-->
                <span  style="float:right"><a href="admin/add_student_record_pending" class="btn btn-large btn-success">Add New Student</a></span>
                <hr>
            </h2>
           ...
           <button type="button" class="btn btn-success">
            ...
            <table class="table table-boxed table-bordered table-striped" style="font-size:11px;">
                    <thead>
                        <tr>
                            <th>PK</th>
                            <th>Picture</th>
...
$i = 1;
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>"><span style="font-size:15px;"><?php echo $student_name;?></span></a>    
                ...
                <td>
                    <?php // if($status == 'Application Receive'):?>
                    <a class="btn btn-primary btn-sm" href="admin/update_student/<?php echo $student_id.'/'.$subProgram_id;?>"><b>Edit</b></a>
                    <?php // else: ?>
                    <!--<a class="btn btn-primary disabled btn-sm"><b>Edit</b></a>-->
                    <?php // endif; ?>
                </td>
    <td><a class="btn btn-danger btn-sm disabled" href="admin/upload_sphoto/<?php echo $student_id;?>"><b>Add Pic</b></a></td>
    </tr>
<?php
}
 ?>
