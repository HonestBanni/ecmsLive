...
<h2 align="center" style="border-bottom:1px solid #ccc;">Update Student (Inter Level)</h2>   
    <div class="row cols-wrapper">
        ...
        <div class="form-group col-md-3">
            ...
            <select name="rseat_id2" class="form-control" disabled="disabled">
                <?php
...
<!--            <div class="form-group col-md-3">
   ...
   <div class="form-group col-md-3">
        ...
        <input type="text" name="student_name" value="<?php echo $row->student_name;?>" class="form-control" disabled="disabled">
        <?php else: ?>
...
<option type="text" value="<?php echo $brec->religion_id;?>"><?php echo $brec->title;?></option>
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-3">
        ...
        <?php else:?>
        <input type="text" name="mobile_no" readonly="readonly" class="form-control phone">
        <?php endif;?>
    </div>
    <div class="form-group col-md-3">
        ...
        <?php else:?>
        <input type="text" name="mobile_no2" readonly="readonly" class="form-control phone">
        <?php endif;?>
    </div>
<div class="form-group col-md-3">
