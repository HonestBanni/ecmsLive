            ...
            <div class="row">
                <article class="contact-form col-md-12 col-sm-7"> 
                    ...
                    <div class="col-md-12" style="min-height:70px;">
                        <?php echo form_open('admin/student_group_inter_1st'); ?>
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group ">
                                    <select type="text" name="sec_id" class="form-control" required>
                                        ...
                                        <?php
                                                $this->db->where_in('sections.sub_pro_id',array(1,2,4,5));
  ...
  <script><!-- comment -->
      ...
      $(document).ready(function(){
            ...
            $("#group_allotment_inter_1st").autocomplete({  
                minLength: 0,
                source: "DropdownController/group_allotment_inter_1st/"+$("#group_allotment_inter_1st").val(),
                autoFocus: true,
                scroll: true,
                dataType: 'jsonp',
