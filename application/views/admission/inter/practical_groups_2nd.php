<div class="content container">
    <h2 align="left">Student Practical Groups Inter Level<span  style="float:right"><a href="AttendanceController/add_prac_group_2nd" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
                ...
                <article class="contact-form col-md-12 col-sm-7">   
                    ...
                    <table class="table table-boxed table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-theme btn-sm" href="AttendanceController/update_prac_group_2nd/<?php echo $pRow->serial_no;?>">Update</a></td>
                            <td><a class="btn btn-danger btn-sm" href="AttendanceController/delete_prac_group_2nd/<?php echo $pRow->serial_no;?>">Delete</a></td>
                        </tr>
                        <?php 
                            $s++;
                            endforeach;
