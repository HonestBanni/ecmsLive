...
<div class="content container">
    ...
    <div class="row cols-wrapper">
        <div class="col-md-12">
            <form method="post" enctype="multipart/form-data" action="UpdateStudentGroupSingle1st/<?php echo $serial_no;?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select type="text" name="section_id" class="form-control">
                               ...
                               <?php
                               $b = $this->db->query("SELECT * FROM sections WHERE status LIKE 'On' AND sections.sub_pro_id IN ('1','2','4','5') order by sections.name asc");
