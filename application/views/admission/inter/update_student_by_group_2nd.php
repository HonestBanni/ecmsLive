...
<div class="content container">
    <h2 align="left">Update Student Group<hr></h2>
    <h4 style="color:red; text-align:center;"><?php print_r($this->session->flashdata('msg'));?></h4>
    <div class="row cols-wrapper">
        <div class="col-md-12">
            <form method="post" enctype="multipart/form-data" action="UpdateStudentGroupSingle2nd/<?php echo $serial_no;?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select type="text" name="section_id" class="form-control">
                               ...
                               <?php
                               $b = $this->db->query("SELECT * FROM sections WHERE status LIKE 'On' AND sections.sub_pro_id IN ('24','25','26','27') order by sections.name asc");
