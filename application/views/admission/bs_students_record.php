...
<!--              <div class="form-group">
            ...
            <div class="form-group">
                <?php 
                echo form_dropdown('s_status_id', $status, $s_status_id,  'class="form-control" required="required"');
                ?>
              </div>
             <div class="form-group">
              ...
              <tbody>
                ...
                ?>
                      <tr>
                          ...
                          <td><a href="admin/student_profile/<?php echo $resRow->student_id;?>"><?php echo $resRow->student_name;?></a></td>
                                <td><?php echo $resRow->father_name;?></td>
                                <td><?php echo $resRow->batch;?></td>
                                <td><?php echo $resRow->programe_name;?></td>
                                <td><?php echo $resRow->subprogram;?></td>
                                <td><?php echo $resRow->sectionName;?></td>
                          <?php
                          if($s_status_id == 5): ?>     
                          <td><span class="btn btn-theme btn-sm"><?php echo $resRow->statusName;?><span></td>
                          <?php  else:?>
                        <td><span class="btn btn-danger btn-sm"><?php echo $resRow->statusName;?><span></td>
                       <?php endif;?>
                    </tr>
                            <?php
                   $sn++;
