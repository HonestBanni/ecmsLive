     ...
     <div class="form-group col-md-3">
      ...
      <?php
       ...
       <?php  
        ...
        <div class="form-group col-md-12">
            <h3 align="left">Disciplinary Comments by VP Office</h3>   
        </div>
                <table class="table table-boxed table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th width="10%">Action Taken by</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    foreach($result_status as $rec){
                        if($rec->action_taken != ''):
                            ...
                            <tr class="gradeA">
                                ...
                                <td><?php echo $rec->other_remarks;?></td>
                                <td><?php echo $rec->action_taken;?></td>
       ...
       <?php  
        ...
        <div class="form-group col-md-12">
            <h3 align="left">Struck off and Suspension Details</h3>   
        </div>
                <table class="table table-boxed table-bordered table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php
                    $i = 1;
                    foreach($strck_off_status as $rec)  
                    {
                        $date = $rec->date;
            $newDate = date("d-m-Y", strtotime($date));
                        ?>
