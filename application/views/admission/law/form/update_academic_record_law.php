    ...
    <div class="content">
        ...
        <div class="module">
            ...
            <div class="module-body">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/update_academic_record_law/<?php echo $id;?>">
            ...
            <input type="hidden" name="old_student_id" value="<?php echo $student_id;?>">
                   ...
                   <div class="form-group col-md-4">
                        <label for="usr">LAT Test Marks:</label>
                        <input type="text" name="lat_marks" value="<?php echo $lat_marks;?>" class="form-control"> 
               </div>
                    <div class="form-group col-md-4">
