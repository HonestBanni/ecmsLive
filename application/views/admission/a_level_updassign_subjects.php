...
<form method="post" enctype="multipart/form-data" action="admin/update_a_level_assigning_subject">
    ...
    <div class="form-group col-md-2">
        ...
        <?php
            ...
            if($gres){
                ...
                { ?>          
                <input type="text" required="required" name="sec_Name" value="<?php echo $grec->name; ?>" placeholder="Section" class="form-control" id="section_a_level">
                <input type="hidden" name="sec_id" id="sec_id" value="<?php echo $grec->sec_id; ?>">      
                <input type="hidden" name="log_sec_id" id="sec_id" value="<?php echo $grec->sec_id; ?>">      
                <?php 
                }     
            }else{?>
            <input type="text" name="sec_Name" placeholder="Section" class="form-control" id="section_a_level" required="required">
            <input type="hidden" name="log_sec_Name" placeholder="Section" class="form-control" id="sec" required="required">  
                <?php
                }    
            ?>                  
    </div>
   <div class="form-group col-md-6"> 
    ...
    <table class="table table-boxed table-hover">
           ...
           <?php
            ...
            <input type="hidden" name="check_log[]" checked value="'.$resRow->subject_id.'" id="checkItem">
            </td>
            <td>'.$resRow->title.'</td>
          </tr>';
                  }else{
