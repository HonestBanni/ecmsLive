        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Inter Subject Allottment (Arts)<hr></h2>
            <div class="row cols-wrapper">
                <div class="col-md-12">
                    <h4>
                        <span style="margin-right:30px;color:#208e4c"><?php echo $pages;?></span> 
                    </h4>
                    <form method="post" action="admin/search_arts_student">
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <?php 
//                                $this->db->like('sub_programes.name','FA');
//                                $this->db->or_like('sub_programes.name','Com');
//                                $q = $this->db->get('sub_programes');
//                                
...
$query = $this->CRUDModel->get_where_row('student_subject_alloted',array('student_id'=>$student_id));
    ...
    { 
    ?>
<a class="btn btn-success btn-sm" href="<?php echo base_url();?>admin/student_updassign_subjects/<?php echo $student_id;?>/<?php echo $rec->sub_pro_id;?>">Update Subjects</a>      
    <?php
    }
    else{
        ?>
   <a class="btn btn-primary btn-sm" href="<?php echo base_url();?>admin/student_assign_subjects/<?php echo $student_id;?>/<?php echo $rec->sub_pro_id;?>">Assign Subjects</a>
<?php
    }            
    ?>    </td>
    </tr>
