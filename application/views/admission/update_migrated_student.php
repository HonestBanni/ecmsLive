    ...
    <div class="form-group col-md-3">
        <label>Student Name:</label>
            <?php        
                ...
                $old_s_status_id = $result->s_status_id;
                ...
                if(!empty($student_id)){
                    ...
                    { ?>          
        <input type="text" name="student_id" value="<?php echo $emprec->student_name; ?>" placeholder="Student Name" class="form-control">
        <input type="hidden" name="student_id" value="<?php echo $emprec->student_id; ?>">  
        <input type="hidden" name="old_s_status_id" value="<?php echo $old_s_status_id;?>">    
                    <?php 
                    }     
                }?>                
            </div>
