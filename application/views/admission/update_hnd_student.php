...
<div class="content container">
       <!-- ******BANNER****** -->
<h2 align="center">Update Student (HND)</h2>    
    ...
    <div class="form-group col-md-3">
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM prospectus_batch WHERE batch_name LIKE '%HND%' OR batch_name LIKE '%BBA%' OR batch_name LIKE '%EDSML%'");
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM programes_info WHERE programe_name LIKE '%HND%' OR programe_name LIKE '%BBA%' OR programe_name LIKE '%EDSML%'");
                    foreach($b->result() as $brec)
                    {
                    ?>
            ...
            echo '<option type="text" value=""></option>';
                ...
                ?>
                    ...
                    <?php 
                        $sb = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=5");
...
<select class="form-control" type="text" name="hostel_required">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" name="mobile_no" value="<?php echo $row->mobile_no;?>" class="form-control phone" readonly>      
    </div>
    <div class="form-group col-md-3">
...
<div class="form-group col-md-12">                       
    <input type="submit" class="btn btn-theme" name="submit" value="Update Student">
                ...
                <br><br>
                <h3 align="center">Student Academic Record Details<hr><span style="folat:right"><a href="<?php echo base_url();?>admin/hnd_student_academic_record/<?php echo $id;?>" class="btn btn-large btn-primary">Add Academic Record</a></span></h3>
            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped	 display" width="100%">
                    ...
                    foreach($q->result() as $rec)  
                    {
                        ...
                        $b = $this->get_model->get_by_id('board_university',array('bu_id'=>$bu_id));
                            ...
                            <td><?php
                        $b = $this->get_model->get_by_id('grade',array('grade_id'=>$grade_id));
                            if($b){
                                foreach($b as $brec){
                                echo $brec->grade_name;
                                    }     
                                        }else{
                                 echo '';
                                            }    
                                        ?></td>
            <td><a href="admin/update_academic_record/<?php echo $rec->serial_no; ?>">Edit</a></td>                
             <td><a href="<?php echo base_url();?>admin/delete_hnd_academic/<?php echo $rec->serial_no;?>" 
           onclick="return confirm('Are You Sure to Delete This..?')"><i class="icon-trash" style="color:red"></i><b>Delete</b></a></td>
                        </tr>
