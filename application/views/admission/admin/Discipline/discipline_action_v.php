...
//                                        $sub_program = array('Sub Program'=>"Sub Program");
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group ">
                                        <?php 
//                                        $sub_program = array('Sub Program'=>"Sub Program");
                                                echo form_dropdown('section', $section,$section_id,  'class="form-control" id="showSections"');
                                        ?>
                                    </div>
                                </div> 
                            </div>
    ...
    foreach($result as $rec):
        ...
        $education_details = $this->CRUDModel->get_where_row('applicant_edu_detail',array('student_id'=>$rec->student_id));
                ...
                if($rec->applicant_image == ''):
                    ...
                    echo '<td><a class="btn btn-primary btn-sm" href="AddDisciplineAction/'.$rec->student_id.'"><i class="fa fa-edit"></i>  <b>Add Action</b></a></td>';
                 echo '</tr>';    
