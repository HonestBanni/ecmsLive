 <!-- ******CONTENT****** --> 
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="center" style="border-bottom:1px solid #ccc;">Add New Student (Degree Level)</h2>
            <div class="row cols-wrapper">
                <div class="col-md-12">
                    <form name="student" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/add_degree_student"> 
 <h3 align="left">Student Admission Information<hr></h3> 
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="sub_pro_id" class="form-control">
                ...
                <?php
                $b = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=4");
                foreach($b->result() as $brec)
                {
                ?>
