...
?>
            ...
            <div class="row cols-wrapper">
                ...
                <form name="student" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/upload_sphoto_adding_picture/<?php echo $id;?>">
Batch Name:<span style="margin-left:290px;">Program: </span><span style="margin-left:300px;">Sub Program: </span><br>
                ...
                <input style="width:33%; height:30px;" type="text" value="<?php echo $sprec->name;?>"><br><br>
                   <div class="control-group">
                        ...
                        <div class="controls">
                        <input style="margin-left:300px" type="file" name="applicant_image" data-original-title="" class="span8 tip" required>
                        </div>
                    </div>
                    <div class="control-group">
            <div class="controls">
