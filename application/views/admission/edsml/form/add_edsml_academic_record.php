<?php
        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Add Student Academic EDSML<hr></h2>
...
<form  method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/edsml_student_academic_records/<?php echo $student_id;?>">
    ...
    <div class="form-group col-md-4">
        <input type="submit" class="btn btn-theme" name="submit" value="Add Record">
                ...
                <br><p>If Academic Details Completed Then Click on Done Button, Thanks... <a style="float:right; margin-right:550px;" href="StudentRecordEDSML" onclick="myFunction()" class="btn btn-primary">Done</a></p><br>    
            <br>
