        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <!--<h2 align="left"><?php //echo $title;?><span  style="float:right"><a href="admin/add_hnd_student_record" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>-->
            <h2 align="left">
                <?php echo $title;?>
...
foreach($result as $rec)  
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>">
    ...
    <td><a class="btn btn-primary btn-sm" href="admin/update_hnd_student_record/<?php echo $rec->student_id;?>"><b>Edit</b></a></td>
