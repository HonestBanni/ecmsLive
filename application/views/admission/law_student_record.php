        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <!--<h2 align="left">Law Students Record<span  style="float:right"><a href="admin/add_law_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>-->
            <h2 align="left">Law Students Record
...
foreach($result as $rec)  
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>">
    ...
    <td><a class="btn btn-primary btn-sm" href="admin/update_law_student/<?php echo $rec->student_id;?>"><b>Update</b></a></td>
    <td><a class="btn btn-danger btn-sm disabled" href="admin/upload_law_sphoto/<?php echo $rec->student_id;?>"><b>Add Pic</b></a></td>
