...
<div class="content container">
       <!-- ******BANNER****** -->
<h2 align="center" style="border-bottom:1px solid #ccc;">Update Student (A Level)</h2>   
    ...
    <div class="form-group col-md-3">
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM prospectus_batch WHERE programe_id=5 order by batch_id desc");
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM programes_info WHERE programe_id=5");
                    foreach($b->result() as $brec)
                    {
                    ?>
            ...
            <option type="text" value="<?php echo $grec->sub_pro_id;?>"><?php echo $grec->name;?></option>
                <?php 
                   ...
                   <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=5");
                    foreach($b->result() as $brec)
                    {
                    ?>
...
<select class="form-control" type="text" name="hostel_required">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" name="mobile_no2" value="<?php echo $row->mobile_no2;?>" class="form-control phone" readonly>
        <?php else:?>
...
<div class="form-group col-md-12">                       
    <input type="submit" class="btn btn-theme" name="submit" value="Update Student">
                ...
                <br><br>
                <h3 align="center">Student Academic Record Details<hr><span style="folat:right"><a href="<?php echo base_url();?>admin/student_a_level_academic/<?php echo $id;?>" class="btn btn-large btn-primary">Add Academic Record</a></span></h3>
