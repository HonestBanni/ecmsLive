...
<div class="content container">
        ...
        <div class="col-md-12">
            ...
            <div class="row cols-wrapper">
                ...
                <form name="student" method="post" enctype="multipart/form-data" action="admin/new_upload_sphoto/<?php echo $id;?>">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" readonly="readonly" value="<?php echo date('d-m-Y',strtotime($result->admission_date));?>" class="form-control">
                      </div>
					  <div class="form-group col-md-4">
                <label>Shift:</label>
...
?>   
                    ...
                    <div class="form-group col-md-8">
                            <input type="submit" name="submit" value="Upload Picture" class="btn btn-theme">
                      </div>
                    </form> 
           </div>
</div><!--/.container-->
