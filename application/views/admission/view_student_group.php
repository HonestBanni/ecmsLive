...
<!-- ******CONTENT****** --> 
        <div class="content container">
            ...
            <form method="post">
                ...
                <a href="Admin/print_student_with_picture/<?php echo $this->uri->segment(3);?>" target="_blank" class="btn btn-theme"><i class="fa fa-print"></i> Print with Pictures</a>
            ...
            <div id="div_print">
                <h3 align="center">Class / Section: <?php foreach($result as $row); echo $row->name;?></h3>
