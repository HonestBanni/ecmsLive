...
<br />
<form method="post" enctype="multipart/form-data" action="admin/admin_student_academic_record/<?php echo $student_id;?>">
    ...
    <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-4">
        <a  href="HostelNewRecordAdmin/<?php echo $student_id;?>"  class="btn btn-theme">Add Hostel Record</a>
        </div>
