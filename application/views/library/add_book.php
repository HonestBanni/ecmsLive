 <!-- ******CONTENT****** --> 
        ...
        <div class="form-group col-md-2">
           <input type="text" name="accession_number" placeholder="New Accession #" class="form-control">
        </div>    
        <div class="form-group col-md-2">
           <input type="text" name="old_accession_number" placeholder="Old Accession #" class="form-control">
        </div>
        <div class="form-group col-md-2">
           <input type="text" name="isbn_number" placeholder="ISBN13" class="form-control">
        </div>
        <div class="form-group col-md-2">
    ...
    <div class="form-group col-md-3">
        ...
        <select name="book_category" class="form-control" required="required">
                <option value=""> Book Category </option>     
                    ...
                    {
                    ?>
                        <option value="<?php echo $LibRow->subject_id;?>"><?php echo $LibRow->subject_name;?></option>
                    <?php 
                    }
                    ?>
            </select>
