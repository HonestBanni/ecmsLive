        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">All Employee Scales <span  style="float:right"><a href="" data-toggle="modal" data-target="#adding" class="btn btn-large btn-primary">Add New Scale</a></span><hr></h2>
                ...
                <div class="col-md-12">
                    ...
                    foreach($result as $rec)  
                    {
                        ...
                        <tr class="gradeA">
                            ...
                            <td><a href="<?php echo base_url();?>HrController/update_scale/<?php echo $rec->emp_scale_id;?>"><i class="icon-edit"></i><b> Update</b></a></td>
                            <td><a href="<?php echo base_url();?>HrController/delete_scale/<?php echo $rec->emp_scale_id;?>" 
