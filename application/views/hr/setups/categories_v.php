                                    ...
                                    <form action="" class="course-finder-form" method="post" accept-charset="utf-8" id="saveRecordForm">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" id="category_code"  name="category_code" value="" placeholder="Category Code" class="form-control">
                                                <input type="hidden" id="category_id"  name="category_id"  placeholder="Category Code" class="form-control">
                                            </div>
                                            <div class="col-md-3">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            ...
            jQuery('#SaveRecord').on('click',function(){
                var send_payload = {
                        'category_code':jQuery('#category_code').val(),
