...
<table class="datatable-1 table table-boxed table-bordered table-striped">
    ...
    ?>
    <tr class="gradeA">
        <td><?php echo $rec->emp_status_name;?></td>
        
        <td>
            <a href="javascript:void(0)" id="<?php echo $rec->emp_status_id;?>" class="ShowUpdate"  style="color: blue;text-decoration: underline;">Update</a> &nbsp;
            <a href="javascript:void(0)" id="<?php echo $rec->emp_status_id;?>"  class="DeleteRecord"  style="color: red;text-decoration: underline;">Delete</a>
        </td>
       </tr>
