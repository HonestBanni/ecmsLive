                                    ...
                                    <form action="" class="course-finder-form" method="post" accept-charset="utf-8" id="saveRecordForm">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" id="bank_name"  value="" placeholder="Bank Name" class="form-control">
                                                <input type="hidden" id="bank_id"  class="form-control">
                                            </div>
                                            <div class="col-md-3">
                                             <label for="name">Bank Short Name</label>
                                             <input type="text" id="bank_short_name"  value="" placeholder="Bank Short Name" class="form-control">
                                            </div>
        ...
        jQuery(document).ready(function(){
            ...
            jQuery('#SaveRecord').on('click',function(){
                var send_payload = {
                        ...
                        'bank_short_name'   : jQuery('#bank_short_name').val(),
                        'request'           : 'SaveRecord'
                    };
                jQuery.ajax({
                        type   : 'post',
