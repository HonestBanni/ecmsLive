<div class="content container">
    ...
    <h4 align="center">Update Show Cause</h4>
        </div>
    </div><hr>
            <div class="row cols-wrapper">
        ...
        <input type="hidden" name="sc_id" value="<?php echo $result->sc_id;?>">
    ...
    <input class="form-control" type="text" name="emp_id" id="empname">
        ...
        <input class="form-control date_format_d_m_yy" value="<?php echo $date;?>" type="text" name="date">
            ...
            <input type="submit" class="btn btn-primary" name="submit" value="Update Show Cause">              </div>     
                </div>
