<div class="content container">
    ...
    <h4 align="center">Add Contract Reneval</h4>
        </div>
    </div><hr>
            <div class="row cols-wrapper">
                ...
                <div class="form-group col-md-3">
                    <label for="usr">From Date:</label>
                      <input class="form-control date_format_d_m_yy" type="text" name="fromdate">
                  </div>
                <div class="form-group col-md-3">
                    <label for="usr">To Date:</label>
                      <input class="form-control date_format_d_m_yy" type="text" name="todate">
                  </div>
                 <div class="form-group col-md-3">
            ...
            <input type="submit" class="btn btn-primary" name="submit" value="Add Contract Reneval">              </div>     
                </div>
