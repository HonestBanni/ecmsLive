...
return false;
        ...
        <div class="content container">
            ...
            <header class="page-heading clearfix">
                <h1 class="heading-title pull-left">View &AMP; Update Pre Board Test Marks List</h1>
                </header>
            </div>
...
<!--                <form method="post" action="AttendanceController/view_test_marks_list/<?php echo $id;?>">  
            ...
            <td><img src="assets/images/students/<?php echo $rec->applicant_image;?>" width="60" height="50"></td>
                ...
                <td style="font-size: 15px;"><?php echo $rec->omarks;?> /<?php echo $rec->tmarks;?></td> <td><a href="AttendanceController/update_pre_boardMarks/<?php echo $rec->serial_no; ?>" class="btn btn-theme btn-sm">Update</a></td> 
                        </tr>
                        <?php
                        $i++;
                        }
