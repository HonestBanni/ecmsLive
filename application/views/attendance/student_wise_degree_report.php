                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <?php 
                                                echo form_dropdown('section', $subPrograme,@$sectionId,  'class="form-control" id="sub_program_degree"');
                                                ?>
                                            </div>
                                            <div class="form-group ">
                                                <select class="form-control" id="sub_program_degreedropdown" name="section">
                                                    
                                                </select>
                                                <?php 
//                                                  form_dropdown('section', $section,@$sectionId,  'class="form-control" id="section_id"');
                                                ?>
                                            </div>
