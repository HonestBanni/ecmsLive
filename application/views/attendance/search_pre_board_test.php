<div class="content container">
    <h2 align="left">Pre Board Test List<hr></h2>
        <div class="row cols-wrapper">
            <div class="col-md-12">    
                <form method="post" action="AttendanceController/search_pre_board_test">
        ...
        <input type="text" name="emp_id" placeholder="Employee" class="form-control" id="emp">
                ...
                <div class="col-md-12">
                    ...
                    ?>     
                        <div class="col-md-2 col-xm-4">
                            <p class="promo-badge">
                                <a class="OliveDrab" href="AttendanceController/admin_sectionbase_preboard/<?php echo $row->class_id;?>/<?php echo $row->sec_id;?>">
            ...
            echo count($this->CRUDModel->get_where_result('student_group_allotment',array('section_id'=>$row->sec_id))) 
               ...
               ?>               
                        <div class="col-md-2 col-xm-4">
                            <p class="promo-badge">
                                <a class="OliveDrab" href="AttendanceController/admin_subjectbase_preboard/<?php echo $row->class_id;?>/<?php echo $row->sec_id;?>/<?php echo $row->subject_id;?>">
