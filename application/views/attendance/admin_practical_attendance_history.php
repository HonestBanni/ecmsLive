        ...
        <option value="<?php echo $subRec->prac_subject_id;?>"><?php echo $subRec->title;?></option>
                    ...
                    <div class="form-group col-md-2">
                            <input type="date" name="attendance_date" value="<?php if($attendance_date): echo $attendance_date; else: echo date('Y-m-d'); endif; ?>" class="form-control">
                      </div>
                    ...
                    foreach($result as $record):
                            ...
                            $count_pr   = $this->db->query("SELECT * FROM practical_attendance_details WHERE attend_id = '$attd_id' AND status=1");
                            $count_ttl  = $this->db->query("SELECT * FROM practical_attendance_details WHERE attend_id = '$attd_id'"); 
                    ...
                    <p>
                    <button type="button" class="btn btn-success"><i class="fa fa-check-circle"></i>Total Records: <?php if(@$result): echo count($result); endif;?></button>   
