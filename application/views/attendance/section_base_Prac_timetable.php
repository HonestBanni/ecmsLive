...
return false;
        ...
        <div class="content container">
            ...
            <div class="row cols-wrapper">
                  <div class="col-md-8">  
                      <div id="div_print">
                   <h4 align="center">Group Wise Practical Time Table: <?php 
                       $where = array('prac_group_id'=>$this->uri->segment(3));
                       $t = $this->CRUDModel->get_where_row('practical_group',$where);
                       echo $t->group_name;?></h4>     
