        ...
        <div class="content container">
            ...
            <div class="col-md-12">    
                <form method="post" action="AttendanceController/exam_bs_history">
                      ...
                      <div class="form-group col-md-2">
                            <input type="text" name="subject_name" placeholder="Subject" class="form-control" id="sub_bs_exam_history">
...
//                        echo '<pre>'; print_r($result); die;
                    ...
                    {   
                        ...
                        <tr class="gradeA">
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="AttendanceController/view_exam_marks_list/<?php echo $rec->exb_test_id;?>/<?php echo $rec->emp_id;?>/<?php echo $rec->sbj_id;?>/<?php echo $rec->sec_id;?>">View &amp; Update</a>
                                <a class="btn btn-warning btn-sm" href="AttendanceController/edit_exam_total_marks/<?php echo $rec->exb_test_id;?>">Update Total Marks</a>
                            </td>
