...
<div class="content container">
  <div class="page-wrapper">
    <header class="page-heading clearfix">
      <h1 class="heading-title pull-left">Menu
      </h1>
                  ...
                  $sn = 1;
                   foreach($menuLeve12 as $urRow):
                      ...
                      echo '<tr>
                                ...
                                <td><a href="Menu/'.$urRow->m2_id.'" class="productstatus" ><button  class="btn btn-primary btn-sm">Edit</button></a>&nbsp;&nbsp;&nbsp;'
                                 ?>
                                <a href="DelMenu/<?php echo $urRow->m2_id ?>" onclick="return confirm('Are You Sure to Delete This..?')" class="productstatus" ><button  class="btn btn-danger btn-sm">Delete</button></a>
                            <?php
                               echo '</td>
                              </tr>';
                   $sn++;
