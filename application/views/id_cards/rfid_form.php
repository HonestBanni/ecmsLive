                ...
                <div class="col-md-4">
                    ...
                    <h1 class="section-heading text-highlight"><strong><span class="line">ID Card Credentials</span></strong></h1>
                        ...
                        <div class="section-content">
                            <form class="course-finder-form" action="IDCardController/update_rfid" id="saveForm" name="saveForm" method="post">
                                <div class="row">
                                    
                                    <div class="col-md-12 subject form-group">
                                        <label style="text-indent: 3px">RF ID:</label>
                                        <input type="text" class="form-control" name="rfid" id="rfid" autocomplete="off" value="<?php echo $idcard_active->idc_rfid?>">
                                        <input type="hidden" readonly="readonly" name="idcid" id="idcid" value="<?php echo $idcard_active->idc_id?>">
                                    </div>
                        ...
                        echo '<div class="idcard_size">
                            ...
                            <div>
                                <table style="width:99%; margin: 0px auto;">
                                    <tr>
                                        <td width="20%">
                                            <div class="idc_student_image" style="background: url(assets/images/students/'.$student_rec->applicant_image.') center no-repeat; background-size: contain;"></div>
                                        </td>
                                        <td class="card_detail">
                                            <h3><strong>'.$idcard_active->idc_student_name.'</strong></h3>
                                            <h4><strong>College No. '.$idcard_active->idc_college_no.'</strong></h4>
                                            <h5 style="margin-bottom: 5px;"><strong>'.$idcard_active->idc_program.'</strong></h5>
                                            <h5><strong>Issue Date: '.$idcard_active->idc_issue_date.'</strong></h5>
                                            <h5><strong>Expiry Date: <span style="color:#c00;">'.$idcard_active->idc_expiry_date.'</span></strong></h5>
                            ...
                            <table style="width:99%; margin: 0px auto;">
                                <tr>
                                    <td class="card_detail_back">
                                        <h5>&nbsp;</h5>
                                        <h5><strong>Father Name: '.$idcard_active->idc_father_name.'</strong></h5>
                                        <h5><strong>Address: '.$idcard_active->idc_address.'</strong></h5><br>
                                        <h5><strong>Res Phone: '.$idcard_active->idc_contact.'</strong></h5>
