                    ...
                    <div class="card_header">
                        <table style="width:95%; margin: 0px auto;">
                            <tr>
                                ...
                                <td class="card_title"><h3 style="color:#fff"><strong>EDWARDES COLLEGE PESHAWAR</strong></h3><h5 style="color:#fff">STUDENT ID CARD</h5></td>
                            </tr>
                        </table>
                    </div>
                    <div>
                        <table style="width:99%; margin: 0px auto;">
                            <tr>
                                <td width="20%">
                                    <div class="idc_student_image" style="background: url(assets/images/students/'.$picture.') center no-repeat; background-size: contain;"></div>
                                </td>
                                <td class="card_detail">
                                    <h2>'.$student_name.'</h2>
                                    <h4>College No. '.$college_no.'</h4>
                                    <h5 style="margin-bottom: 5px;">'.$program.'</h5>
