            ...
            $newDate = date("d-m-Y", strtotime($date));
              ...
              <tr>
                    ...
                    <td><?php 
                                    ...
                                    $whereDetails = array('invt_items_assuance_details.ass_id'=>$row->ass_id);
                   $itemsDetails =  $this->InventoryModel->issuance_items_details('invt_items_assuance_details', $whereDetails);
              
                    if(!empty($itemsDetails)):
                        $sn = '';
                        $count = count($itemsDetails);
                        foreach($itemsDetails as $itemsRows):
                        $sn++;
                        if($sn == $count):
                            echo $itemsRows->itm_name.'Q='.$itemsRows->quantity.'';
                        else:
                            echo $itemsRows->itm_name.'Q='.$itemsRows->quantity.',';
                        endif;
