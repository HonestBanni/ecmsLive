...
<div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Student Previous Attendance and Marks History<hr></h2>
            ...
            <?php        
                ...
                if(!empty($student_id)){
                    ...
                    { ?>          
        <input type="text" name="student_id" value="<?php echo $emprec->student_name; ?>" placeholder="Student" class="form-control" id="students_all">
                    <input type="hidden" name="student_id" id="student_id" value="<?php echo $emprec->student_id; ?>">      
                    <?php 
                    }     
                }else{?>
        <input type="text" name="student_id" placeholder="Student" class="form-control" id="students_all">
