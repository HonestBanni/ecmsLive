        ...
        <input type="text" name="emp_id" placeholder="Employee" class="form-control" id="emp">
            ...
            $newDate = date("d-m-Y", strtotime($date)); 
                        ...
                        <tr class="gradeA">
                            ...
                            <td><a href="AttendanceController/admin_view_test_marks_list/<?php echo $rec->test_id;?>/<?php echo $rec->emp_id;?>/<?php echo $rec->subject_id;?>/<?php echo $rec->sec_id;?>">View Test Marks List</a></td>
                            <td>
                                ...
                                <a class="btn btn-theme btn-sm testDateChange" href="" data-toggle="modal" data-target="#viewDetails" id="<?php echo $rec->test_id;?>">Update</a>
