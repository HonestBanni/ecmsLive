...
return false;
 ...
 <div class="content container">
    <button type="button" name="print" value="print" onclick="printdiv('div_print');" class="btn btn-theme"><i class="fa fa-print"></i> Print </button> 
        <div id="div_print">
            <div class="col-md-12">
                <h4 style="margin-top: 8px;margin-bottom: -21px;"><strong>Edwardes College Peshawar Practical White Card:</strong><hr></h4>
...
//                                                  
       ...
       $classSubjects = $this->AttendanceModel->get_practicalSubjects(array('group_id'=>$group_id));
                ...
                if($classSubjects):
                    ...
                    for($i=1;$i<=7;$i++):
                        ...
                        $stdAtts = $this->AttendanceModel->get_studentPractical_att($where);
                           $p=0;
                            $a=0;
                        ...
                        echo '</td>';
                          ...
                          echo  '<td>'.$granPresent.'/'.$GrandTotal.'='.round($per,1).'</td>
                            ...
                            for($i=1;$i<=7;$i++):
                                ...
                                $stdAttst = $this->AttendanceModel->get_studentPractical_att($wheret);
...
//                                $netPresent = 0;
                                $montylyPresent = 0;
                                $MontlyGrandTotal = 0; 
                                $montylyPresentGrand = 0;
                                $montylyApsentGrand = 0;    
                                if($stdAtt->status == 1):
                                          $tp++;
                                        else:
                                          $ta++;
