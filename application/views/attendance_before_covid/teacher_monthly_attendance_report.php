        ...
        <div class="content container">
            ...
            ?>
        <h2 align="left"> <strong style="color:green"><?php echo $rec->employee;?></strong>: Month Wise Attendance History <hr></h2>
            <div class="row cols-wrapper">
               ...
               ?>               
                <div class="col-md-2 col-xm-4">
                    <p class="promo-badge">
                        <a class="OliveDrab" href="TMAR/<?php echo $row->sec_id?>/<?php echo $row->subject_id?>/<?php echo $row->emp_id?>/<?php echo $row->flag?>">
