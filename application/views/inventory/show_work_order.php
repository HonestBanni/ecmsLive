  ...
  <div class="page-wrapper">
    ...
    <div style="width:100%; height:45px;">
        <div style="width:32%; height:45px; float:left">
            <strong><strong>Work Order ID:</strong> <?php echo $row->year;?>/<?php echo $row->work_id;?>
        </div>
    ...
    <div style="width:100%; height:80px;">
        ...
        <div style="width:38%; height:80px; float:left">
                <strong>Name:</strong> Sarfaraz Khan<br>
...
<!--    <div style="width:100%; height:80px;">
        <div style="width:96%; height:80px; float:left"> 
                <strong>Name:</strong> Asso Prof. Muhammad Jamal<br>
    ...
    <div style="width:100%; height:80px;">
        <div style="width:96%; height:80px; float:left"> 
                <strong>Name:</strong> Mohammad Naveed Ali<br>
            <strong>Position:</strong>Convener Purchase Committee<br><br>
                <strong>Signature: ..........................</strong>
        </div>
    </div>    
                </article>                    
