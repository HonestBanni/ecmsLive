      ...
      <div class="row">
        ...
        <input type="text" name="bb_name" placeholder="Block Name" class="form-control">
            ...
            <div class="form-group col-md-3">
                    ...
                    <input type="text" name="no_of_rooms" id="bb_shortname" placeholder="No of rooms" class="form-control">
            </div>
            <div class="form-group col-md-3">
                    <lable>Total Seats: </lable>
                    <input type="text" name="total_seats" id="bb_shortname" placeholder="Total Seats" class="form-control">
            </div>
        <div class="form-group col-md-3">
