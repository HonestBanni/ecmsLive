      ...
      <div class="row">
        ...
        <article class="contact-form col-md-12 col-sm-7">
            ...
            <table width="90%" border="1" style="margin-left:25px;">
                ...
                <?php
            $where = array('invt_fixed_item_details.fid_roomId'=>$rm_id, 'invt_fixed_item_details.itm_status'=> 1);              
            $this->db->select('*'); 
            ...
            foreach($ddquery->result() as $ddrow):
                ...
                <tr align="center">
                    ...
                    <td><?php echo $rrow->rm_shortname;?></td>
                    <td><?php echo $ddrow->itm_name; ?></td>
                    <td><?php echo $newDate; ?></td>
                    <td><?php echo $ddrow->emp_name; ?></td>
                     <td><a href='InventoryController/delte_inventory_items/<?php echo $ddrow->fid_id?>' onclick="return confirm('Are You Want to Delete...?')">Delete</a></td>
                </tr>
                <?php 
                $i++;
                    endforeach;
