              ...
              <section class="course-finder" style="padding-bottom: 2%;">
                        ...
                        <div class="section-content" >
                                ...
                                <div class="col-md-2 col-sm-5">
                                          <label for="name">College From</label>
                                ...
                                <div class="col-md-2 col-sm-5">
                                          <label for="name">College To</label>
...
//                                        $Section = array('Section'=>"Section");
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-2">
                                    <label for="name">Reserved 1</label>
                                    <div class="form-group ">
                                        <?php 
                                            echo form_dropdown('reserved_seat1', $reserved_seat1,$reserved_seat_id1,  'class="form-control"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <label for="name">Reserved 2</label>
                                    <div class="form-group ">
                                        <?php 
                                            echo form_dropdown('reserved_seat2', $reserved_seat2,$reserved_seat_id2,  'class="form-control"');
                                        ?>
                                    </div>
                                </div>
                                </div>
