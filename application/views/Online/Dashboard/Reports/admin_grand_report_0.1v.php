                        ...
                        <div class="section-content" >
                                ...
                                <div class="col-md-2 col-sm-5">
                                    <label for="name">Program</label>
                                        <div class="input-group" id="adv-search">
                                            <?php
                                            echo form_dropdown('program', $program, $programId,  'class="form-control" id="Programe"');
                                                  ?>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-2 col-sm-5">
                                    <label for="name">Sub Program</label>
                                        <div class="input-group" id="adv-search">
                                            <?php
                                                echo form_dropdown('sub_program', $subprogrames, $subprogramId,  'class="form-control" id="SubProgram"');
                                             ?>
                                        </div>
                                </div>
                                  <div class="col-md-2 col-sm-5">
                                  ...
                                  <div class="col-md-2 col-sm-5">
                                    <label for="name">Sections</label><br>
                                        <div class="input-group" id="adv-search">
                                            <?php
                                                 echo form_dropdown('sections_name', $sections, $sectionId, 'class="form-control" id="Sections"');
                                            ?>
                                        </div>
                                    </div>
                                  <div class="col-md-2 col-sm-5">
