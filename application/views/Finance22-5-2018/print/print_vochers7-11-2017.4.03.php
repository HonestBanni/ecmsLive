    ...
    <div class="table-responsive">
        ...
        <table class="table table-boxed table-hover" align="right">
           <tbody>
                ...
                <tr>
                    <td width="10px" colspan="4" style="height: 60px">Payee : <strong><?php echo $voucher_info->gl_at_payeeId;?></strong></td>
...
//                            echo '<pre>';print_r($all_attac2);die;
           ...
           ?>
                   ...
                   <tr>
                       ...
                       <td colspan="4" style="height: 60px; padding-top: 22px;"  >Prepared & Paid by (Cashier) :
                        <?php
        ...
        <table class="table table-boxed table-hover">
           <tbody>
                   ...
                   <tr style=" font-size:12px; font-weight: 400;">
                       <td colspan="4"><strong> (In Words)  :'.$this->CRUDModel->money_convert($word_crdit).'only</strong></td>
...
//        else:
        ...
        if($voucher_info->vocher_type == 1 && $voucher_info->vocher_type == 2):
