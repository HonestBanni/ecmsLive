...
<div class="content container">
  <div class="page-wrapper">
    <header class="page-heading clearfix">
      <h1 class="heading-title pull-left">Chart Of Account Parents 
      </h1>
      <div class="breadcrumbs pull-right">
        <ul class="breadcrumbs-list">
          ...
          <li class="current">Chart Of Account Parents
        </ul>
      </div>
      <!--//breadcrumbs-->
    </header> 
                  ...
                  $sn = 1;
                   foreach(@$coa as $urRow):
                      ...
                      echo '<tr>
                                ...
                                <td>'.$status.'</td>
                                <td>
                                <a href="COA_prents/'.$urRow->fn_coaId.'" class="productstatus" ><span class="fa fa-book text-navy"></span></a> &nbsp;
