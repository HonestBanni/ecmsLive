            ...
            <div class="col-md-12">
                <section class="course-finder" style="padding-bottom: 2%;">
                    <h1 class="section-heading text-highlight">
                            <span class="line"><?php echo $page_heading?>  Form</span>
                    </h1>
                                   ...
                                   <div class="row">
                                       <div class="col-md-12">
                                        ...
                                        <div class="col-md-4 pull-right">
                                                ...
                                                <button type="button" class="btn btn-theme" name="add_fy_bgt" id="add_fy_bgt"  value="update" ><i class="fa fa-plus"></i> Add</button>
