                                        ...
                                        ?>
                                             ...
                                             <table class="table table-hover" style="font-size:10px; margin-bottom:8px;">
                                                 <tr>
                                                     ...
                                                     <td colspan="4" style="border-top: 1px solid #ffff;font-weight: bold;text-align: right;font-size:10px;">From&nbsp;: <?=date('d-m-Y', strtotime($dateFrom))?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To : <?=date('d-m-Y', strtotime($dateTo))?></td>
                                                 </tr>
                                             </table>
...
//                                                        echo wordwrap($dRow->gl_at_description,80,"<br>\n")
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td colspan="1"  style="border-top: 2px solid #000000;border-bottom:  2px solid #000000;"></td>
