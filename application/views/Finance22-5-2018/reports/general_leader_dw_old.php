                                        ...
                                        <div class="table-responsive">                      
                                            ...
                                            <table class="table table-hover" style="font-size:10px">
                                                ...
                                                $where = array(
                                                            ...
                                                            'gl_at_date <'=>date('Y-m-d', strtotime($dateFrom)),
        //                                                    
//                                                    
                                                        );
                                                        $open_balance       = $this->FinanceModel->open_balance_old($where);
                                                ...
                                                $parentId               = $this->CRUDModel->get_where_row('fn_coa_parent',array('fn_coaId'=>$GLRow->fn_coa_pId));
                                                    ...
                                                    if($parentId->fn_coa_code == 200000):
                                                        ...
                                                        if($parentId->fn_coa_code == 400000):
                                                               $dateDiff = date_diff(date_create(date('Y-m-d', strtotime($query->year_start))),date_create($obRow->gl_at_date));
