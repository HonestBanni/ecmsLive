            ...
            <div class="col-md-12">
                <section class="course-finder" style="padding-bottom: 2%;">
                    <h1 class="section-heading text-highlight">
                            <span class="line">Voucher Form</span>
                    </h1>
                    <div class="section-content" >
                        <div class="row">
                               <?=form_open('VoucherSave',array('class'=>'course-finder-form'))?>
                                   ...
                                   <div class="row">
                                       <div class="col-md-12">
                                        ...
                                        <div class="col-md-4 pull-right">
                                                ...
                                                <button type="button" class="btn btn-theme" name="update_vocher" id="update_vocher"  value="update" ><i class="fa fa-plus"></i> Update</button>
