                                    ...
                                    <?php   echo form_open('',array('id'=>'RecordForm')) ?>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                    ...
                                                    <div>
                                                        <div style="width: 33%; float: left" class=" form-group">
                                                            ...
                                                            echo form_dropdown('ps_day',$dob_day,date('d'),array('class'=>'form-control','id'=>'ps_day'));
                                                            ?> 
                                                        </div>
                                                        <div style="width: 33%; float: left" class="form-group" autocomplete="off" >
                                                            ...
                                                            echo form_dropdown('ps_month',$month,date('m'),array('class'=>'form-control','id'=>'ps_month'));
                                                            ?>
                                                        ...
                                                        <div style="width: 33%; float: left" class="form-group">
                                                              <?php
                                                                ...
                                                                echo form_dropdown('ps_year',$dob_year,date('Y'),array('class'=>'form-control','id'=>'ps_year'));
                                            ...
                                            <div class="col-md-12 form-group">
                                                     ...
                                                     <textarea name="remarks" cols="40" rows="2" class="form-control" placeholder="Pay scale Remarks"  id="remarks"></textarea>
                                                 </div>
                                            ...
                                            <div class="col-md-4 col-md-offset-1 pull-right">
                                                ...
                                                <button type="button" class="btn btn-theme" name="SavePayScale" id="SavePayScale" value="SavePayScale"><i class="fa fa-save"></i> Save Record</button>
        ...
        jQuery(document).ready(function(){
            ...
            jQuery('#PayScaleDetails').on('click',function(){
                 var    formData = new FormData($("#RecordForm")[0]);
                        formData.set("formCode", jQuery('#formCode').val());
                        formData.set("request", 'PayScaleDetailsDemo');
                jQuery.ajax({
                            type        : "POST",
