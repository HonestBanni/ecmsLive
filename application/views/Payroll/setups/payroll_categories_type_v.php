                                    ...
                                    <?php   echo form_open('',array('id'=>'RecordForm')) ?>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" id="category_type_code" name="category_type_code" value="" placeholder="Category Type Code" class="form-control">
                                                <input type="hidden" class='pk_id' id="pk_id" name="pk_id">
                                            </div>
                                            <div class="col-md-3">
                                                <label for="name">Category Type Name</label>
                                                <input type="text" id="category_type_name" name="category_type_name" value="" placeholder="Category Type Name" class="form-control">
