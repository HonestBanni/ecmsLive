...
<!--                        <div class="col-md-3 col-sm-12 form-group">
                        ...
                        <div class="col-md-3 col-sm-12 form-group">
                            <label for="name">Initiate From Date</label>
                            <input type="text" class="form-control datepicker" name="init_start" id="init_start" value="" readonly="readonly">
                        </div>
                        
                        <div class="col-md-3 col-sm-12 form-group">
                            <label for="name">Initiate To Date</label>
                            <input type="text" class="form-control datepicker" name="init_end" id="init_end" value="<?php echo date('d-m-Y'); ?>" readonly="readonly">
                        </div>
                        
                        <div class="col-md-3 col-sm-12 form-group">
                            <label for="name">Approve From Date</label>
                            <input type="text" class="form-control datepicker" name="appr_start" id="appr_start" value="" readonly="readonly">
                        </div>
                        
                        <div class="col-md-3 col-sm-12 form-group">
                            <label for="name">Approve To Date</label>
                            <input type="text" class="form-control datepicker" name="appr_end" id="appr_end" value="<?php echo date('d-m-Y'); ?>" readonly="readonly">
                        </div>
                        ...
                        <div class="col-md-2 col-sm-12 form-group">
                            ...
                            <!--<button type="button" class="btn btn-danger" name="print_ms" id="print_ms"  value="print_ms" > Print</button>-->
                        </div>
...
//        });
        ...
        $('#search_ms').on('click', function(){
            var data = { 
                ...
                'init_start'    : $('#init_start').val(),
                'init_end'      : $('#init_end').val(),
                'appr_start'    : $('#appr_start').val(),
                'appr_end'      : $('#appr_end').val()
            };
            $.ajax({
                type    : 'post',
                url     : 'MinuteSheetController/admin_minute_sheet_grid',
        ...
        $('#print_ms').on('click', function(){
            ...
            $.ajax({
                type    : 'post',
                url     : 'MinuteSheetController/dfn_print_minute_sheet_record',
                data    : data,
                success :function(result){ 
                   $('#result_grid').html(result);    
                }
