...
//                                        echo '<pre>';print_r($row);die;
                                        ...
                                        $sn++;
                                            ...
                                            echo '</td>';
                                            echo '<td><a href="BRSPrintGA/'.$row->brs_report_id.'" target="_blank"><button class="btn btn-success btn-sm"><i class="fa fa-print"></i>Print</button></a></td>';
                                            echo '<td><a href="BRSEditGA/'.$row->brs_report_id.'" target="_blank"><button class="btn btn-theme btn-sm"><i class="fa fa-book"></i>Edit</button></a></td>';
//                                            echo '<td></td>';
                                            echo '</tr>';
                                    endforeach;
