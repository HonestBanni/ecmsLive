                                             ...
                                             <td>&nbsp;</td>
                                                ...
                                                $coacs = $this->CRUDModel->get_where_result('fn_coa_master_sub_child',array('fn_coa_mc_status'=>1,'fn_coa_mc_mId'=>$coacRow->fn_coa_m_cId));
                                                        ...
                                                        foreach($coacs as $coacsRow):
                                                             ...
                                                             echo ' <tr class="recordFrom3rdga '.$class[$k].'" id="'.$coacsRow->fn_coa_mc_title.','.$coacsRow->fn_coa_mc_id.','.$coacsRow->fn_coa_mc_code.'">
                                                                        <td>&nbsp;</td>
...
//                                 $COAP =$this->CRUDModel->get_where_result('fn_coa_parent',array('fn_coa_status'=>1));
                                             ...
                                             <td>&nbsp;</td>
                                                ...
                                                $coacs = $this->CRUDModel->get_where_result('fn_coa_master_sub_child',array('fn_coa_mc_status'=>1,'fn_coa_mc_mId'=>$coacRow->fn_coa_m_cId));
                                                        ...
                                                        foreach($coacs as $coacsRow):
                                                             ...
                                                             echo ' <tr class="recordTo3rdga '.$class[$k].'" id="'.$coacsRow->fn_coa_mc_title.','.$coacsRow->fn_coa_mc_id.','.$coacsRow->fn_coa_mc_code.'">
                                                                        <td>&nbsp;</td>
                                                                        <td>'.$coacsRow->fn_coa_mc_code.'</td>
 ...
 jQuery("#recordFromGA").autocomplete({
        ...
        //Search GA To COA
 jQuery("#recordToGA").autocomplete({
      
        minLength: 0,
        source: "FnBRSAutoCompleteGA/"+$("#recordToGA").val(),
        autoFocus: true,
        scroll: true,
        dataType: 'jsonp',
        select: function(event, ui){
            jQuery("#recordToGA").val(ui.item.value);
...
//        jQuery('#myModal').modal('toggle');
     ...
     //Report RecordTo
    jQuery('#table .recordTo3rdga').dblclick(function () {
