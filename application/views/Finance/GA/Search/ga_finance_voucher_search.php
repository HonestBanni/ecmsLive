                                                            ...
                                                            echo '</th>
                                                                <th>'.number_format($row->print_cheque_value, 0, ',', ',').'</th>
                                                                  ...
                                                                  <td><a href="javascript:valid(0)" id="'.$row->gl_at_id.'" class="amount_tran_details"><button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal"> Details</button></a></td>';
                                                                        ?>
                                                                        <td>  <a href="BankVoucherEditGA/<?php echo $row->gl_at_id;?>"  target="_new" class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Update</button></a>
                                                                  </td> 
                                                                    <td>  
                                                                        
                                                                        
                                                                        
                                                                        <a href="VoucherPrintGA/<?php echo $row->gl_at_id;?>" target="_new"  class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Print</button></a>
                                                                    ...
                                                                    <td>  <a href="voucherApprovalGA/<?php echo $row->gl_at_id;?>" target="_new" class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Voucher Approval</button></a>
                                                                  </td> 
