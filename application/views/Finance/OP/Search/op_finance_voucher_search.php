                                                           ...
                                                           $sn++;
                                                            ...
                                                            echo '</th>
                                                                <th>'.number_format($row->print_cheque_value, 0, ',', ',').'</th>
                                                                  ...
                                                                  echo '<td><a href="ChequePrint/'.$row->gl_at_id.'" target="_new"  class="productstatus"><button type="button" class="btn btn-theme btn-xs">Cheque</button></a></td> ';
                                                                    if($row->vocher_status == 2):
                                                                        ...
                                                                        echo '<td>  <a href="BankVoucherEdit/'.$row->gl_at_id.'"  target="_new" class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Update</button></a></td>';
                                                                        echo '<td>  <a href="VoucherPrint/'.$row->gl_at_id.'" target="_new"  class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Print</button></a></td> ';
                                                                        echo '<td>  <a href="voucherApproval/'.$row->gl_at_id.'" target="_new" class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Vchr Approval</button></a></td> ';
                                                                        echo '<td>  <a href="VoucherSign/'.$row->gl_at_id.'" target="_new" class="productstatus"><button type="button" class="btn btn-theme btn-xs">Sign By</button></a></td> ';
                                                                    endif;
