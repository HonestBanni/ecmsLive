           ...
           <tbody>
               ...
               if($approval):
                   ...
                   echo '<tr style="height: 45px">
                            <td width="220px" style=" padding-top: 22px;">'.$aprRow->trns_ab_designation.'</td>
                            <td style=" padding-top: 22px;">'.$aprRow->trns_ab_name.'</td>
...
//                    $order['order']   = 'asc';
//                    $approval_currnt         = $this->CRUDModel->get_where_result_order('fn_vocher_approvalby',array('status'=>1,'fn_account_type_id'=> 1),$order); 
//
//                       
//                       
//                       foreach($approval_currnt as $aprRowCrnt):
//                   echo '<tr style="height: 45px">
//                            <td width="220px" style=" padding-top: 22px;">'.$aprRowCrnt->designation.'</td>
//                            <td style=" padding-top: 22px;">'.$aprRowCrnt->name.'</td>
//                            <td width="150px" style=" padding-top: 22px;">Signed</td>    
//                            <td style=" padding-top: 22px;"></td>    
//                            <td width="150px" style=" padding-top: 22px;">Date</td>    
//                            <td style=" padding-top: 22px;"> </td>    
