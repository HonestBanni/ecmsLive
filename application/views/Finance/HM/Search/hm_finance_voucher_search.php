                                ...
                                <div class="row">   
                                     ...
                                     <div class="col-md-2 col-sm-5">
                                         ...
                                         <?php
                                                ...
                                                echo   form_dropdown('voucher_status',$voucher_status_ml,$statusid,  'class="form-control"');
                                            ?>
...
//                                                                        
//                                                                        echo '<td></td>';
//                                                                        echo '<td><a href="VoucherPrint/'.$row->gl_at_id.'" target="_new"  class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Print</button></a></td> ';
//                                                                        echo '<td></td>';
//                                                                        else:
                                                                        echo '<td>  <a href="HmBankVoucherEdit/'.$row->gl_at_id.'"  target="_new" class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Update</button></a></td>';
                                                                        echo '<td>  <a href="HmVoucherPrint/'.$row->gl_at_id.'" target="_new"  class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Print</button></a></td> ';
                                                                        echo '<td>  <a href="HmVoucherApproval/'.$row->gl_at_id.'" target="_new" class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Voucher Approval</button></a></td> ';
                                                                        echo '<td>  <a href="HmVoucherSign/'.$row->gl_at_id.'" target="_new" class="productstatus"><button type="button" class="btn btn-theme btn-xs">Sign By</button></a></td> ';
//                                                                    endif;
