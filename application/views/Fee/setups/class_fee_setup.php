                           ...
                           <?php echo form_open('',array('class'=>'course-finder-form'));
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-5">
                                            ...
                                            <?php 
                                           echo form_dropdown('programe_id', $program,$programe_id,  'class="form-control feeProgrameId" required="required" id="feeProgrameId"');
                                ...
                                <div class="col-md-3 col-sm-5">
                                            ...
                                            <?php 
                                                ...
                                                echo form_dropdown('sub_pro_nameId',$sub_programX,$sub_pro_id,'class="form-control" required="required" id="showFeeSubPro"');
