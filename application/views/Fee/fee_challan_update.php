                               ...
                               <div class="col-md-3">
                                    <label for="name">Batch</label>
                                        <?php 
                                             ...
                                             echo form_dropdown('batch_id', $batch,$student_info->batch_id,  'class="form-control" id="batch-id"');
                                              form_input(array(
                                                'name'          => 'father_name',
                                                'id'            => 'father_name',
                               ...
                               <div class="col-md-3">
                                    <label for="name">Sub Program</label>
                                        <?php 
                                             ...
                                             echo form_dropdown('sub_pro_name', $sub_pro_name,$student_info->sub_pro_id,  'class="form-control" id="sub-pro-name"');
                                              form_input(array(
                                                'name'          => 'father_name',
                                                'id'            => 'father_name',
                                                'value'         => $student_info->sub_proram,
                                ...
                                <div class="col-md-3">
                                    ...
                                    echo form_dropdown('pc_array', $pc_array, $challan_info->fc_pay_cat_id,'id="payment-challan" class="form-control"');
...
//                                                             echo '<pre>';print_r($row);die;  
                                                            ...
                                                            echo '<tr>
                                                                ...
                                                                <th><input type="hidden" value="'.$row->fcs_id.','.$row->old_balance_pc_id.'" name="update_amount_id[]"></th>
