...
//                                                            echo '<pre>';print_r($row);die;
                                                          ...
                                                          echo '<tr>
                                                                ...
                                                                <td><a href="AdminFullDetails/'.$row->student_id.'" target="_new"><strong title="'.$row->student_name.'/'.$row->father_name.', Class :('.$row->sessionName.'), Student status = '.$row->student_status.'") target="_new">'.substr($row->student_name, 0, 15).'</strong></a></td>
                                                                <td>'.$hoste_status.'</td>
...
//                                                           
                                                             ...
                                                             echo '<td><a href="feeChallanPrint/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-success btn-xs"><span class="fa fa-print"> Print</span></a></td>';
                                                              echo '<td><a href="AdminFeeNewHead/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-danger btn-xs "><span class="fa fa-download"> Update Heads</span></a></td>';
