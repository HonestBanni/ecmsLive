                                                          ...
                                                          echo '<tr>
                                                                ...
                                                                <td>'.$pc_title.'</td>';
                                                                  ...
                                                                  if($row->ch_status_id == 2):
                                                                      $totalGrand = $total_Paid;
                                                                      else:
                                                                      $totalGrand = '';
                                                                  endif;
                                                                      echo '<td>'.$totalGrand.'</td>';
...
//                                                           
                                                                  ...
                                                                  if($row->ch_status_id == 1):
                                                                       ...
                                                                       echo '<td><a  class="btn btn-danger btn-xs disabled"><span class="fa fa-download"> Add Head</span></a></td>';
                                                                       echo '<td><a  class="btn btn-warning btn-xs disabled"><span class="fa fa-crosshairs"> Cancel</span></a></td>';
                                                                    endif; 
                                                                    
                                                               echo     '<td><a href="fullDetails/'.$row->student_id.'" class="btn btn-success btn-xs" target="_new">Full Details</a></td>';
                                                               $paid_date = '';
