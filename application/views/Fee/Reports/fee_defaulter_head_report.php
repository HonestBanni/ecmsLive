...
//                                          '21'  =>'BOARD EXAM FEE',
//                                          '7'  =>'BOARD REG. FEE',
//                                          '19'  =>'UNIVERSITY EXAM FEE',
//                                          '8'  =>'UNIVERSITY REG. FEE',
//                                        );
                                            echo form_dropdown('fee_head', $fee_head,$fee_id,  'class="form-control" ');
                                        ?>
                                    </div>
                                </div> 
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group ">
                                        <?php 
                                            echo form_dropdown('programe_id', $program,$programe_id,  'class="form-control" required="required" id="feeProgrameId"');
                                        ?>
                                    </div>
                                </div>
                                                        ...
                                                        $sn = "";
                                                         ...
                                                         $gTotal += $row->balance;
                                                          ...
                                                          echo '<tr>
                                                                    ...
                                                                    <td>Total</td>
                                                                    <td></td>
                                                                    <td>'.number_format($gTotal, 0, ',', ',').'</td><td></td><td></td>';
                                                            echo '  </tr>';
