        ...
        ?>
                     ...
                     <div style="padding-top:1%;">
                                <div class="col-md-5 pull-right">
                                    ...
                                    <a href="EnvelopePrint/<?php echo $studentInfo->student_id?>" target="_new" class="btn btn-theme" > <i class="fa fa-print"></i> Print Envelope</a>
                 ...
                 ?>
                        <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">
                            <tr class="danger">
                                ...
                                <td style="border: 1px solid #000000; width: 10%;">Valid Date: <strong><?php echo date('d-m-Y',strtotime($challan_info->fc_dueDate))?></strong></td>
                            ...
                            <tr class="danger">
                                ...
                                <th style="border: 1px solid #000000; width: 10%;">Remarks</th>
                    ...
                    foreach($challan_info->payment_details as $payment_info):
                        ...
                        if($payment_info->delete_head == 0):
                              ...
                              <tr class='<?=$fee_class_info?>'>
                                      ...
                                      <td style="border: 1px solid #000000; width: 11%;  text-decoration: line-through;color: red;"><?php echo $payment_info->Fee_heads?></td>
...
//                            echo '<pre>';print_r($mess_row);die;
                              if(!empty($mess_row->bill_details)):
