    ...
    //                                                echo form_dropdown('section', $section,$sec_id,  'class="form-control"');
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-7 pull-right">
                                    ...
                                    <button type="submit" class="btn btn-theme" name="paid_amount_report" id="paid_amount_report"  value="paid_amount_report" ><i class="fa fa-search"></i> Paid Amount</button>
                                    <button type="submit" class="btn btn-theme" name="paid_amount_report_split" id="paid_amount_report_split"  value="paid_amount_report_split" ><i class="fa fa-search"></i> Paid Amount Split</button>
                                    <!--<button type="submit" class="btn btn-theme" name="paid_fee_head" id="paid_fee_head"  value="paid_fee_head" ><i class="fa fa-search"></i> Paid Amount Head Wise</button>-->
