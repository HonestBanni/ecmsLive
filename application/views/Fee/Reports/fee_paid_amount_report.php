    ...
    //                                                echo form_dropdown('section', $section,$sec_id,  'class="form-control"');
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-9 pull-right">
                                    ...
                                    <button type="submit" class="btn btn-theme" name="paid_fee_head" id="paid_fee_head"  value="paid_fee_head" ><i class="fa fa-search"></i> Head Wise All</button>
                                    <button type="submit" class="btn btn-theme" name="paid_fee_head_college" id="paid_fee_head_college"  value="paid_fee_head_college" ><i class="fa fa-search"></i> Head Wise College</button>
                                    <button type="submit" class="btn btn-theme" name="paid_fee_head_hostel" id="paid_fee_head_hostel"  value="paid_fee_head_hostel" ><i class="fa fa-search"></i> Head Wise Hostel</button>
...
//                                      echo '<pre>';print_r($result);die;
                                      ...
                                      if(!empty($res_head)):
                                          ...
                                          foreach($res_head->head_details as $head_det):
                                            ...
                                            echo '<td>'.number_format($head_det->paid_amount, 0, ',', ',').'</td>';
                                            echo '</tr>';
                                              $Total +=$head_det->paid_amount;
                                           endforeach;
                                           
                                           
                                           $credit_amt= '';
                                          
                                            foreach($res_head->credit as $crdt_amount):
                                                $credit_amt +=$crdt_amount->credit_amount;
                                            endforeach;
                                           ...
                                           if(!empty($credit_amt)):
                                                echo '  <tr>
                                                            ...
                                                            <td><strong>'.number_format($credit_amt, 0, ',', ',').'</strong></td>
                                                 ...
                                                 if(!empty($Total)):
                                                    ...
                                                    <td></td>
                                                    <td><strong> Total</strong></td>
                                                    <td><strong>'.number_format($Total+$credit_amt, 0, ',', ',').'</strong></td>
                                                        </tr>';
                                                endif;
                                      endif;
                                      $TotalFee+=$Total+$credit_amt;
                                      endforeach;
                                       ...
                                       if(!empty($TotalFee)):
                                                    ...
                                                    <td><strong>'.number_format($TotalFee, 0, ',', ',').'</strong></td>
                                                        </tr>';
                                                endif;
                                      
                                     echo '<tr>';  
                                     echo '<td colspan="3"><p class="text-highlight" style=" text-align: left"><strong>Hostel Details</strong></p></td>';  
                                     echo '</tr>';  
                                      if($result):
                                          $gHostel_total= '';
                                          foreach($result as $hosl):
                                            echo '<tr>';
                                            echo '<td>'.$hosl->program_name.'</td>';
                                            echo '<td></td>';
                                            echo '<td></td>';
                                            echo '</tr>';
                                          $Hostel_total= '';
                                            foreach($hosl->hostel as $hstl):
                                              if($hstl->head_type ==1):
                                                  echo '<tr>
                                                      <td></td>
                                                      <td>'.$hstl->fh_head.'</td>';
                                                      if($hstl->paid_amount):
                                                          echo '<td> '.number_format($hstl->paid_amount, 0, ',', ',').'</td>';
                                                      $Hostel_total += $hstl->paid_amount;
                                                      endif;
                                                  echo '</tr>';
                                              endif;
                                            endforeach;
                                            
                                            if(!empty($Hostel_total)):
                                               echo '<tr>
                                                      <td></td>
                                                      <td><strong>Total</strong></td>
                                                      <td><strong>'.number_format($Hostel_total, 0, ',', ',').'</strong></td>    
                                                    </tr>';  
                                            endif;
                                            $gHostel_total +=$Hostel_total;
                                           
                                          endforeach;
                                          
                                              if(!empty($gHostel_total)):
                                               echo '<tr>
                                                      <td></td>
                                                      <td><strong>Hostel Total</strong></td>
                                                      <td><strong>'.number_format($gHostel_total, 0, ',', ',').'</strong></td>    
                                                    </tr>';  
                                            endif;
                                      endif;
                                      ...
                                      if($result):
                                           echo '<tr>';  
                                            echo '<td colspan="3"><p class="text-highlight" style=" text-align: left"><strong>Mess Details</strong></p></td>';  
                                            echo '</tr>';
                                          ...
                                          $Mess_total= '';
                                            ...
                                            if(!empty($Mess_total)):
                                                 echo '<tr>
                                                      <td></td>
                                                      <td><strong>Total</strong></td>
                                                      <td><strong>'.number_format($Mess_total, 0, ',', ',').'</strong></td>    
                                                    </tr>'; 
                                            endif;
                                          $gMess_total +=$Mess_total;
                                          endforeach;
                                          
                                           if(!empty($gMess_total)):
                                                 echo '<tr>
                                                      <td></td>
                                                      <td><strong>Mess Total</strong></td>
                                                      <td><strong>'.number_format($gMess_total, 0, ',', ',').'</strong></td>    
                                                    </tr>'; 
                                            endif;
                                      endif;
                                      
                                          $mTotal =$TotalFee+$gHostel_total+$gMess_total;
                                     if(!empty($mTotal)):
                                                ...
                                                <td></td>
                                                <td><strong>Grand Total</strong></td>
                                                <td><strong>'.number_format($mTotal, 0, ',', ',').'</strong></td>
                                              </tr>';
                                            endif;
                                            $Total = '';
                                            $credit_amt = '';
                    ...
                    <?php 
                          ...
                          // Head Wise Section report College Fee
                    if($report_type == 'paid_fee_head_college'):
                    ?>
...
//                                      echo '<pre>';print_r($result);die;
                    ...
                    <?php 
                         ...
                         // Head Wise Section report College Fee
                    if($report_type == 'paid_fee_head_hostel'):
                    ?>
                         
                    <div class="table-responsive">
                        <p class="text-highlight" style=" text-align: left"><strong>Hostel Details</strong></p>
