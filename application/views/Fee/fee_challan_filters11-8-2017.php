...
//                                                                );
//                                                    
//                                                                $instl_payment =    $this->db->where($where)->get('fee_balance')->row();
//                                                                  echo '<pre>';print_r($instl_payment);
//                                                            if($instl_payment->r_amount >1):
//                                                                     '<td><a href="balanceChallan/'.$row->student_id.'/'.$row->fc_challan_id.'" class="btn btn-danger btn-xs "><span class="fa fa-download"> Balance Challan</span></a></td>';
//                                                                   else:
//                                                                   echo '<td></td>';
//                                                               endif;
//                                                                
...
//                                                                     
//                                                                    
//                                                                     $instl_payment =    $this->db->where('pay_cat_id',$row->fc_pay_cat_id)->get('fee_balance')->row();
//                                                                        
//                                                                         if($instl_payment->r_amount>0):
//                                                                             echo '<td><a href="balanceChallan/'.$row->student_id.'/'.$row->fc_challan_id.'" class="btn btn-danger btn-xs "><span class="fa fa-download"> Balance Challan</span></a></td>';
//                                                                             else:
//                                                                             echo '<td></td>';
//                                                                         endif;
...
//                                                                   if($row->ch_status_id == 3):
//                                                                        
//                                                                        echo '<td><a href="feeChallanDetail/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-info btn-xs disabled"><span class="fa fa-search"> Details</span></a></td>';
//                                                                        else:
//                                                                       echo '<td><a href="feeChallanDetail/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-info btn-xs "><span class="fa fa-search"> Details</span></a></td>';
//                                                                    endif; 
...
//                                                                echo ' <td><a href="feeChallanDetail/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-info btn-xs"><span class="fa fa-search"> Details</span></a></td>';
                                                            ...
                                                            echo '<td><a href="feeChallanPrint/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-success btn-xs"><span class="fa fa-print"> Print</span></a></td>';
                                                                  ...
                                                                  if($row->ch_status_id == 1):
                                                                        ...
                                                                        echo '<td><a href="feeNewHead/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-danger btn-xs "><span class="fa fa-download"> Add New Head</span></a></td>';
                                                                        else:
                                                                       echo '<td><a href="feeNewHead/'.$row->fc_challan_id.'/'.$row->student_id.'" class="btn btn-danger btn-xs disabled"><span class="fa fa-download"> Add New Head</span></a></td>';
                                                                    endif; 
