                        ...
                        <div class="section-content" >
                            ...
                            if(!empty($studentInfo)):
                               ...
                               echo form_input(array(
                                ...
                                echo '<div class="col-md-3"><label for="name">Class</label>';
                                 echo form_input(array(
                            ...
                            if(!empty($studentInfo)):
                                ...
                                echo form_input(array(
                                 ...
                                 echo '</div>';
                                echo '<div class="col-md-6"><label for="name">Reasons </label>';
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-4 col-md-offset-1 pull-right">
                                    ...
                                    if(@$challand_comments->fc_ch_status_id == 2):
                                        echo '<button type="submit" class="btn btn-theme" name="refund_challan" id="refund_challan"  value="refund_challan" ><i class="fa fa-upload"></i> Refund Challan</button>';
                                    endif;
                                    ?>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                                        ...
                                                        $grand_paid_amount = '';
                                                          ...
                                                          foreach($result as $row):
                                                            ...
                                                            echo '<tr ">
                                                                ...
                                                                <th><input value="'.$row->paid_amount.'" name="update_installment[]" class="update_installment"></th>
                                          ...
                                          <?php
                                                                ...
                                                                echo '<div class="alert alert-danger alert-dismissable">
                                                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                                    <strong>Challan Information  !</strong>Record No Found...</div>';
                                                           endif;
                                      endif;
                                    ?> 
                                    </div>
...
jQuery(document).on("change", ".update_installment", function() {
  ...
  <script>
  jQuery(document).ready(function(){
    jQuery('.update_installment').dblclick(function(){
        jQuery(this).val('0');
         var sum = 0; 
         jQuery(".update_installment").each(function(){
        sum += +$(this).val();
