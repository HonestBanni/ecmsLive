        ...
        ?>
                ...
                <div class="col-md-12"> 
                    <div class="report_header">
                      ...
                      <h4 class="text-highlight" style=" text-align: center"><?=$Bank_info?></h4>
                  ...
                  <div class="table-responsive">
                      <h5 class="text-highlight" style=" text-align: left">Total Student : <?=count($std_result)?></h5>
                        <table class="table table-hover" id="table">
                              ...
                              <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td><strong><?=$actualgrandTotal?></strong></td>
                                     <td></td>
                                    <td><strong><?=$paidgrandTotal?></strong></td>
                                    <td></td>
                                    <td></td>
