...
//                  echo '<pre>';print_r($fee_information);
               ...
               foreach($fee_information as $challan_info):
                 ...
                 ?> 
                        ...
                        <tr class="danger">
                            <td colspan="2" style="border: 1px solid #000000;">Payment Category  :<strong><?php echo $challan_info->pc_name?></strong></td>
                            <td colspan="4" style="border: 1px solid #000000;">Challan Comments  :<strong><?php echo $challan_info->fc_comments?></strong></td>
