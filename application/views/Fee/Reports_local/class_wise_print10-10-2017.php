...
<!--                        <td  style="border-top: 0px solid #000000;"></td>-->
                    ...
                    <tr>
                        <td colspan="4" style="border-top: 0px solid #000000;">Class :  <strong><?php echo $stdInfo->sectionName.' ('.$stdInfo->subProName.')'?> </strong> </td>
                    ...
                    <tr>
                       ...
                       <td colspan="2"style="border-top: 0px solid #000000;">Valid till: <strong><?php echo date_format(date_create($stdInfo->fc_dueDate),"d-M-Y")?></strong></td>
                    </tr>
                    ...
                    <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">    
                    <tr>
                        <td style="border-top: 0px solid #000000;">Payment Details :  <strong><?php
...
//                                'balance >'        =>0,
               ...
               <h6 align="center" style="border-top: 1px solid; font-size: 12px;">F#( <strong><?php echo $stdInfo->form_no?> )Banker's stamp &amp; signature</strong></h6>
