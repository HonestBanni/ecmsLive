...
<!--                                    <button type="submit" class="btn btn-theme" name="conce_std_wise" id="conce_std_wise"  value="conce_std_wise" ><i class="fa fa-search"></i> Section Wise</button>
                                    ...
                                    <!--<button type="submit" class="btn btn-theme" name="hostel_head_wise" id="hostel_head_wise"  value="hostel_head_wise" ><i class="fa fa-book"></i>Head wise</button>-->
                ...
                <div class="col-md-10 col-md-offset-1"> 
                  ...
                  if($report_type == 'hostel_std_wise'): ?>
                    <div class="report_header">
                      ...
                      <h3 class="text-highlight" style=" text-align: center"><?php $report_head?> Fee Report</h3>
                    </div>
...
//                                    echo '<pre>';print_r($where);die;
                  ...
                  if($report_type == 'hostel_head_wise'): ?>
                    <div class="report_header">
                      <img style="float: right; padding-right: 79px;"  class='img-responsive' src='assets/images/logo-black.png' alt='Edwardes College Peshawar'>
                      <h3 class="text-highlight" style=" text-align: center">Host</h3>
                    </div>
                        <h4 class="text-highlight" style=" text-align: center"><?=$report_name?></h4>
