                           ...
                           <form action="" class="course-finder-form" method="post" accept-charset="utf-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-5">
                                         ...
                                         <input type="text" class="form-control phone" name="hostel_mobile_no1" placeholder="0300-0000000" value="<?php echo $result->name;?>" >
                                          
                                     
                                     </div>
                                    <div class="col-md-3 col-sm-5">
                                         <label for="name">Hostel SMS NO.1:</label>
                                         <input type="text" class="form-control phone" name="hostel_mobile_no2" placeholder="0300-0000000" value="<?php echo $result->name;?>" >
