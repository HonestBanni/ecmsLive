                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                          ...
                                          <div class="form-group">
                                               ...
                                               $query = $this->db->get_where('student_attendance_details')->result();
                                              $yearShow = array();
                                               foreach($query as $year):
                                                  $yearShow[date('Y',strtotime($year->timestamp))] =  date('Y',strtotime($year->timestamp));
                                               endforeach;
//                                                $year = array(
//                                                        '2016'=>'2016',
//                                                        '2017'=>'2017',
...
//                                                        '2021'=>'2021',
//                                                       );
                                                    echo form_dropdown('year', $yearShow,$current_year,  'class="form-control" id="programId"');
                                                ?>
                                              </div>
                                    <div class="form-group">
