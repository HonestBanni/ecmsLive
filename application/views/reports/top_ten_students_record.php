...
<script language="javascript">
  function printdiv(printpage)
  {
   ...
   var program      = jQuery('#feeProgrameId :selected').text(); 
   var batchid      = jQuery('#batch_id :selected').text(); 
   var sub_pro_name = jQuery('#showFeeSubPro :selected').text(); 
         ...
         ?>     
             <div id="div_print">
                 <div class="report_header">                   
                    <h3 class="text-highlight" style=" text-align: center">Top Ten Students Result </h3>
                    <h4 class="text-highlight" style=" text-align: center" ><div id="jq_program"></div></h4>
                    <h4 class="text-highlight" style=" text-align: center" ><div id="jq_batch_id"></div></h4>
                    <h4 class="text-highlight" style=" text-align: center" ><div id="jq_sub_pro_id"></div></h4>
                 </div>
                 <hr> 
                <?php
                if($result):
                ...
                $TMO = $this->ReportsModel->get_top_ten_marks_result($whereMarks);
                $TMOM = 0;
                $TMTM = 0;
