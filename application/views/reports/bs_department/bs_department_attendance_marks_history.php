...
<div class="content container">
            ...
            <?php        
                ...
                if(!empty($student_id)){
                    ...
                    { ?>          
                          <input type="text" name="student_id" required="required" value="<?php echo $emprec->student_name; ?>" placeholder="Enter College No" class="form-control" id="students_name">
                    <input type="hidden" name="student_id" id="student_id" value="<?php echo $emprec->student_id; ?>">      
                    <?php 
                    }     
                }else{?>
        <input type="text" name="student_id" required="required" placeholder="Enter College No" class="form-control" id="students_name">
    ...
    jQuery(document).ready(function(){
        jQuery("#students_name").autocomplete({  
        minLength: 0,
        source: "ReportsController/bs_program_student_search_auto/"+$("#students_name").val(),
        autoFocus: true,
        scroll: true,
        dataType: 'jsonp',
        select: function(event, ui){
        jQuery("#students_name").val(ui.item.contactPerson);
