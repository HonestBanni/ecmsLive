      ...
      <div class="modal-footer">
        ...
        jQuery(document).ready(function(){
            ...
            jQuery("#EmpBsProgram").autocomplete({  
                minLength: 0,
                source: "DropdownController/auto_emp_bs_law/"+$("#EmpBsProgram").val(),
                autoFocus: true,
                scroll: true,
                dataType: 'jsonp',
            ...
            jQuery("#SecBsProgram").autocomplete({  
                minLength: 0,
                source: "DropdownController/auto_sec_bs_law/"+$("#SecBsProgram").val(),
                autoFocus: true,
                scroll: true,
                dataType: 'jsonp',
                select: function(event, ui){
            ...
            jQuery("#SubjBsProgram").autocomplete({  
                minLength: 0,
                source: "DropdownController/auto_subj_bs_law/"+$("#SubjBsProgram").val(),
                autoFocus: true,
                scroll: true,
                dataType: 'jsonp',
                select: function(event, ui){
           ...
           jQuery('.timetable_details').on('click',function(){
            ...
            $('#print_bs_list').on('click', function(){
                ...
                if(SubjId == ''){ SubjId = 0; }
                window.open('ReportsController/bslaw_exame_result_print/'+TeacherId+'/'+SectionId+'/'+SubjId, '_blank');
            });
