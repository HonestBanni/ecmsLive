...
<div class="content container">
            ...
            <?php        
                ...
                if(!empty($student_id)){
                    ...
                    { ?>          
        <input type="text" name="student_id" value="<?php echo $emprec->student_name; ?>" placeholder="Student" class="form-control" id="students_bseng">
                    <input type="hidden" name="student_id" id="student_id" value="<?php echo $emprec->student_id; ?>">      
                    <?php 
                    }     
                }else{?>
        <input type="text" name="student_id" placeholder="Student" class="form-control" id="students_bseng">
            ...
            <?php if(@$result): ?>
                ...
                <div class="table-responsive">                      
                    <table class="table table-hover table-boxed table-bordered">
                        <thead>
                            <tr>
                                <th colspan="2">Name: <?php echo  strtoupper($result->student_name); ?></th>
                                <th>F-Name: <?php echo  strtoupper($result->father_name); ?></th>
                                <th>College # <?php echo  strtoupper($result->college_no); ?></th>
                                <th>Program: <?php echo  strtoupper($result->programName); ?></th>
                                <th colspan="2">Class Name: <?php echo  strtoupper($result->sectionsName); ?></th>
                            </tr>
                            <tr>
                                <td colspan="7" align="center" style="color:red"><strong>Student Attendance Comulative</strong></td>
                            </tr>
    ...
    jQuery(document).ready(function(){
        jQuery("#students_bseng").autocomplete({  
        minLength: 0,
        source: "ReportsController/auto_students_bseng/"+$("#students_bseng").val(),
        autoFocus: true,
        scroll: true,
        dataType: 'jsonp',
        select: function(event, ui){
        jQuery("#students_bseng").val(ui.item.contactPerson);
