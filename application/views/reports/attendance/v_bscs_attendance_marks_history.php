        ...
        <div class="col-md-12">    
            <form method="post">
                ...
                <?php    
                    ...
                    <input type="text" name="student_id" value="<?php echo $emprec->student_name; ?>" placeholder="Student" class="form-control" id="students_bscs">
                    <input type="hidden" name="student_id" id="student_id" value="<?php echo $emprec->student_id; ?>">      
                    <?php } } else { ?>
                    <input type="text" name="student_id" placeholder="Student" class="form-control" id="students_bscs">
    ...
    <div class="col-md-12">
        <div class="table-responsive">
            <div id="div_print"> 
                ...
                <?php foreach($sub_program as $SubPro): ?>          
...
<script>
    jQuery(document).ready(function(){
        jQuery("#students_bscs").autocomplete({  
        minLength: 0,
        source: "ReportsController/auto_students_bscs/"+$("#students_bscs").val(),
        autoFocus: true,
        scroll: true,
        dataType: 'jsonp',
        select: function(event, ui){
        jQuery("#students_bscs").val(ui.item.contactPerson);
