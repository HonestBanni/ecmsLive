...
//                            echo '<pre>';print_r($mess_row);die;
            ...
            <!--<h4 align="center">Add Academic Record <hr></h4>-->
            <hr/>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-3">
                                ...
                                <select class="form-control" name="degree_id">
                                    <?php 
                            $d = $this->db->query('SELECT * FROM degree WHERE degree_id in(2,17) ORDER BY degree_id asc');
                        ...
                        <div class="form-group col-md-3">
                                ...
                                <select class="form-control" name="bu_id">
                                    <?php 
                            $d = $this->db->query('SELECT * FROM board_university WHERE bu_id=1');
                            foreach($d->result() as $drow):        
                                    ?>
                        ...
                        <div class="form-group col-md-3">
                                ...
                                <?php echo form_dropdown('year_of_passing', $year_of_pass,'',  'class="form-control required="required""');?>
                        ...
                        <div class="form-group col-md-3">
                                ...
                                <input type="text" name="total_marks" value="1100" class="form-control" readonly> 
                       </div> 
                        <div class="form-group col-md-3">
                      ...
                      <div class="form-group col-md-3">
                            ...
                            <?php
                             echo form_dropdown('grade_id', $grade, '',  'class="form-control"');
                            ?>
                       </div>
                        <div class="form-group col-md-3">
                        ...
                        <div class="form-group col-md-3">
                        <label for="usr">Exam Type:</label>
                         <select name="std_character" class="form-control">
                             <?php
                                $chr = $this->CRUDModel->getResults('student_character');
                                foreach($chr as $char_row):
                                    echo '<option value="'.$char_row->char_id.'">'.$char_row->char_name.'</option>';
                                endforeach;
                             ?>
                            </select> 
                       </div>
                        <div class="form-group col-md-3">
                            ...
                            if($totl == 0 || !empty($securty_issue)):                
                            ?>
                            <a style="margin-top:23px;" href="AdminDeptController/Print_provisional_certificate_inter/<?php echo $result->student_id;?>" class="btn btn-theme">Print</a>
                            <?php endif;?>
                        </div>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped display" width="100%">
                 ...
                 <?php
                        ...
                        <tr class="gradeA">
                            ...
                            <td><a href="AdminDeptController/deleteAcademic/<?php echo $rec->serial_no;?>/<?php echo $rec->student_id;?>" onclick="return confirm('Are You Want to Delete This..?')">Delete</a></td>
                        </tr>
                        <?php
                        endforeach;
                        endif;
