...
//                                        $sub_program = array('Sub Program'=>"Sub Program");
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group ">
                                        <?php 
//                                        $sub_program = array('Sub Program'=>"Sub Program");
                                                echo form_dropdown('degree_id', $degree,'',  'class="form-control degree_id" id="degree_id"');
                                        ?>
                                    </div>
                                </div> 
                                <div class="col-md-3">
...
//       jQuery('#acdemicResult2').hide();
       ...
       if(sub_programId == '')
        ...
        var  degree_id = jQuery('.degree_id').val();
       if(degree_id == '')
            {
               alert('Please select Degree ');
               jQuery('.degree_id').focus();
               return false;
            }
