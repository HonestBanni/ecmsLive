  ...
  public function getClassDaym($table,$where)
    {
        ...
        $this->db->order_by('class_starting_time.order_stime','asc');
        $query =  $this->db->get();
        if($query):
            return $query->result();
        endif;
    ...
    public function getClassDaysat($table,$where)
    {
        $this->db->SELECT('
                class_alloted.class_id,
                class_alloted.sec_id,
        ...
        $this->db->join('subject','subject.subject_id=class_alloted.subject_id', 'left outer');
        $this->db->where($where);
        $this->db->where('timetable.day_id','6');
        $this->db->order_by('class_starting_time.order_stime','asc');
        $query =  $this->db->get();
        if($query):
            return $query->result();
    ...
    public function adminstudent_attendance_search($table,$where)
    {
       $this->db->select('
        student_attendance.attend_id,
        student_attendance.attendance_date,
...
//            endif;
//   }
    public function admin_search_history_vp($table,$where=NULL,$from_date=NULL,$to_date=NULL){
        ...
        $this->db->join('subject','subject.subject_id=class_alloted.subject_id');
       $this->db->join('sections','sections.sec_id=class_alloted.sec_id');
       $this->db->order_by('student_attendance.timestamp','asc');
//       $this->db->group_by('DATE(student_attendance.timestamp)');
        if($from_date !="" && $to_date !=""):
                $this->db->where('DATE(student_attendance.timestamp) BETWEEN "'.date('Y-m-d',strtotime($from_date)).'" and "'.date('Y-m-d',strtotime($to_date)).'"');
        endif;
    ...
    public function admin_search_history_law($table,$where=NULL,$from_date=NULL,$to_date=NULL){
...
$this->db->where('student_record.s_status_id','5');
    ...
    public function present_daily_students_search($where)
    {
       $this->db->select('
        student_attendance_details.*,
        student_attendance.*,
    ...
    public function absent_daily_students_search($where)
    {
       $this->db->select('
        student_attendance_details.*,
        student_attendance.*,
    ...
    public function total_daily_students_search($where)
    {
       $this->db->select('
        student_attendance_details.*,
        student_attendance.*,
    ...
    public function present_daily_students_search_btw_dates($where, $from_date, $to_date)
    {
       $this->db->select('
        student_attendance_details.*,
        student_attendance.*,
    ...
    public function absent_daily_students_search_btw_dates($where, $from_date, $to_date)
    {
       $this->db->select('
        student_attendance_details.*,
        student_attendance.*,
    ...
    public function total_daily_students_search_btw_dates($where, $from_date, $to_date)
    {
       $this->db->select('
        student_attendance_details.*,
        student_attendance.*,
...
//        $this->db->order_by('practical_timetable.stime_id','asc');
    ...
    public function getDBUserLaw($table,$like=NULL)
    {
       $this->db->select('
        hr_emp_record.emp_id as emp_id,
        hr_emp_record.emp_name as emp_name,
       ...
       '); 
        ...
        $this->db->join('department','department.department_id=hr_emp_record.department_id', 'left outer');
        $this->db->where(array('users.user_status'=>1, 'hr_emp_record.cat_id'=>1,'emp_status_id'=>1));
        $this->db->where(array('department.department_id' => 22));
        if($like):
        $this->db->like($like);
        endif;
    ...
    public function getstudent_exam_prev($table,$where=NULL)
    {
       $this->db->select('
        exams_bs.*,
        sections.*,
...
//        $this->db->order_by('exams_bs.exb_test_id','desc');
    ...
    public function view_exam_marks_list_print($table,$where){
        $this->db->select('
        student_record.student_id as student_id,
        student_record.student_name as student_name,
        student_record.father_name as father_name,
    ...
    ->where_in('student_record.s_status_id', array(5,8,12))
     ->get();
        return $query->result();  
    }
    ...
    public function search_def_disc_actions($table, $where=NULL, $like=NULL){
        ...
        $this->db->join('users','users.id=proctorial_fine.proc_user_id','left outer');
        $this->db->join('hr_emp_record','hr_emp_record.emp_id=users.user_empId','left outer');
        $this->db->where_in('student_record.s_status_id', array(5,8,12));
        if($where):   
          $this->db->where($where);
        endif;    
        if($like):   
...
//        $this->db->where('programe_id =','2');   
    ...
    public function leave_record_single($table, $where=NULL){
        $this->db->select('
        student_attendance_leave_record.*,
        student_record.student_name,           
        student_record.father_name,           
        student_record.college_no,            
        student_record.form_no,  
        ...
        ');
        $this->db->FROM($table);
        $this->db->join('student_record','student_record.student_id=student_attendance_leave_record.salr_student_id','left outer');  
        $this->db->join('student_status','student_status.s_status_id=student_record.s_status_id','left outer');
        $this->db->join('programes_info','programes_info.programe_id=student_record.programe_id','left outer') ; 
        $this->db->join('sub_programes','sub_programes.sub_pro_id=student_record.sub_pro_id','left outer');
        $this->db->join('student_group_allotment','student_group_allotment.student_id=student_record.student_id','left outer');
    ...
    public function search_1styr_leave_record($table, $where=NULL, $like=NULL){
        $this->db->select('
        student_attendance_leave_record.*,
        student_record.student_name,           
        student_record.father_name,           
        ...
        $this->db->join('student_group_allotment','student_group_allotment.student_id=student_record.student_id','left outer');
        $this->db->join('sections','sections.sec_id=student_group_allotment.section_id','left outer');
        $this->db->join('users','users.id=student_attendance_leave_record.salr_user_id','left outer');
        $this->db->join('hr_emp_record','hr_emp_record.emp_id=users.user_empId','left outer');
    ...
    public function get_students_1st_year($table,$like=NULL){
        $this->db->SELECT('
        student_record.*,
        sub_programes.name as sub_program,
        student_status.name as std_status,
        ...
        $this->db->where_in('student_record.sub_pro_id',array(1,2,4,5));   
        $this->db->where_in('student_record.s_status_id',array(5,8));   
//        $this->db->where('programe_id =','1');   
         $query = $this->db->get();
        return $query->result();  
    }
    
    public function search_2ndyr_leave_record($table, $where=NULL, $like=NULL){
        $this->db->select('
        student_attendance_leave_record.*,
        student_record.student_name,           
        student_record.father_name,           
        ...
        $this->db->join('users','users.id=student_attendance_leave_record.salr_user_id','left outer');
        $this->db->join('hr_emp_record','hr_emp_record.emp_id=users.user_empId','left outer');
        $this->db->where_in('student_record.sub_pro_id', array(24,25,26,27));
        if($where):   
          $this->db->where($where);
        endif;    
        if($like):   
    ...
    public function get_students_2nd_year($table,$like=NULL){
        $this->db->SELECT('
        student_record.*,
        sub_programes.name as sub_program,
        student_status.name as std_status,
