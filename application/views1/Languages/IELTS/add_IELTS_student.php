 <!-- ******CONTENT****** --> 
    ...
    <h3 align="left">Student Admission Information<hr></h3>
        <div class="form-group col-md-4">
            ...
            <select type="text" name="batch_id" class="form-control">
                <?php
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE programe_id=19 order by batch_id desc");
        ...
        <div class="form-group col-md-4">
            ...
            <select type="text" name="programe_id" class="form-control">
                <?php
        $b = $this->db->query("SELECT * FROM programes_info WHERE programe_id=19");
                foreach($b->result() as $brec)
                {
                ?>
    <option value="<?php echo $brec->programe_id;?>"><?php echo $brec->programe_name;?></option>
        ...
        <div class="form-group col-md-4">
           ...
           <?php
        $c = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=19");
    ...
    <div class="form-group col-md-3">
      ...
      <div class="form-group col-md-12">
       ...
       <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            <button type="submit" class="btn btn-theme" name="Save" value="Save"> Add Student</button>
        </div>
                    <?php echo form_close();?> 
                        </div>
                    </div>
