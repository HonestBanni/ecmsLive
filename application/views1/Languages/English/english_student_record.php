    <div class="content container">
            <h2 align="left"><?php echo $page_header;?><span  style="float:right"><a href="RegEnglishLangStudent" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
...
foreach($result as $rec)  
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>">
    ...
    <td><a class="btn btn-primary btn-sm" href="UpEnglishLangStudent/<?php echo $rec->student_id;?>"><b>Update</b></a></td>
