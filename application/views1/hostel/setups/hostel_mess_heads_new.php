...
//                                        $sub_program = array('Sub Program'=>"Sub Program");
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3 pull-right">
                                    ...
                                    <button type="button" class="btn btn-theme" name="search_hotel_setups_info" id="search_hotel_setups_info"  value="search_hotel_setups_info" ><i class="fa fa-search"></i> Search</button>
              ...
              <div id="search_hotel_setups_info_result"></div>
...
//                            jQuery('#hostel_type_id_hostel_head').val('');
    ...
    jQuery('#search_hotel_setups_info').on('click',function(){
        
            var payment_id  = jQuery('#feeProgrameId').val();
           ...
           var   data = {
                        'payment_id'    : payment_id,
                        'batch_id'      : batch_id,
                        'instal_type'   : instal_type,
                         
                    };

                     jQuery.ajax({
                       type   :'post',
                       url    :'hosteHeadInstall',
                       data   :data,
                       success:function(result){
                           jQuery('#search_hotel_setups_info_result').html(result);
                       }
