                                    ...
                                    if($row->payment_date == '0000-00-00'):
                                       ...
                                       echo '<td>'.$payment_date.'</td>
                                                ...
                                                if($row->ch_status_id ==1):
                                                    ...
                                                    <td><a href="hostelCancelChallan/'.$row->challan_id.'/'.$row->hostel_id.'" class="btn btn-danger btn-xs" target="_new"><i class="fa fa-times"></i>Cancel<a></td>
                                                    ...
                                                    <td><a href="hostelAddHead/'.$row->hostel_id.'/'.$row->challan_id.'" class="btn btn-success btn-xs" target="_new"><i class="fa fa-print"></i>Add Head<a></td>';
                                            else:
                                                echo '<td></td>';
                                                echo '<td></td>';
                                                echo '<td></td>';
