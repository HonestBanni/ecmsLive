...
<!--              <div class="form-group ">
              ...
              <div class="form-group">
                <?php 
                  form_dropdown('gender', $gender, $genderId,  'class="form-control" id="my_id"');
                ?>
              </div>
              <div class="form-group">
                <?php 
              ...
              <div class="form-group">
                <?php 
                  form_dropdown('batch', $batch, $batchId,  'class="form-control" id="my_id"');
                ?>
              </div>
              <div class="form-group">
                <?php 
                  form_dropdown('sections_name', $sections, $sectionId,  'class="form-control" id="my_id"');
                ?>
              </div>
              ...
              <div class="form-group">
            <?php 
                  form_dropdown('reserved_seat', $reserved_seat, $reserved_seatId,  'class="form-control" id="my_id"');
            ?>
              </div>
              <div class="form-group">
                <?php 
                 form_dropdown('application_status', $student_status,$application_statusId,  'class="form-control" id="my_id"');
                ?>
              </div>
              <!--//form-group-->
              <div class="form-group">
                ...
                <?php 
                  $limit = array(
                   ...
                   form_dropdown('picture',$limit,$pictureId,  'class="form-control" id="my_id"');
                ?>
