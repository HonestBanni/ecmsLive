...
<form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/update_degree_assigning_subject">
...
//         $sectioCheck = $this->CRUDModel->get_where_row('student_group_allotment',array('sec_id'=>$student_id));
            ...
            if($gres){
                ...
                { ?>          
                <input type="text" required="required" name="sec_Name" value="<?php echo $grec->name; ?>" placeholder="Section" class="form-control" id="sec">
                <input type="hidden" name="sec_id" id="sec_id" value="<?php echo $grec->sec_id; ?>">      
                <?php 
                }     
            }else{?>
            <input type="text" name="sec_Name" placeholder="Section" class="form-control" id="sec" required="required">
                    <input type="hidden" type="clas" name="sec_id" id="sec_id">    
                <?php
                }    
            ?>                  
    </div>
