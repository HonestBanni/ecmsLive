    <div class="content container">
            <h2 align="left">Students Record (Chinese-Languages) <span  style="float:right"><a href="admin/add_language_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
