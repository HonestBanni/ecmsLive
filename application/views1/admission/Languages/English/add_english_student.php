 <!-- ******CONTENT****** --> 
        ...
        <form name="search" method="post" action="Admin/search_english_student">    
            <div class="col-md-3">
    ...
    <input type="hidden" name="student_id" id="student_id">
            ...
            <h3 align="left" style="border-bottom:1px solid #ccc;">Add New Student (English Language)</h3>
       
            <div class="row cols-wrapper">
                <div class="col-md-12">
                    
    <form name="student" method="post" action="admin/add_english_student">        
    <h3 align="left">Student Admission Information<hr></h3>
        <div class="form-group col-md-4">
            ...
            <select type="text" name="batch_id" class="form-control">
                <?php
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE programe_id=13 order by batch_id desc");
        ...
        <div class="form-group col-md-4">
            ...
            <select type="text" name="programe_id" class="form-control">
                <?php
        $b = $this->db->query("SELECT * FROM programes_info WHERE programe_id=13");
                foreach($b->result() as $brec)
                {
                ?>
    <option value="<?php echo $brec->programe_id;?>"><?php echo $brec->programe_name;?></option>
        ...
        <div class="form-group col-md-4">
           ...
           <?php
        $c = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=13");
        ...
        <?php  
            $StdMob_network = '';
             if(!empty($result->std_mobile_network)): 
                 $StdMob_network =  $result->std_mobile_network; 
                $mobile_network          = $this->CRUDModel->dropDown('mobile_network','', 'net_id', 'network',array('net_id'=>$result->std_mobile_network)); 
             else:
                $mobile_network          = $this->CRUDModel->dropDown('mobile_network','Select Mobile No', 'net_id', 'network');  
             endif; 
        
            
            echo form_dropdown('mobile_network_student',$mobile_network,$StdMob_network,array('class'=>'form-control'));  
            ?>
        </div>
        <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="gender_id" class="form-control" required>
