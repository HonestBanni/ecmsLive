 <!-- ******CONTENT****** --> 
        <div class="content container">
            ...
            <form name="student" method="post" enctype="multipart/form-data" action="admin/add_student_record_pending"> 
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="batch_id" id="batch_id" class="form-control">
                <?php
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE  `batch_name` LIKE  '%FSc%' order by batch_name desc LIMIT 2");
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" name="form_no" id="form-Checking" placeholder="form no e.g 222" class="form-control" disabled="disabled">        
        </div>
        <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="email" placeholder="Applicant Email" name="std_email" class="form-control">        
        </div>
    ...
    <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" placeholder="Last School Address" name="last_school_address" class="form-control">      
        </div> 
        <div class="form-group col-md-6">
