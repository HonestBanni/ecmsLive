<?php
        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Add Academic Record<hr></h2>
...
<br />
<form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/admin_student_academic_record/<?php echo $student_id;?>">
    ...
    <div class="form-group col-md-4">
            ...
            <input type="text" name="bu_id" class="form-control" id="bu" required>
    ...
    <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-2">
            <a href="<?php echo base_url();?>admin/all_student_record" onclick="myFunction()" class="btn btn-primary">Save Student Record</a>
        </div>
    </div>
