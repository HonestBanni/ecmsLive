...
<!--              <h2 align="left">Hostel Students Record<span style="float:right"><a href="HostelController/add_hostel_student" class="btn btn-large btn-primary">Add Hostel Student</a></span><hr></h2>-->
            ...
            <form method="post" action="admin/search_migrated_student">
    ...
    <img src="<?php echo base_url();?>assets/images/students/<?php echo $sRow->applicant_image;?>" style="border-radius:10px;" width="60" height="60">
                <?php 
                    ...
                    ?></td>
                        ...
                        <td><a class="btn btn-success btn-sm" href="admin/add_migrated_student/<?php echo $sRow->student_id;?>"><b>Student Migration </b></a></td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
            </table>
            ...
            <form method="post" action="admin/migrated_student_record">
                <div class="form-group col-md-2">
            <?php        
    ...
    <table class="table table-boxed">
        ...
        ?>    
            ...
            if($status == 1):
                ...
                <td><a class="btn btn-theme btn-sm" href="admin/update_migrated_student/<?php echo $row->migration_id;?>">Update</a> </td>   
        </tr>
            <?php 
            $i++;
                endforeach;
