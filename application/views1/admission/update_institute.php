<?php
        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Update Institute <hr></h2>
            <div class="row cols-wrapper">
                <div class="col-md-12">
									...
									<form class="form-horizontal row-fluid" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/update_institute/<?php echo $id;?>">
