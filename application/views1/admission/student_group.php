    ...
    <header class="page-heading clearfix">
      ...
      <div class="breadcrumbs pull-right">
        <ul class="breadcrumbs-list">
          ...
          <li class="current">Student Groups
        </ul>
      </div>
      <!--//breadcrumbs-->
    </header> 
        ...
        <form>
            <div class="row">
             <div class="col-md-12">
                ...
                <hr>
        <?php echo form_open('admin/student_group'); ?>
            <div class="row">
             <div class="col-md-12">
                 <div class="row">
                     <div class="col-md-2">
                     ...
                     <div class="col-md-2">
                         <div class="form-group ">
                            <?php 
                              echo form_dropdown('gender_id', $gender,$gender_id,  'class="form-control" id="programId"');
                          ?>
                        </div>
                     </div>
                     <div class="col-md-2">
                         <div class="form-group ">
                        <input type="text" name="limit" value="<?php echo $limit?>" class="form-control" placeholder="Limit eg 35">
                        </div>
                     </div>
