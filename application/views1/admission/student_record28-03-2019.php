        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">All Students (Inter Level)<span  style="float:right"><a href="admin/add_student_record" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
...
$i = 1;
 ...
 <td><a href="admin/student_profile/<?php echo $student_id;?>"><span style="font-size:15px;"><?php echo $student_name;?></span></a>    
    ...
    <td><a class="btn btn-danger btn-sm" href="admin/upload_sphoto/<?php echo $student_id;?>"><b>Add Pic</b></a></td>
    </tr>
<?php
}
 ?>
