 <!-- ******CONTENT****** --> 
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="center" style="border-bottom:1px solid #ccc;">Add New Student (Bs-English)</h2>
                <div class="row cols-wrapper">
                    <div class="col-md-12">
                        <form name="student" method="post" enctype="multipart/form-data" action="admin/add_bs_english_student">        
                            <h3 align="left">Student Admission Information<hr></h3> 
                                <div class="form-group col-md-3">
                                    <label for="usr">Batch Name:</label>
                                    <?php echo form_dropdown('batch_id', $prospectus_batch,'',  'class="form-control" '); ?> 
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="usr">Program Name:</label>
                                    <?php echo form_dropdown('programe_id', $programes_info,'',  'class="form-control"  id="id="SProgrameId"');?>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Sub Program</label>
                                     <?php echo form_dropdown('sub_pro_id', $sub_programes,'',  'class="form-control"  id="id="showingSubPro"'); ?>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="usr">Form No.:</label>
                                    <input type="text" name="form_no" id="form_Check" placeholder="form no e.g a-123" class="form-control">        
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="usr">Reserved Seats:</label>
                                    <?php echo form_dropdown('rseats_id', $reserved_seat,'',  'class="form-control" '); ?>
