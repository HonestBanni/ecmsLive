        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Degree Level Subject Allottment<hr></h2>
...
$query = $this->CRUDModel->get_where_row('student_subject_alloted',array('student_id'=>$student_id));
    ...
    { 
    ?>
<a class="btn btn-primary btn-sm" href="<?php echo base_url();?>admin/degree_std_updassign_subjects/<?php echo $student_id;?>/<?php echo $rec->sub_pro_id;?>">Update Subjects</a>      
    <?php
    }
    else{
        ?>
   <a class="btn btn-success btn-sm" href="<?php echo base_url();?>admin/degree_std_assign_subjects/<?php echo $student_id;?>/<?php echo $rec->sub_pro_id;?>">Assign Subjects</a>
<?php
    }            
    ?>    </td>
    </tr>
