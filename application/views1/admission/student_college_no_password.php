        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">All Students College # and Password<hr></h2>
...
$i = 1;
    ...
    <img src="<?php echo base_url();?>assets/images/students/<?php echo $applicant_image;?>" style="border-radius:10px;" width="60" height="60">
                ...
                <td style="color:red;font-size:16px;"><?php echo $rec->student_password;?></td>
                ...
                <td><span class="label label-primary"><?php echo $rec->status;?></span></td>
                <td><a href="admin/edit_collegeno_and_password/<?php echo $student_id;?>"><span class="btn btn-theme btn-sm">Edit</span></a></td>
    </tr>
        <?php
        }
         ?>
