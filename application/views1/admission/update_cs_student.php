...
<div class="content container">
       <!-- ******BANNER****** -->
<h2 align="center">Update Student (BS(CS) Science)</h2>    
    ...
    <div class="form-group col-md-3">
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM programes_info WHERE programe_id=2");
                    foreach($b->result() as $brec)
                    {
                    ?>
                    ...
                    foreach($q->result() as $rec)  
                    {
                        ...
                        */
                        ...
                        <tr class="gradeA">
                            ...
                            <td><a href="admin/update_cs_academic_record/<?php echo $rec->serial_no;?>">Update</a></td>
<!--                           
