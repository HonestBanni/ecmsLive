...
<h2 align="center" style="border-bottom:1px solid #ccc;"><?php echo $page_header;?></h2>   
    <div class="row cols-wrapper">
        <div class="col-md-12">
            ...
            <form name="student" method="post" enctype="multipart/form-data">       
                ...
                <input type="hidden" name="FK_sub_pro_id" value="<?php echo $sub_pro_id;?>">
                ...
                <input type="hidden" name="PK_student_id" id="StudentID" value="<?php echo $id;?>">
        ...
        <div class="form-group col-md-3">
            ...
            echo '<option type="text" value=""></option>';
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                    $b = $this->db->query("SELECT * FROM prospectus_batch WHERE  `batch_name` LIKE  '%FSc%'");
            ...
            <div class="form-group col-md-3">
               ...
               <select class="form-control subject_changer" type="text" name="sub_pro_id" >
                   <?php
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" name="form_no" id="form-Checking" value="<?php echo $row->form_no;?>" class="form-control" required="required">
            </div>    
            <div class="form-group col-md-3"> 
            ...
            <div class="form-group col-md-3"> 
              ...
              <select class="form-control" type="text" name="rseats_id3">
                   <?php
                $gres = $this->get_model->get_by_id('reserved_seat',array('rseat_id'=>$rseat_id3));
                    if($gres){
                        foreach($gres as $grec){ ?>                   
                <option type="text" value="<?php echo $grec->rseat_id;?>"><?php echo $grec->name;?></option>
                     <?php 
            ...
            if($s_status_id != 1 && !empty($college_no)):?>
                <input type="text" name="college_no" value="<?php echo $college_no;?>" class="form-control"> 
                <?php else: ?>
   ...
   <div class="form-group col-md-3">
        ...
        <?php else: ?>
        <input type="text" name="student_name" value="<?php echo $row->student_name;?>" class="form-control" required="required">
        <?php endif;?>
    </div>                                          
    <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" name="applicant_mob_no1"  pattern="03[0-9]{2}-(?!1234567)(?!1111111)(?!7654321)[0-9]{7}" title="Follow request format 0000-0000000" value="<?php echo $row->applicant_mob_no1;?>" class="form-control phone" >      
    </div>  
    <div class="form-group col-md-3">
        <label for="usr">Applicant Mob No 2:</label>
        <input type="text" name="applicant_mob_no2"  pattern="03[0-9]{2}-(?!1234567)(?!1111111)(?!7654321)[0-9]{7}" title="Follow request format 0000-0000000" value="<?php echo $row->applicant_mob_no2;?>" class="form-control phone">      
    </div>  
        <div class="form-group col-md-3">
...
<select class="form-control" type="text" name="domicile_id"  required="required">
    <?php
...
<select class="form-control" type="text" name="hostel_required">
  ...
  <div class="form-group col-md-6">
            ...
            <input type="text" placeholder="Last School Address" name="last_school_address"  class="form-control" value="<?php echo $row->last_school_address;?>" required="required">      
    </div>
    <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" name="mobile_no" pattern="03[0-9]{2}-(?!1234567)(?!1111111)(?!7654321)[0-9]{7}" title="Follow request format 0000-0000000" value="<?php echo $row->mobile_no;?>" class="form-control phone" required="required">
        <?php else:?>
        <input type="text" name="mobile_no" class="form-control phone" pattern="03[0-9]{2}-(?!1234567)(?!1111111)(?!7654321)[0-9]{7}" title="Follow request format 0000-0000000"  required="required">
        <?php endif;?>
    </div>
    <div class="form-group col-md-3">
        <label for="usr">Mobile No 2:</label>
        <?php if(!empty($row->mobile_no2)):?>
...
<div class="form-group col-md-3">
    ...
    <?php
        ...
        if($admission_date === '0000-00-00' || $admission_date == "1970-01-01"){
            ...
            ?>
<input type="text" name="admission_date"  value="<?php echo $admission_date;?>" class="form-control">      
</div>
<div class="form-group col-md-3">
...
//    Add Hostel Record
    if(empty($hostelInfo)):
//        echo ' <a  href="HostelNewRecord/'.$id.'"  class="btn btn-theme">Add Hostel Record</a>';
    endif;
...
//        endif;
    ?>
                ...
                <br><br>
                <h3 align="center">Student Academic Record Details<hr><span style="folat:right"><a href="NewAdmissionAcademic/<?php echo $id;?>" class="btn btn-large btn-primary">Add Academic Record</a></span></h3>
                ...
                <?php 
                    ...
                    foreach($q->result() as $rec)  
                    {
                        ...
                        $b = $this->get_model->get_by_id('board_university',array('bu_id'=>$bu_id));
                            ...
                            <td><a href="UpdateAdmissionAcademic/<?php echo $rec->serial_no;?>" class="btn btn-primary">Edit</a></td>
                            <!--             
...
jQuery(document).ready(function(){
     var subProId2 = jQuery('.subject_changer').val();
     if(subProId2 == 5 || subProId2 == 27){
//     if(subProId2 == 4 || subProId2 == 5 || subProId2 == 26 || subProId2 == 27){
         jQuery('#artsubjectlist').show();
         var stdId = jQuery('#StudentID').val();
         jQuery.ajax({
                type   :'post',
                url    :'AdminDeptController/getUpdateCheckSubjects',
                data   :{'subId':subProId2, 'stdId':stdId},
