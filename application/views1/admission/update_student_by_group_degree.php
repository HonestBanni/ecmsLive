...
<div class="content container">
    ...
    <h4 style="color:red; text-align:center;"><?php print_r($this->session->flashdata('msg'));?></h4>
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form method="post" action="admin/update_student_by_group_degree/<?php echo $serial_no;?>">
            ...
            <div class="col-md-12">
              <div class="form-group col-md-4">
                  <script>
                    function myFunc() {
                        alert("In case of Group change Please Check and Click Relevant Subjects");
                    }
                    </script>
              ...
              <div class="form-group col-md-4">
                ...
                <select type="text" name="section_id" class="form-control">
                        ...
                        <option value="">&larr; Assign Section &rarr;</option>
                            <?php
                            $b = $this->db->query("SELECT * FROM sections WHERE program_id=4 AND status LIKE 'On'");
         ...
         <div class="form-group col-md-8">
                    <input type="submit" onclick="myFunc()" class="btn btn-theme" name="submit" value="Update Record">
              </div> 
        </div>            
     </form>
