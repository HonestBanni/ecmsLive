 <!-- ******CONTENT****** --> 
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="center" style="border-bottom:1px solid #ccc;">Add New Student (A Level)</h2>
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form name="student" method="post" enctype="multipart/form-data" action="admin/add_a_level_student">       
        ...
        <div class="form-group col-md-3">
            ...
            <input type="number" name="form_no" id="form_Check" placeholder="form no e.g 222" class="form-control">        
        </div>
        <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" placeholder="Place of Birth" name="place_of_birth" class="form-control"> </div>
        <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" placeholder="Mobile No." name="std_mobile_no" class="form-control phone">        
        </div>
        
        <div class="form-group col-md-3">
            <label>Applicant Mobile Network</label>
                <select name="app_net_id" class="form-control">
