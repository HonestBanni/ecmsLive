    ...
    <div class="content">
        ...
        <div class="module">
            ...
            <div class="module-body">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/update_academic_record/<?php echo $id;?>">
            ...
            <input type="hidden" name="old_student_id" value="<?php echo $student_id;?>">
                   ...
                   <div class="form-group col-md-4"> 
                        ...
                        <input type="text" name="year_of_passing" value="<?php echo $year_of_passing;?>" class="form-control">
                   </div>
                    <div class="form-group col-md-4"> 
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="grade_id" class="form-control">
                           <?php
                        $pro = $this->get_model->get_by_id('grade',array('grade_id'=>$grade_id));
                            if($pro){
                                foreach($pro as $prec){ ?>
                                <option value="<?php echo $prec->grade_id;?>"><?php echo $prec->grade_name;?></option>
                                       <?php
                                    }     
                                        }else{
                                 echo '<option value=""></option>';
                                        ...
                                        ?>  
                                <option>&larr; Select New Grade &rarr;</option>
                        <?php
                        $p = $this->db->query("SELECT * FROM grade");
                        foreach($p->result() as $pr)
                                {        
                                ?>        
                                <option value="<?php echo $pr->grade_id;?>"><?php echo $pr->grade_name;?></option>
                        <?php
                            }
                            ?>    
                            </select>
                    ...
                    <div class="form-group col-md-4"> 
                        <label class="control-label" for="basicinput">Board Roll No.</label>
                       <input type="text" name="board_no" value="<?php echo $rollno;?>" class="form-control">
                   </div>
