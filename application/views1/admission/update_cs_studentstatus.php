...
?>
 <div class="content container">
               <!-- ******BANNER****** -->
            <h4 align="left">Update Admission Status (Computer Science)</h4>
    ...
    <img style="float:right; border-radius:10px;" src="<?php echo base_url();?>assets/images/students/<?php echo $applicant_image;?>" width="120" height="70">
            ...
            <div class="row cols-wrapper">
                ...
                <input style="width:33%; height:30px;" type="text" value="<?php echo $sprec->name;?>"><br><br>              
                            Form No:<span style="margin-left:310px;">Reserved Seats: </span><span style="margin-left:310px;">College No.: </span><br>
                ...
                <input style="width:33%; height:30px;" type="text" placeholder="College No." name="college_no" value="<?php echo $college_no;?>">              
                            <br><br>
                            Student Status:<span style="margin-left:275px;"> Admission Date: </span><span style="margin-left:255px;">Comment: </span><br>                    
...
<input style="width:33%; height:30px;" type="text" placeholder="Status Comment" name="admission_comment" value="<?php echo $admission_comment;?>">                            
                            <br><br>
