  ...
  <div class="content container">
    ...
    <img style="float:right; border-radius:10px;" src="<?php echo base_url();?>assets/images/students/<?php echo $applicant_image;?>" width="100" height="100">
                <?php 
                    ...
                    ?>
            <h2 align="center"><?php echo $empRow->student_name;?>: Student Profile (A Level)</h2>
        </div>
    </div>
    <div class="row cols-wrapper">
        <div class="col-md-12">
        ...
        <div class="form-group col-md-3">
            <label for="usr">Hostel Applied:</label>
            <input type="text" value="<?php echo $empRow->hostel_applied; ?>" class="form-control">      
        </div>
