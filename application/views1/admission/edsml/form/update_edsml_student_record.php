...
<div class="content container">
       <!-- ******BANNER****** -->
<h2 align="center">Update Student EDSML</h2>    
    <div class="row cols-wrapper">
        <div class="col-md-12">
                ...
                <option>&larr; Select &rarr;</option>
                 <?php
                  if($s_status_id == 1):
                    $b = $this->db->query("SELECT * FROM prospectus_batch WHERE programe_id =7");
            ...
            echo '<option type="text" value=""></option>';
                ...
                ?>
                    ...
                    <?php 
                        $sb = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=7");
...
<div class="form-group col-md-12">                       
    <input type="submit" class="btn btn-theme" name="submit" value="Update Student">
                ...
                <br><br>
                <h3 align="center">Student Academic Record Details<hr><span style="folat:right"><a href="<?php echo base_url();?>admin/edsml_student_academic_records/<?php echo $id;?>" class="btn btn-large btn-primary">Add Academic Record</a></span></h3>
            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped	 display" width="100%">
                    ...
                    foreach($q->result() as $rec)  
                    {
                        ...
                        $b = $this->get_model->get_by_id('board_university',array('bu_id'=>$bu_id));
                            ...
                            <?php
                            if($s_status_id == 1):
                                ?><td><a href="admin/update_edsml_academic_student_record/<?php echo $rec->serial_no; ?>" class="btn btn-success">EDIT</a></td><?php
                                else:
