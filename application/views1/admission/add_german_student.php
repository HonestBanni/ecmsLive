<div class="content container">
    <form name="search" method="post" action="Admin/search_german_student">    
            <div class="col-md-3">
    ...
    <input type="hidden" name="student_id" id="student_id">
            ...
            <h3 align="left" style="border-bottom:1px solid #ccc;">Add New Student (German Language)</h3>
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form name="student" method="post" action="admin/add_german_student">        
    <h3 align="left">Student Admission Information<hr></h3>
        <div class="form-group col-md-4">
            ...
            <select type="text" name="batch_id" class="form-control">
                <?php
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE programe_id=11 order by batch_id desc");
    ...
    <option value="<?php echo $brec->programe_id;?>"><?php echo $brec->programe_name;?></option>
        ...
        <div class="form-group col-md-4">
           ...
           <?php
        $c = $this->db->query("SELECT * FROM sub_programes WHERE programe_id='11'");
        ...
        $result = $this->db->get_where('student_record',array('programe_id'=>11))->row();
		if(empty($result)):
				$number = 1;
			else:
