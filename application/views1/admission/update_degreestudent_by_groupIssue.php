...
<div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Update Degree Student by Group<hr></h2>
    <h4 style="color:red; text-align:center;"><?php print_r($this->session->flashdata('msg'));?></h4>
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/update_degreestudent_by_group/<?php echo $serial_no;?>">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group col-md-4">
                  ...
                  $gres = $this->CRUDModel->get_where_row('student_record',array('student_id'=>$student_id));
                
                   
                            if($gres){
                                 ?>
                    <input type="text"   value="<?php echo $gres->student_name;?>" class="form-control"> 
                    <input type="text" name="student_id" value="<?php echo $gres->student_id;?>" class="form-control"> 
                         <?php 
