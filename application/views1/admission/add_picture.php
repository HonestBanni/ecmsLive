        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left">Add Picture (Inter Level)<hr></h2>
...
$i = 1;
    ...
    <img src="assets/images/students/<?php echo $applicant_image;?>" style="border-radius:10px;" width="60" height="60">
                <?php 
                    ...
                    ?></td>
 <td><a href="admin/new_student_profile/<?php echo $student_id;?>"><span style="font-size:15px;"><?php echo $student_name;?></span></a>    
                    </td>
    ...
    <td><a class="btn btn-danger btn-sm" href="admin/adding_spicture/<?php echo $student_id;?>"><b>Add Pic</b></a></td>
    </tr>
        <?php
        }
         ?>
