    <div class="content container">
            <h2 align="left">Arabic Students Record<span  style="float:right"><a href="admin/add_arabic_student" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
    ...
    $c = $this->db->query("SELECT * FROM sub_programes WHERE programe_id=15");
        ...
        <option value="<?php echo $crec->sub_pro_id;?>"><?php echo $crec->name;?></option>
            ...
            <option value="<?php echo $brec->batch_id;?>"><?php echo $brec->batch_name;?></option>
                ...
                <?php 
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE  `programe_id`=15");
                foreach($b->result() as $brec)
                {
                ?>
                    <option value="<?php echo $brec->batch_id;?>"><?php echo $brec->batch_name;?></option>
