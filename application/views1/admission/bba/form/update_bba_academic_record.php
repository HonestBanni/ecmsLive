    ...
    <div class="content">
        ...
        <div class="module">
            <div class="module-head">
                <h3>Update BBA Student Academic Record</h3>
            </div>
            <div class="module-body">
                
                <br />
                
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/update_bba_student_academic_record/<?php echo $id;?>">
