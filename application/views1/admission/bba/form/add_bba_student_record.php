    ...
    <h3 align="left">Student Admission Information<hr></h3> 
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="batch_id" id="batch_id" class="form-control">
                <?php
                $b = $this->db->query("SELECT * FROM prospectus_batch WHERE programe_id='6' order by batch_id desc");
        ...
        <div class="form-group col-md-3">
            ...
            <select type="text" name="programe_id" id="SProgrameId" class="form-control">
                <?php
        $b = $this->db->query("SELECT * FROM programes_info WHERE programe_id='6' ");
                foreach($b->result() as $brec)
                {
                ?>
        ...
        <div class="form-group col-md-3">
           ...
           <?php
        $c = $this->db->query("SELECT * FROM sub_programes WHERE programe_id='6'");
