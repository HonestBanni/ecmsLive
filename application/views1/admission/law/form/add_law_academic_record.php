<?php
        ...
        <form method="post" action="admin/law_student_academic_record/<?php echo $student_id;?>">
...
-->
    ...
    <div class="form-group col-md-4">
            ...
            <input type="text" name="lat_marks" class="form-control"> 
   </div>
    <div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
        <input type="submit" class="btn btn-theme" name="submit" value="Add Record">
            ...
            <div class="form-group col-md-12">    
                <br><p>If Academic Details Completed Then Click on Done Button, Thanks... <a style="float:right; margin-right:600px;" href="admin/law_student_record" onclick="myFunction()" class="btn btn-primary">Done</a></p><br>    
            <br>
                </div>    
