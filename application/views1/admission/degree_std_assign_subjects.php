...
<form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>admin/degree_assigning_subject">
    ...
    <div class="form-group col-md-3">
            ...
            <?php
               ...
               $gres =       $this->CRUDModel->get_where_row('sections',array('sec_id'=>$section->section_id));
             if($gres){
                 ?>          
                <input type="text" required="required" name="sec_Name" value="<?php echo $gres->name; ?>" placeholder="Section" class="form-control" id="sec">
                <input type="hidden" name="sec_id" id="sec_id" value="<?php echo $gres->sec_id; ?>">      
                <?php 
