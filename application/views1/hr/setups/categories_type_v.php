                                ...
                                <div class="section-content">
                                    <form action="" class="course-finder-form" method="post" accept-charset="utf-8" id="saveRecordForm">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <label for="name">Category Type Code</label>
                                                <input type="text" id="category_type_code"  name="category_code" value="" placeholder="Category Type Code" class="form-control">
                                                <input type="hidden" id="category_type_id"  name="category_type_id"  placeholder="Category Code" class="form-control">
                                            </div>
                                            <div class="col-md-3">
                                             <label for="name">Category Type Name</label>
                                             <input type="text" id="category_type_name" name="category_name" value="" placeholder="Category Type Name" class="form-control">
                                            </div>
                                            ...
                                            <div class="col-md-3 pull-right">
                                                ...
                                                <button type="reset" class="btn btn-theme" name="reset" id="SaveUpdate" value="reset"><i class="fa fa-refresh"></i> Reset</button>
                                            </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            ...
            jQuery('#SaveRecord').on('click',function(){
                ...
                var send_payload = {
                        'category_type_code':jQuery('#category_type_code').val(),
                        'category_type_name':jQuery('#category_type_name').val(),
