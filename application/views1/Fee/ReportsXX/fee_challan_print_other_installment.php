            ...
            <div style="margin-top: 2px;width:32%;height:710px;border-right:2px dotted #000;margin-right:8px;margin-bottom:9px;float:left;margin-bottom: 2px;">
              <div style="width:100%; float:left; height:138px; padding:20px;">
                <table class="table table-hover" id="table" style="margin-bottom: 1px;">
                    ...
                    <td style="border-top: 0px solid #000000;"><img class="img-responsive pull-right" src="assets/RQ/challan_rq/<?=$feeComments->fc_challan_rq?>" alt="Edwardes College Peshawar" width="80px;"  ></td> 
                  ...
                  <p style="font-size: 12px; text-align: center;"><strong><?=$feeComments->name?>
                  <br/>Acc No :(<?=$feeComments->account_no?>)
                </strong>
                  ...
                  <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">
                    <tr>
                     <td style="border-top: 0px solid #000000;">College #</td>
                      <td style="border-top: 0px solid #000000;"><strong><?=$studentInfo->college_no?></strong></td>
                      <td style="border-top: 0px solid #000000;">Valid till</td>
                      <td style="border-top: 0px solid #000000;"><strong><?=date_format(date_create($feeComments->fc_dueDate),"d-M-Y")?></strong></td>
                    </tr>
                  </table>       
                  <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">    
                    <tr>
                        <td style="border-top: 0px solid #000000;">Name</td>
                        <td style="border-top: 0px solid #000000;"><strong><?=$studentInfo->student_name?></strong></td>
                    </tr>
                  </table>       
                  <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">    
                    <tr>
                      <td style="border-top: 0px solid #000000;">Class </td>
                      <td colspan="3" style="border-top: 0px solid #000000;"> <strong><?=$studentInfo->sectionsName.' ('.$studentInfo->sub_proram.')'?> </strong> </td>
                    </tr>
                  </table>       
                  <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">    
                    <tr>
                      <td style="border-top: 0px solid #000000;">Issue Date </td>
                      <td style="border-top: 0px solid #000000;"> <strong><?=date_format(date_create($feeComments->fc_issue_date),"d-M-Y")?> </strong> </td>
                      <td style="border-top: 0px solid #000000;">Challan# </td>
                      <td style="border-top: 0px solid #000000;"> <strong><?=$this->uri->segment(2)?></strong> </td>  
                    </tr>
                  </table>
                    <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">    
                    <tr>
...
//                         echo "<pre>";print_r($feeComments);
                            $where_pc =array(
                                        ...
                                        $pc_id = $this->db->where($where_pc)->get('fee_payment_category')->row();
//                                      echo "<pre>";print_r($pc_id); die;
                                     echo $pc_id->title; 
//                                     echo $pc_id->title.'   ('.$pc_id->name.')'; 
                      ...
                      <td style="border-top: 0px solid #000000;"> <strong><?=$studentInfo->form_no?> </strong> </td>
...
//                                'balance !='      =>0,
               ...
               <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">    
                    ...
                    <tr>
                      <td style="border-top: 0px solid #000000;"><strong><?=$feeComments->fc_comments?></strong></td>
              ...
              <div style="width:100%; float:left; height:138px; padding:20px;">
                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">    
                    <tr>
                      <td style="border-top: 0px solid #000000;">Class </td>
                      <td style="border-top: 0px solid #000000;"> <strong><?=$studentInfo->sectionsName.' ('.$studentInfo->sub_proram.')'?> </strong> </td>
