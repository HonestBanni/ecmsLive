...
//                                                            echo '<pre>';print_r($row);die;
                                                          ...
                                                          echo '<tr>
                                                                ...
                                                                <td><a href="fullDetails/'.$row->student_id.'" target="_new"><strong title="'.$row->student_name.'/'.$row->father_name.', Class :('.$row->sessionName.'), Student status = '.$row->student_status.'") target="_new">'.substr($row->student_name, 0, 30).'</strong></a><br/>'.$row->batch_name.'<br/>'.$row->sessionName.'<br/>'.$row->student_status.'</td>
                                                                <td>'.$hoste_status.'</td>
