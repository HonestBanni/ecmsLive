...
//              
                 ...
                 $conssions += $con_amount;
                        ...
                        <tr>
                                ...
                                <td style="border: 1px solid #000000;"><strong><?php echo 'comments'?></strong></td>
             ...
             ?>
                      ...
                      <?php
                        ...
                        ?> 
                            <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">
                                <tr>
                                       <td style="border: 1px solid #000000;">Hostel Challan: <strong><?php echo $hostel_row->hostel_bill_id?></strong></td>
...
//                            echo '<pre>';print_r($mess_row);die;
                       ...
                       <br/> 
                        ...
                        <p style="font-size: 15px; padding-right:25%;text-align: left; font-weight: bold;">SUMMERY DETAILS</p>
                 
                                <table class="table table-hover"   id="table" style="margin-bottom: 1px;font-size: 12px;width: 60%;float: left;">
                                     <tr>
                                    ...
                                    <tr>
                                        <td><strong>Balance Fee</strong></td>
                                    ...
                                    <tr>
                                       ...
                                       <tr>
                                        <td><strong>MESS DETAILS</strong></td>
                                        <td><strong></strong></td>
                                    </tr>
                                    <tr>
                                        <td>Mess Fee</td>
                                     ...
                                     <tr>
                                      ...
                                      <tr>
                                        <td><strong>GRAND TOTAL INFORMATION</strong></td>
                                        <td><strong></strong></td>
                                    </tr>
