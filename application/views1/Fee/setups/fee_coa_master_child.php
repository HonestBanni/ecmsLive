        ...
        <article class="contact-form col-md-12 col-sm-7">                            
          <?php echo form_open('',array('class'=>'form-inline')); ?>
            ...
            <div class="col-md-12">
                ...
                <?php 
                echo form_dropdown('COAP', $COAP,$coaId,  'class="form-control" id="fee_coa_id" required="required"');
                ?>
              </div>
                  ...
                  $sn = 1;
                   foreach($coa_master as $urRow):
                      ...
                      echo '<tr>
                                ...
                                <td>'.$status.'</td>
                                <td>
                                <a href="feeCOAChild/'.$urRow->fn_coa_m_cId.'" class="productstatus" ><span class="fa fa-book text-navy"></span></a>
                                &nbsp;
                                <a href="deltefeeCOAC/'.$urRow->fn_coa_m_cId.'" class="productstatus" ><span class="fa fa-trash text-danger"></span></a>    
                                </td>
