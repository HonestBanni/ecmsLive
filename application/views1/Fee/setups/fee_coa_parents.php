                  ...
                  $sn = 1;
                   foreach(@$coa as $urRow):
                      ...
                      echo '<tr>
                                ...
                                <td>'.$status.'</td>
                                <td>
                                <a href="feeCOAHead/'.$urRow->fn_coaId.'" class="productstatus" ><span class="fa fa-book text-navy"></span></a> &nbsp;
                                <a href="deltefeeCOAP/'.$urRow->fn_coaId.'" class="productstatus" ><span class="fa fa-trash text-danger"></span></a>
                                    </td>
