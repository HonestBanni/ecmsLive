                        ...
                        <div class="section-content" >
                           <?php echo form_open('',array('class'=>'course-finder-form'));
                               ...
                               <?php
                                ...
                                $messge = $this->session->flashdata('add_payment_error'); 
                            if(!empty($messge)):
                        ...
                        ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group ">
                                        <?php 
                                            echo form_dropdown('programe_id', $program,$programe_id,  'class="form-control feeProgrameId" id="feeProgrameId" required="required"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        $sub_program = array('Sub Program'=>"Sub Program");
                                                echo form_dropdown('sub_pro_nameId', $sub_program,$sub_pro_id,  'class="form-control" required="required" id="showFeeSubPro"');
                                        ?>
                                    </div>
                                </div>
                                     <div class="col-md-2">
                                 ...
                                 <div class="col-md-3 col-sm-5">
                                         ...
                                         <?php
                                                 ...
                                                 echo form_dropdown('payCategory', $fee_category_titles,'',  'class="form-control" required="required" id="add_paymentCategory_id"');
