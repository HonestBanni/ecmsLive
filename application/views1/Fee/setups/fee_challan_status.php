                                                          ...
                                                          foreach($result as $row):
                                                           ...
                                                           $sn++;
                                                            echo '<tr class="'.$class[$k].'">
                                                                ...
                                                                ';
                                                                       ?>
                                                                    <td>  <a href="challanStatus/<?php echo $row->ch_status_id;?>"  class="productstatus"><button type="button" class="btn btn-theme btn-xs"> Edit </button></a>
                                                                  </td> 
                                                                  <td> 
                                                                   <a href="challanStatusDelete/<?php echo $row->ch_status_id;?>"  onclick="return confirm('Are You Sure to Delete This..?')"  class="productstatus"><button type="button" class="btn btn-danger btn-xs"> Delete</button></a>
                                                                   </td>  
                                                                <?php
