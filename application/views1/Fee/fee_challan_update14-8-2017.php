                               ...
                               <div class="col-md-3">
                                    <label for="name">Sub Program</label>
                                        <?php 
                                             ...
                                             echo form_dropdown('sub_pro_name', $sub_pro_name,$student_info->sub_pro_id,  'class="form-control" id="install_type"');
                                              form_input(array(
                                                'name'          => 'father_name',
                                                'id'            => 'father_name',
...
<!--                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    echo form_dropdown('pc_array', $pc_array, $challan_info->fc_pay_cat_id,  'class="form-control"');
                                ...
                                <div class="col-md-3">
                                            ...
                                            <?php 
                                              echo form_dropdown('install_type', $install_type, $challan_info->installment_type,  'class="form-control " disabled="disabled" id="install_type"');
                                         ?>
                                    </div>
