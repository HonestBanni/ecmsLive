                                                    ...
                                                    <tbody>';
                                                        ...
                                                        $sn = "";
                                                          ...
                                                          echo '<tr>
                                                                ...
                                                                <td><a href="fullDetails/'.$row->student_id.'" target="_new"><strong title="'.$row->student_name.'/'.$row->father_name.', Class :('.$row->sessionName.'), Student status = '.$row->student_status.'")>'.substr($row->student_name, 0, 12).'</strong></a></td>
                                                                <td>'.$hoste_status.'</td>
...
//                                                             
                                                                     ...
                                                                     echo     '<td><a href="balanceChallan/'.$row->student_id.'/'.$row->fc_challan_id.'" class="btn btn-danger btn-xs "><span class="fa fa-download">New Challan</span></a></td>';
