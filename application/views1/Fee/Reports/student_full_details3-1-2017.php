                      ...
                      <?php
                        ...
                        ?> 
                            <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">
                                ...
                                <tr class="warning">
                                    <td style="border: 1px solid #000000;" colspan="7">Challan Comments :<strong><?php echo $hostel_row->hostel_comments?></strong></td>
                                </tr>
                            </table>
                        ...
                        ?> 
                            <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">
                                <tr class="warning">
                                       ...
                                       <td style="border: 1px solid #000000;">Mess: <strong><?php echo $mess_row->mess_status?></strong></td>
                                       <td style="border: 1px solid #000000;">Challan: <strong><?php echo $mess_row->challan_status?></strong></td>
                                       <td style="border: 1px solid #000000;">From Date: <strong><?php echo $mess_row->date_from?></strong></td>
                                       <td style="border: 1px solid #000000;">To Date: <strong><?php echo $mess_row->date_to?></strong></td>
                                       <td style="border: 1px solid #000000;">Paid Date: <strong><?php echo $payment_date?></strong></td>
                                       <td style="border: 1px solid #000000;">Issue Date       : <strong><?php echo date('d-m-Y',strtotime($mess_row->issue_date));?></strong></td>
                                </tr>
                                <tr class="warning">
                                    <td style="border: 1px solid #000000;" colspan="7">Challan Comments :<strong><?php echo $mess_row->mess_comments?></strong></td>
                                </tr>
                            </table>
