...
//                                        $Section = array('Section'=>"Section");
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-6 pull-right">
                                    ...
                                    <button type="submit" class="btn btn-theme" name="netReceivableAll" id="netReceivableAll"  value="netReceivableAll" ><i class="fa fa-search"></i> Search All</button>
                                    <button type="submit" class="btn btn-theme" name="netReceivableCollegeHostel" id="netReceivableCollegeHostel"  value="netReceivableCollegeHostel" ><i class="fa fa-search"></i> College & Hostel Accnt</button>
                                    <button type="submit" class="btn btn-theme" name="netReceivableMess" id="netReceivableMess"  value="netReceivableMess" ><i class="fa fa-search"></i> Mess Accnt</button>
