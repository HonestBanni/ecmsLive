...
//                                        $Section = array('Section'=>"Section");
                                ...
                                <div class="col-md-2">
                                    <label for="name">Section Null</label>
                                    <div class="form-group ">
                                        <?php 
                                        $SectionNull = array('1'=>"All Section",'2'=>'Null Section');
//                                        $SectionNull[] = array('2'=>"Only Null Section");
                                                echo form_dropdown('nullSection', $SectionNull,$nullSection,  'class="form-control" ');
                                        ?>
                                    </div>
                                </div> 
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-3 pull-right">
                                    ...
                                    <button type="submit" class="btn btn-theme" name="Export" id="Export"  value="Export" ><i class="fa fa-book"></i> Excel</button>
                                        ...
                                        <div>
                                              <table class="table table-hover" id="table" style="font-size:11px;">
                                                   <thead> ';
                                                          ...
                                                          echo '<tr>
                                                                <td >&nbsp;&nbsp;&nbsp;'.$row->fee_generate_sec.' - '.$std_info->student_status.'</td>
                                                                ...
                                                                ';
                                                                  ...
                                                                  if($row->ch_status_id == 2 || $row->ch_status_id == 3):
                                                                    ...
                                                                    $gBalance           =   $row->total_upPaid-$totalpaid-$row->concession-$row->credit_amount;
                                                                    $total_payable      =   $row->current+$row->arrears-$row->credit_amount;
...
//                                                                        echo '<td>'.$row->fc_comments.'</td>';
                                                                        ...
                                                                        $gCredit        += $row->credit_amount;
                                                                        $gNetPayable    += $total_payable;
                                                                        $gPaid          += $totalpaid;
                                                                        $payable_amount +=$row->current;
                                                                        
                                                         
                                                          endforeach;      
                                                            $gBalances       = $gPayable -$gConcession -$gPaid-$gCredit;
                                                            $show_credit     = $gPaid-$gCredit;
                                                             echo '<tr>
                                                                ...
                                                                <td><strong></strong></td>
                                                                <td><strong></strong></td>
                                                                <td><strong>'.$payable_amount.'</strong></td>
                                                                <td><strong>'.$gCredit.'</strong></td>
                                                                 
                                                                <td><strong></strong></td>
                                                                <td><strong></strong></td>
                                                                <td><strong>'.$gConcession.'</strong></td>
                                                                <td><strong></strong></td>
                                                                <td><strong>'.$gPaid.'</strong></td>
                                                                <td><strong>'.$gBalances.'</strong></td>
                                                                <td><strong></strong></td>
                                                                <td><strong></strong></td>
                                                                '; 
                                                            echo '</tr>';
