...
//              
                 ...
                 $conssions += $con_amount;
                        ...
                        <tr class="danger">
                                ...
                                <td style="border: 1px solid #000000; width: 12%; "><strong><?php echo $payment_info->old_credit_amount?></strong></td>
                                ...
                                if($challan_info->ch_status_id == 2):
                                 ...
                                 if($payment_info->current_amount > 0):
                                   $balance = $balance - $payment_info->old_credit_amount;
                                 endif;
                               ?></strong></td>
...
//                          $gbalance+= $balance;
                          ...
                          $g_old_credit_amount+= $payment_info->old_credit_amount;
                        ...
                        ?>
                                <tr class="danger">
                                    ...
                                    <td style="border: 1px solid #000000; "><strong><?php echo $g_old_credit_amount?></strong></td>
                      ...
                      <?php
                        ...
                        ?> 
                            <table class="table table-hover" id="table" style="margin-bottom: 1px; font-size: 12px;">
                                ...
                                <tr class="info">
                                    ...
                                    <td colspan="6" style="border: 1px solid #000000;"><strong><?php echo $hostel_row->hostel_comments?></strong></td>
                                   </tr>
                            </table>
                        ...
                        <thead>
                            ...
                            <tr class="info">
                                ...
                                <td style="border: 1px solid #000000;width: 17%;"><?php echo $bill_row->head_comments?></td>
                            </tr>
