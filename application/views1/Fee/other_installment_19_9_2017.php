...
//                                    echo '<pre>';print_r($studentInfo);die;
                                    if(!empty($result)):
                                        ...
                                        echo '<a href="generateOthrInstll/'.$result[0]->student_id.'" class="btn btn-theme" name="new_challan" id="new_challan"  value="generate_fee" ><i class="fa fa-upload"></i>Add New Challan</a>';
                                    endif;
                                    ?>
