                        ...
                        <div class="section-content" >
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-4 col-md-offset-1 pull-right">
                                    ...
                                    $check_concession = $this->db->get_where('fee_concession_challan',array('challan_id'=>$challandId))->row();
                                    ...
                                    if(empty($check_concession)):
                                        if($challan_lock == 0 && $challan_status ==1):
                                            ...
                                            echo '<a href="feeConcession" class="btn btn-danger" target="_blank">  Delete Concession First</a>';
                                                        ...
                                                        $grand_paid_amount = '';
                                                          ...
                                                          foreach($result as $row):
                                                            ...
                                                            echo '<tr">
                                                                ...
                                                                <th><input value="'.$row->paid_amount.'" id="'.$row->actual_amount.'"  name="update_installment[]" class="update_installment"></th>
