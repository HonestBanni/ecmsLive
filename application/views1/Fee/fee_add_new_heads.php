...
//                                                                'value'       => $recordFrom,
                           ...
                           <div style="padding-top:1%;">
                                <div class="col-md-3 pull-right">
                                    ...
                                    <?php
//                                    echo $feeComments->challan_id_lock;
                                    if($feeComments->challan_id_lock == 0):
                                        echo '  <button type="submit" class="btn btn-theme" name="filter" id="filter"  value="filter" ><i class="fa fa-plus"></i> Add</button>';
                                    endif;
