...
{
var headstr = "<html><head><title></title></head><body><p><img  class='img-responsive'></p>";
                                ...
                                <tbody>
                                    ...
                                    if($classSubjects):
                                        ...
                                        foreach($classSubjects as $rowCS):
                                         ...
                                         $get_teacher = $this->db->get_where('class_alloted', array('class_alloted.subject_id'=>$rowCS->subject_id, 'class_alloted.sec_id'=>$secId))->row();
                                         
                                         echo '<tr><td>'.substr($rowCS->title,0,20).'<br><strong>'.$get_teacher->emp_name.'</strong></td>';
...
//                                                    'class_alloted.subject_id'=>$rowCS->subject_id,
                        ...
                        <h5 class="has-divider text-highlight" style="margin-top: -10px; margin-bottom: 2px;"><strong><i>Disciplinary Action Taken</i></strong></h5>
                        <div class="table-responsive">                      
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    if(!empty($fines)):
                                        $ser = '';
                                        foreach($fines as $fnrow):
                                            $ser++;
                                            echo '<tr>
                                            <td>'.$ser.'</td>
                                            <td>'.date('d-m-Y', strtotime($fnrow->date)).'</td>
                                            <td>'.$fnrow->amount.'</td>
                                            <td>'.$fnrow->recover_assets.'</td>
                                            <td>'.$fnrow->proc_type_title.'</td>
                                            <td>'.$fnrow->status_name.'</td>
                                            <td>'.$fnrow->remarks.'</td>
                                            </tr>';
                                        endforeach;
                                    endif;
