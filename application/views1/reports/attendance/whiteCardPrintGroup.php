...
//$scope.printDiv = function(div_print) {
...
//             $sectionId = $this->uri->segment(3);
            ...
            $result = '';
            if($CheckStd->flag==1):
               $result           = $this->ReportsModel->get_whiteCard_subject(
                       array(
                           'student_group_allotment.student_id'=>$studentId,
                           'student_group_allotment.section_id'=>$sectionId
                        )
                       ); 
            ...
            <div class="col-md-12" style="padding-bottom: 100px !important; padding-top: 70px; width:98%;height:1000px;">
                <h4><strong>Edwardes College Peshawar <?php echo $result->batch_name; ?> </strong></h4>
                                    ...
                                    <tr>
                                        <td >  
                                            <div class="profilepicture">
                                                <img src="assets/images/logoWhiteCard.png" style=" height: 100px;  margin-left: 24px;">
                                            </div>
