...
<div class="content container">
            ...
            <?php        
                ...
                if(!empty($student_id)){
                    ...
                    { ?>          
        <input type="text" name="student_id" value="<?php echo $emprec->student_name; ?>" placeholder="Student" class="form-control" id="students_alevel">
                    <input type="hidden" name="student_id" id="student_id" value="<?php echo $emprec->student_id; ?>">      
                    <?php 
                    }     
                }else{?>
        <input type="text" name="student_id" placeholder="Student" class="form-control" id="students_alevel">
    ...
    jQuery(document).ready(function(){
        jQuery("#students_alevel").autocomplete({  
        minLength: 0,
        source: "ReportsController/auto_students_alevel/"+$("#students_alevel").val(),
        autoFocus: true,
        scroll: true,
        dataType: 'jsonp',
        select: function(event, ui){
        jQuery("#students_alevel").val(ui.item.contactPerson);
