...
<div class="content container">
            ...
            <?php        
                ...
                if(!empty($student_id)){
                    ...
                    { ?>          
        <input type="text" name="student_id" value="<?php echo $emprec->student_name; ?>" placeholder="Student" class="form-control" id="students_bslaw">
                    <input type="hidden" name="student_id" id="student_id" value="<?php echo $emprec->student_id; ?>">      
                    <?php 
                    }     
                }else{?>
        <input type="text" name="student_id" placeholder="Student" class="form-control" id="students_bslaw">
    ...
    jQuery(document).ready(function(){
        jQuery("#students_bslaw").autocomplete({  
        minLength: 0,
        source: "ReportsController/auto_students_bslaw/"+$("#students_bslaw").val(),
        autoFocus: true,
        scroll: true,
        dataType: 'jsonp',
        select: function(event, ui){
        jQuery("#students_bslaw").val(ui.item.contactPerson);
