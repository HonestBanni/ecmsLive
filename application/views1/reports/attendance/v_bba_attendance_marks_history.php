...
<div class="content container">
            ...
            <?php        
                ...
                if(!empty($student_id)){
                    ...
                    { ?>          
        <input type="text" name="student_id" value="<?php echo $emprec->student_name; ?>" placeholder="Student" class="form-control" id="students_bba">
                    <input type="hidden" name="student_id" id="student_id" value="<?php echo $emprec->student_id; ?>">      
                    <?php 
                    }     
                }else{?>
        <input type="text" name="student_id" placeholder="Student" class="form-control" id="students_bba">
    ...
    jQuery(document).ready(function(){
        jQuery("#students_bba").autocomplete({  
        minLength: 0,
        source: "ReportsController/auto_students_bba/"+$("#students_bba").val(),
        autoFocus: true,
        scroll: true,
        dataType: 'jsonp',
        select: function(event, ui){
        jQuery("#students_bba").val(ui.item.contactPerson);
