...
//    var headstr = "<html><head><title></title></head><body>";
    var headstr = "<html><head><title></title></head><body><p><img  class='img-responsive' src='assets/images/logo.png' alt='Edwardes College Peshawar'><h2>Student Attendance Defaulter Report</h2></p>";
    var footstr = "</body>";
...
//                                        $Section = array('Section'=>"Section");
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-4 pull-right">
                                    ...
                                    <button type="submit" class="btn btn-theme" name="Export" id="Export"   value="Export" ><i class="fa fa-book"></i> Export</button>
                                </div>
                            </div>
                    </section>
