                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-2 col-sm-5">
                                ...
                                <div class="input-group">
                                    <?php 
                                        echo form_dropdown('sectionpr', $subPrograme,@$sectionId,  'class="form-control" id="new_sub_program"');
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-5">
                 ...
                 <tbody>
                     ...
                     if(@$student_result):
                        ...
                        foreach($student_result as $srRow):
                            ...
                            if(@$subjectId):
                                $subject_results = $this->ReportsModel->get_subject_new_student_list(array('new_student_subjects.subject_id'=>$subjectId,'new_student_subjects.student_id'=>$srRow->student_id));
                                ...
                                if($subject_results):
                                    ...
                                    echo '<tr style="font-size: 14px;">
                                        ...
                                        <td>'.date('d-m-Y H:i:s',strtotime($srRow->timestamp)).'</td><td>';
