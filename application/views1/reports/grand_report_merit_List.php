    ...
    <div class="page-content">
      <div class="row">
        ...
        ?>
                                  ...
                                  <div class="col-md-2 col-sm-5">
                                    <label for="name">Reserved Seat 1</label>
                                        <div class="input-group" id="adv-search">
                                            <?php
                                  ...
                                  <div class="col-md-2 col-sm-5">
                                    <label for="name">Reserved Seat 2</label>
                                        <div class="input-group" id="adv-search">
                                            <?php
                                                 echo form_dropdown('reserved_seat2', $reserved_seat2, $reserved_seatId2,  'class="form-control" id="my_id"');
           
                                            ?>
                                        </div>
                                   </div>
                                    <div class="col-md-2 col-sm-5">
                                    <label for="name">Reserved Seat 3</label>
                                        <div class="input-group" id="adv-search">
                                            <?php
                                  ...
                                  <div class="col-md-2 col-sm-5">
                                    <label for="name">Admission In</label>
                                        <div class="input-group" id="adv-search">
                                            <?php
                                                 echo form_dropdown('reserved_seat4', $reserved_seat4, $reserved_seatId4,  'class="form-control" id="my_id"');
                                ...
                                <div class="col-md-2 col-sm-5">
                                    <label for="name">Passing Year</label>
                                        <div class="input-group" id="adv-search">
                                            ...
                                            echo  form_dropdown('year_of_passing',$year,$passingYear,  'class="form-control"');
                                            ?>
                                        </div>
                                    </div>    
                                <div class="col-md-2 col-sm-5">
                   ...
                   foreach($result as $resRow):
                         $timestamp = strtotime($resRow->admission_date);
                          $admission_date = date('d-m-y', $timestamp);
                            ...
                            $rseat_id3 = $resRow->rseats_id3;
                            $result3 = $this->ReportsModel->get_by_id('reserved_seat',array('rseat_id'=>$rseat_id3));
                ?>
                      ...
                      <tr>
                                ...
                                <td><?php foreach($result3 as $orec3){ echo $orec3->name; }?></td> 
