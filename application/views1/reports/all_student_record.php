        ...
        <div class="content container">
            ...
            <div class="row cols-wrapper">
                <div class="col-md-12">
                    ...
                    <form method="post" action="ReportsController/search_enrolled_student">
...
$i = 1;
    ...
    <img src="<?php echo base_url();?>assets/images/students/<?php echo $applicant_image;?>"  width="60" height="40">
                <?php 
                    ...
                    ?></td>
 <td>
     <span style="font-size:15px;"><a href="admin/student_profile/<?php echo $student_id;?>"><?php echo strtoupper($student_name);?></a></span>    
                    </td>
                    <td><?php echo strtoupper($father_name);?></td>
