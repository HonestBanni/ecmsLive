        <div class="content container">
            ...
            <div class="row cols-wrapper">
                <div class="col-md-12">
    <form method="post" action="AttendanceController/update_prac_group/<?php echo $result->serial_no;?>">       
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" name="group_id" value="<?php echo $result->group_name;?>" class="form-control" id="groupName">
