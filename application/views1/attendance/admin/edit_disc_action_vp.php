    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="row">
                ...
                <form action="AttendanceController/update_disc_action_vp" id="update_form" method="POST" role="form">
                    <div class="form-group col-md-3">
                        <label>Fine Type</label>
                        <?php  echo form_dropdown('proc_type_id', $fine_type, $fine_info->proc_type_id, 'class="form-control" id="proc_type_id"');  ?>
                    ...
                    <div class="form-group col-md-3">
                        <label>Amount</label>
                        <input type="text" name="amount" class="form-control" value="<?php echo $fine_info->amount; ?>" required="required">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Recovered Assets</label>
                        <input type="text" name="recover_assets" class="form-control" value="<?php echo $fine_info->recover_assets; ?>"">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Remarks</label>
                        <input type="text" name="remarks" class="form-control" value="<?php echo $fine_info->remarks; ?>" required="required">
                    </div>
                    <div class="col-md-12 form-group">
                        <label for="name">Action Taken:</label>
                        <textarea type="text" class="form-control notes" maxlength="250" rows="3" name="action_taken" id="action_taken" style="resize: none;" required="required"><?php echo $fine_info->action_taken; ?></textarea>
                    </div>
