      ...
      <div class="row">
        <article class="contact-form col-md-12 col-sm-7  page-row">                            
          <?php echo form_open('',array('class'=>'form-inline')); ?>
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                  <label>Class/Semester Name</label><br>
                <?php 
        ...
        <?php if(@$result): ?>      
            ...
            <table class="table  table-boxed table-bordered table-striped">
              ...
              <thead>
                 <tr style="font-size:15px;font-weight:bold" align="center">
                  ...
                  <td rowspan="2" style="width:100px;">College No</td>
                  <td rowspan="2" style="width:180px;">Name</td>
                  <td rowspan="2" style="width:180px;">F/Name</td>
                 
                <td rowspan="2">Attended Lecture</td>
                <td rowspan="2">Total Lecture</td>
                <td rowspan="2">%Age</td>     
                <td rowspan="2">Remaining Fee</td>     
                </tr>
          ...
          //  ECHO '<pre>';print_r($where);
            ...
            $where_fee = array(
                'student_record.student_id'    =>$resRow->student_id
            );
            
            $fee_total = $this->AttendanceModel->full_defaulter_attendance($where_fee);
            if($fee_total):
                  echo  $fee_total->balance;
                else:
                echo '0';
            endif;
