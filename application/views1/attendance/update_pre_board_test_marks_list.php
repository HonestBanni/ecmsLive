        ...
        <div class="content container">
            ...
            <header class="page-heading clearfix">
                  <h1 class="heading-title pull-left">Update Pre Board Test Marks List</h1>
                </header>
            </div>
            ...
            <td><img src="assets/images/students/<?php echo $rec->applicant_image;?>" width="60" height="50"></td>
                ...
                <td><input type="text" name="omarks[]" value="<?php echo $rec->omarks ?>" class="form-control checkBoard"></td>
