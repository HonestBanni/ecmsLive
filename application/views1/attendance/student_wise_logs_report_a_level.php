                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-2 col-sm-5">
                                ...
                                <div class="input-group">
                                    <?php 
                                        echo form_dropdown('sectionpr', $subPrograme,@$sectionId,  'class="form-control" id="sub_program_a_level"');
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-5">
                                ...
                                <div class="input-group">
                                    <?php 
                                        echo form_dropdown('section', $sections,@$sectionId,  'class="form-control" id="a_level_dropdown"');
                                    ?>
                                </div>
                            </div>
                        </div>  
