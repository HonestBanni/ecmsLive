<div class="content container">
    <h2 align="left">Student Practical Groups Inter Level<span  style="float:right"><a href="AttendanceController/add_prac_group" class="btn btn-large btn-primary">Add New Student</a></span><hr></h2>
    ...
    <div class="page-content">
      <div class="row">
            ...
            <div class="form-group col-md-2">
                <?php
                    ...
                    if(!empty($group_id)){
                        ...
                        { ?>          
            <input type="text" name="group_id" value="<?php echo $secrec->group_name; ?>" placeholder="Section" class="form-control" id="groupName">
        ...
        <tr>
            ...
            <td><a class="btn btn-theme btn-sm" href="AttendanceController/update_prac_group/<?php echo $pRow->serial_no;?>">Update</a></td>
            <td><a class="btn btn-danger btn-sm" href="AttendanceController/delete_prac_group/<?php echo $pRow->serial_no;?>">Delete</a></td>
        </tr>
        <?php 
            $s++;
            endforeach;
