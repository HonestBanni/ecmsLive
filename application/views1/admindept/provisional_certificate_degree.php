        ...
        <div class="content container">
               <!-- ******BANNER****** -->
   <h3 align="left">Provisional Certificates Record Degree<hr></h3>          
...
foreach($result as $rec)  
{
  ...
  <img src="<?php echo base_url();?>assets/images/students/<?php echo $rec->applicant_image;?>" style="border-radius:10px;" width="80" height="80">
    ...
    <td><a class="btn btn-primary btn-sm" href="AdminDeptController/update_provisional_certficate_degree/<?php echo $rec->student_id;?>"><b>Update</b></a></td>
                        </tr>
<?php
}
 ?>
