...
<div class="content container">
  <div class="page-wrapper">
    ...
    <div class="page-content">
      <div class="row">
          <h2 align="right">
              <a href="ComparativeLTWorkOrder" class="btn btn-large btn-theme">Add Work Order From Comparative</a>
              <a href="<?php echo base_url();?>InventoryController/add_work_order" class="btn btn-large btn-primary">Add Work Order Directly</a>
          </h2>
          ...
          <tbody>
            ...
            $newDate = date("d-m-Y", strtotime($date)); 
                ...
                <a class="btn btn-theme btn-sm" href="InventoryController/show_work_order_grn/<?php echo $urRow->work_id;?>">View GRN</a>
                        <?php   
                          ...
                          ?>
            <a class="btn btn-info btn-sm" href="InventoryController/work_order_grn/<?php echo $urRow->work_id;?>">Add GRN</a>
                      <?php
                            }
                          ?>
                      </td>
            ...
            <td>
                <?php
                 if($status == 1){
                        ?>
                <a class="btn btn-danger btn-sm" href="InventoryController/delete_work_order/<?php echo $urRow->work_id;?>" onclick="return confirm('Are You Want to Delete...?')">Delete</a>
                       <?php
                            }else{
                          ?>
