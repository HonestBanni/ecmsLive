...
<div class="content container">
  <div class="page-wrapper">
    ...
    <div class="page-content">
      <div class="row">
          <h2 align="right">
              <a href="ComparativeLTPurchaseOrder" class="btn btn-large btn-theme">Add Purchase Order From Comparative</a>
              <a href="<?php echo base_url();?>InventoryController/purchase_order" class="btn btn-large btn-primary">Add Purchase Order Directly</a>
          </h2>
