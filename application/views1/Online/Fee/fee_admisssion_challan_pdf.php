    ...
    <?php if(!empty($studentInfo)):    ?>
             <div style="margin: 2px 4px 2px; width:32%;height:auto;border-right:2px dotted #000; float: left; position: relative">
                <div style="text-align: center">
                 ...
                 <p style="font-size: 12px; text-align: center;"><strong>EDWARDES COLLEGE PESHAWAR <br/><?php echo $this->DefaultFeeBank->name?></strong> <br><strong style="font-size: 15px;">Acc No :(<?php echo $this->DefaultFeeBank->account_no?>)</strong></p>
                    <table class="table ">
                    ...
                    <tr style="background-color:black; color: white;">
                       ...
                       $grand_total = '';
                        ...
                        <tr>
                            <td colspan="2" style="font-size: 10px;" class="removeBorder"><strong>Comments :&nbsp;&nbsp;<?php echo $feeComments->fc_comments?></strong></td>
