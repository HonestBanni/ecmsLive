        ...
        <div class="content container">
               <!-- ******BANNER****** -->
            <h2 align="left"> Admin Student Change Password<hr></h2>
...
$i = 1;
 ...
 <td><a href="<?php echo base_url();?>admin/student_profile/<?php echo $student_id;?>"><span style="font-size:15px;"><?php echo $student_name;?></span></a>    
                ...
                <td><a href="StudentController/student_update_password/<?php echo $student_id;?>" class="btn btn-primary btn-sm">Change Password</a></td>
    </tr>
        <?php
        }
         ?>
