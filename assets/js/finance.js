jQuery(document).ready(function(){
    ...
    jQuery('#fn_coa_code').on('change',function(){
        ...
        var coa_id_type = jQuery('#coa_id_type').val();
        
            jQuery.ajax({
                type:'post',
                url : 'check_coa_parent',
                data:{'fn_coa_code':fn_coa_code,'coa_id_type':coa_id_type},
                success:function(result){
               if(result ==1){
                   alert('Code already exist or check Delete Status');
    ...
    jQuery('#fn_coa_master_code').on('change',function(){
        ...
        jQuery.ajax({
                ...
                data:{'fn_coa_master_code':fn_coa_master_code,'coa_id':coa_id,'coa_id_type':coa_id_type},
                success:function(result){
               if(result ==1){
 ...
 jQuery('#coa_parent_id').on('change',function(){
     ...
     jQuery.ajax({
         ...
         data   :{'coa_parent_id':coa_parent_id,'coa_id_type':coa_id_type},
 ...
 jQuery('#master_subChild_code').on('change',function(){
     ...
     jQuery.ajax({
         ...
         data   :{'coa_parent_id':coa_parent_id,'master_child':master_child,'master_subChild_code':master_subChild_code,'coa_id_type':coa_id_type},
         success:function(coa_p_record){
              if(coa_p_record ==1){
                   alert('Code already exist');
